...
- Recovery review: S3 ROM UART0 now has dedicated native pins; the [C5 mux candidate](docs/h6-r2-c5-mux-control-review.md) passes Boolean/order tests but is not implemented or electrically qualified. [Actual recovery boundary](docs/service-recovery.md).
