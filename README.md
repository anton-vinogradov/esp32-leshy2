...
| **H1 · Physical product design** | **▶ Current · `H1-R2.27`** | [Current placement](docs/h1-r2-physical-layout.md) · [cost ranking](docs/h1-r2-cost.md) |
