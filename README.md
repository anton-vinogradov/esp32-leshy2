...
> **Now: H1-R2.9 · official K331 functional integration is verified; physical and factory gates remain.**
...
H1-R2.9 drawing is the current collision-tested incremental placement. The
...
![Leshy2 H1-R2.9 inner placement](docs/images/h1-r2-inner-placement.svg)

![Leshy2 H1-R2.9 MMCX placement and service proof](docs/images/h1-r2-mmcx-service.svg)
...
![Leshy2 H1-R2.9 analog-FPV path](docs/images/h1-r2-fpv-path.svg)
...
| **H1 · Physical product design** | **▶️ Current: H1-R2.9 K331 integration evidence and inner placement** | [Current result](docs/h1-r2-physical-layout.md) |
...
**Hardware is at H1-R2.9.** H0-R2 fixes six compute domains, 33/33 used S3
...
**Exact marker: `H1-R2.9`** — the [current placement](docs/h1-r2-physical-layout.md),
