...
> checkpoint](docs/h6-r2-current-routing.md) binds 5,290 checked track/via
> items to the current board hashes; native connectivity has 710 resolved and
> 2,555 remaining physical connections. The UI `ANALOG_AUDIO_SENSE` class is
> complete; RF/power has only 25 connections left in that class after 102 new
...
<table>
  <tr>
    ...
    <td width="50%"><a href="docs/images/h6-r2-routing-rf.svg?rev=h6.0.3-r1-rf102"><img src="docs/images/h6-r2-routing-rf.svg?rev=h6.0.3-r1-rf102" alt="Current RF and power PCB routing" width="100%"></a></td>
  </tr>
  <tr>
