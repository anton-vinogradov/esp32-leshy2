...
**Exact marker: `H2.3.5`** — implement and review the RP2354 core, internal
flash, native USB, recovery and service access on `RF_30_RP2354_CORE_SERVICE`.

- ✅ `H1.8` — complete physical design accepted on 23 August 2026.
- ✅ `H2.0.1` — complete 997-row circuit inventory reviewed.
