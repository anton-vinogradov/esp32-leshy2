...
> **Now: H1-R2.8 · official K331 functional integration is verified; physical and factory gates remain.**
...
H1-R2.8 drawing is the current collision-tested incremental placement. The
...
![Leshy2 H1-R2.8 inner placement](docs/images/h1-r2-inner-placement.svg)

![Leshy2 H1-R2.8 MMCX placement and service proof](docs/images/h1-r2-mmcx-service.svg)
...
![Leshy2 H1-R2.8 analog-FPV path](docs/images/h1-r2-fpv-path.svg)
...
| **H1 · Physical product design** | **▶️ Current: H1-R2.8 K331 integration evidence and inner placement** | [Current result](docs/h1-r2-physical-layout.md) |
...
**Hardware is at H1-R2.8.** H0-R2 fixes six compute domains, 33/33 used S3
...
**Exact marker: `H1-R2.8`** — the [current placement](docs/h1-r2-physical-layout.md),
