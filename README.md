...
> **Current hardware marker: `H1-R2.28`.** The two-PCB physical model has no remaining engineering blocker. Ten main SMA ports are split `5 + 5`; the separate rear MMCX feeds a mutually exclusive post-PCBA K331/AWM666V receiver bay. C5 now uses the stocked `C54951858` supplier route with a fail-closed v1.2 production floor. H1 awaits explicit acceptance of the complete mock-up; KiCad and ordering remain blocked until that review.
...
| **H1 · Physical product design** | **▶ Current · `H1-R2.28`** | [Current placement](docs/h1-r2-physical-layout.md) · [cost ranking](docs/h1-r2-cost.md) |
