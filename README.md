...
> **Current hardware marker: `H4-R2.0.1`.** The complete two-PCB `H1-R2.37`
...
| **H4 · Joined hardware/firmware pre-layout gate** | **▶ Current · `H4-R2.0.1`** | [Stage page](docs/stage-results.md#h4) |
...
- ▶ **Exact current point `H4-R2.0.1`:** freeze the current mechanics, ECAD, H3 and firmware-R2 inputs for one joined pre-layout review.
