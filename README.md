...
| **H6 · KiCad placement, routing and release candidate** | **▶ Current · `H6.0.1-R1`** | [Exact-footprint progress](docs/h6-r2-exact-placement.md) · [mechanical stack](docs/h6-r2-mechanical-stack.md) · [stage page](docs/stage-results.md#h6) · [machine checklist](hardware/verification/h6-layout-release-plan.json) |
...
- ▶ **Exact current point `H6.0.1-R1`:** [native placement](docs/h6-r2-exact-placement.md) is reproducible at 1,208/1,208 positions with zero hard conflict, and the [exact mechanical stack](docs/h6-r2-mechanical-stack.md) closes enclosure capture plus M2.5 retention; only five relaxed microcoax corridors and their enclosure/inspection clearances remain before routing.
