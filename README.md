...
> checkpoint](docs/h6-r2-current-routing.md) binds 4,605 checked track/via
> items to the current board hashes; native connectivity has 608 resolved and
> 2,657 remaining physical connections. The UI `ANALOG_AUDIO_SENSE` class is complete. The formerly blocked
...
<table>
  <tr>
    ...
    <td width="50%"><a href="docs/images/h6-r2-routing-rf.svg?rev=h6.0.3-r1"><img src="docs/images/h6-r2-routing-rf.svg?rev=h6.0.3-r1" alt="Current RF and power PCB routing" width="100%"></a></td>
  </tr>
  <tr>
