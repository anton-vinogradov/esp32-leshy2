...
| dual-SA818S lead time and final assembly | [`original inquiry`](H5.0.3-R1-no-order-supplier-inquiry.md) + [`partial reply`](H5.0.3-R1-jlcpcb-response-2026-08-26.md) + [`machine record`](H5.0.3-R1-supplier-response.json) + [`exact-one clarification draft`](H5.0.3-R1-jlcpcb-clarification-reply.md) | JLCPCB confirms exact VHF MOQ 1 and typical 8–15-working-day pre-order; the original five-unit wording is superseded. `H5-EVR07` now has only 9 release-relevant unanswered fields: the actual two-designator job, four one-device final-assembly operations and exact-MPN control. Function Test, batteries and accessory packing are explicitly non-gating | supplier confirms the actual two-designator U/V job, four required final-assembly operations and exact-MPN/no-substitution control |
