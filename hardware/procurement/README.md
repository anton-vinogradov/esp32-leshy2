...
|---|---|---|---|
| exact display and factory installation | [`ER-TFT035IPS-6-display-assembly.md`](ER-TFT035IPS-6-display-assembly.md) | exact `ER-TFT035IPS-6 + ER-TPC035-6 option 5344`, direct `FH34SRJ-50S-0.5SH(50)`, one stocked 50×50-mm PSA rectangle and the relaxed one-fold FPC route are selected; the HMX donor and `L2-DISP-ADP-001-B` are historical rejected routes | current-lot dry fit proves the ≤24.66-mm neutral-axis path and ≥5.00-mm relaxed reserve; exact PSA MPN/process and deterministic factory installation/mating close before release; owner verifies image/backlight/touch in H7/H8 |
