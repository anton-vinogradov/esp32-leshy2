...
| dual-SA818S lead time and final assembly | [`H5.0.3-R1-no-order-supplier-inquiry.md`](H5.0.3-R1-no-order-supplier-inquiry.md) | exact U/V identities and prices known; no-order request submitted successfully on 26 August 2026, response pending | SA818S-V lead time and itemized `J4-F/P` acceptance/pricing are returned without reservation or order |
