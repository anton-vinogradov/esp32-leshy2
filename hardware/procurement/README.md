...
| dual-SA818S lead time and final assembly | [`original inquiry`](H5.0.3-R1-no-order-supplier-inquiry.md) + [`partial reply`](H5.0.3-R1-jlcpcb-response-2026-08-26.md) + [`machine record`](H5.0.3-R1-supplier-response.json) + [`sent exact-one clarification`](H5.0.3-R1-jlcpcb-clarification-reply.md) + [`sent exact display-PSA supplement`](H5.0.3-R1-jlcpcb-display-psa-clarification.md) | JLCPCB confirms exact VHF MOQ 1 and typical 8–15-working-day pre-order; the original five-unit wording is superseded. Both information-only clarifications were sent on 2026-09-01 from `vinogradov.anton@gmail.com`. `H5-EVR07` waits for release-relevant answers covering the actual two-designator job, four one-device final-assembly operations, exact PSA/FPC/ZIF/pressure process and exact-MPN control. Function Test, batteries and accessory packing are explicitly non-gating | supplier confirms the actual two-designator U/V job, four required final-assembly operations including exact display retention, and exact-MPN/no-substitution control |
