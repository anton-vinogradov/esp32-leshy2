...
| dual-SA818S lead time and final assembly | [`H5.0.3-R1-no-order-supplier-inquiry.md`](H5.0.3-R1-no-order-supplier-inquiry.md) + [`response record`](H5.0.3-R1-supplier-response.json) | exact U/V identities and prices known; no-order request submitted successfully on 26 August 2026; `H5-EVR07` waits fail-closed for the response | SA818S-V lead time and itemized `J4-F/P` acceptance/pricing are returned without reservation or order |
| optional Parts API | [`H5.0.3-R1-parts-api-support-inquiry.md`](H5.0.3-R1-parts-api-support-inquiry.md) | application approved/enabled but Parts permission rejected without reason; no-secret support inquiry submitted successfully on 26 August 2026 | support states the reason and enables Parts or gives an exact actionable correction; manual evidence remains authoritative meanwhile |
