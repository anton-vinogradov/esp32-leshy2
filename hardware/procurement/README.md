...
non-exclusive reference, and the full 209-line BOM is mapped to `J0`–`J3`, `J4-F` or `J4-P`
...
| complete minimum first lot | [`pre-kicad-sample-plan.md`](pre-kicad-sample-plan.md) | generated H5.0.3 basket published; all 209 sourcing/final-assembly routes mapped and purchase not authorized | exact SA518 price and `J4-F/P` factory gates close, then a separate order decision is made |
