...
| exact nRF miniature RF mate | [`E01-ML01IPX-data-request.md`](E01-ML01IPX-data-request.md) | H1 paper path closed as Gen1; optional no-order lot confirmation retained | factory installs the locked production path; owner inspects fit/retention and complete-feed RF performance in H7/H8 |
