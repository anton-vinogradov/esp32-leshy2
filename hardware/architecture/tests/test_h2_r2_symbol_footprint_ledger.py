...
class H2R2SymbolFootprintLedgerTests(unittest.TestCase):
    ...
    def test_generator_is_current(self):
        ...
        self.assertIn("233 board groups", result.stdout)
    ...
    def test_exact_group_boundary_is_complete(self):
        ...
        self.assertEqual(233, summary["symbol_identity_count"])
        self.assertEqual(233, summary["footprint_identity_count"])
        self.assertEqual(1654, summary["logical_contact_count"])
