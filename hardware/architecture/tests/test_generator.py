...
class ArchitectureValidationTests(unittest.TestCase):
    ...
    def test_pre_kicad_plan_preserves_sole_prototype_manifest_and_gate(self):
        ...
        self.assertEqual("H4-R2.0.2", roadmap["current_substep"])
    ...
    def test_i6_native_s3_c5_exact_rf_endpoint_does_not_regress(self):
        ...
        nrf_jumper = self.database["devices"]["te_1_2118651_0"]
        self.assertEqual(60.0, nrf_jumper["electrical_contract"]["cable_length_mm"])
        self.assertEqual(9, nrf_jumper["electrical_contract"]["frequency_max_ghz"])
