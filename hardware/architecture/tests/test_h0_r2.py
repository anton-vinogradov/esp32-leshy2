...
class H0R2ArchitectureTest(unittest.TestCase):
    ...
    def test_display_is_direct_i8080_and_clock_is_legal(self):
        ...
        self.assertEqual(display["selected_clock_hz"], display["idf_clock_contract"]["actual_clock_hz"])
        self.assertGreater(display["idf_clock_contract"]["forbidden_actual_clock_hz"], display["controller_limit_hz"])
    ...
    def test_interboard_map_closes_current_and_mechanics(self):
        ...
        self.assertEqual(9, classes.count("reserve"))
    ...
    def test_interboard_carries_only_intentional_crossings_not_local_payloads(self):
        ...
        self.assertEqual("FAULT_KILL", nets[34])
    ...
    def test_interconnect_page_is_generated_from_the_exact_80_contact_map(self):
        ...
        self.assertIn("`9` NC reserve", module.EN.read_text(encoding="utf-8"))
