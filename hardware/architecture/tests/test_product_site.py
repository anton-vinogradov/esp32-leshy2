...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_roadmap_reports_current_truth_and_complete_route(self):
        pages = {
            "docs/roadmap.md": (
                "Current hardware boundary: H1-R2.6", "H0-R2 reviewed",
                "firmware F0-R2.0",
                "H2.2.5",
                "H9. Manufacturing release", "Production ECAD",
            ),
            "docs/roadmap.ru.md": (
                "Текущая аппаратная граница: H1-R2.6", "H0-R2 проведено ревью",
        ...
        landing_pages = {
            "README.md": ("Roadmap and current position", "Hardware is at H1-R2.6", "printing/fabrication"),
            "README.ru.md": ("Роадмап и текущая позиция", "Железо находится на H1-R2.6", "печать/на фабрику"),
        }
    ...
    def test_h3_plan_and_accepted_input_freeze_are_current(self):
        ...
        self.assertEqual("H1-R2.6", state["current_substep"])
