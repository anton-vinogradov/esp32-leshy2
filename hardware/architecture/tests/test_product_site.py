...
class ProductSiteTests(unittest.TestCase):
    PUBLIC_PAGES = (
        ...
        "docs/h4-r2-correction-closure.md",
        ...
        "docs/h6-r2-routing-automation.md",
        "docs/h6-r2-routing-automation.ru.md",
        ...
        "docs/h6-r2-encoder-engineering-fit.ru.md",
        ...
        "docs/h6-r2-microcoax-service.ru.md",
    ...
    def test_current_hardware_substep_is_visible_and_synchronized(self):
        ...
        for name in pages:
            page = self.read(name)
            found = re.findall(r"<!-- current-substep: (H\d+(?:-R\d+)?(?:\.\d+)+(?:-R\d+)?) -->", page)
    ...
    def test_h1_r2_32_public_boundary_separates_electrical_and_physical_work(self):
        expectations = {
            "README.md": (
                ...
                "docs/h6-r2-current-routing.md",
                "Native ERC currently uses passive symbol pins",
                "electrical-semantics gap blocks release",
            ),
            "README.ru.md": (
