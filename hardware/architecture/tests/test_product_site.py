...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_roadmap_reports_current_truth_and_complete_route(self):
        pages = {
            "docs/roadmap.md": (
                "Current hardware boundary: `H3-R2.0.3`", "H0, H1 and [H2-R2.1.5",
                "firmware F1-R2 reviewed", "F2-R2.4",
                "H9 · Manufacturing release", "Production ECAD",
            ),
            "docs/roadmap.ru.md": (
                "Текущая аппаратная граница: `H3-R2.0.3`", "H0, H1 и [H2-R2.1.5",
        ...
        landing_pages = {
            "README.md": ("Roadmap and current position", "Current hardware marker: `H3-R2.0.3`", "fabrication"),
            "README.ru.md": ("Роадмап и текущее положение", "Текущий маркер железа: `H3-R2.0.3`", "печати прототипа"),
        }
    ...
    def test_current_mockup_review_scope_is_explicit(self):
        expectations = {
            "docs/roadmap.md": (
                ...
                "complete exterior", "accepted on 2026-08-30", "H3-R2.0.3",
            ),
            "docs/roadmap.ru.md": (
                ...
                "Полный внешний вид", "приняты 2026-08-30", "H3-R2.0.3",
            ),
        }
        for name, tokens in expectations.items():
            page = self.read(name)
    ...
    def test_h1_r2_32_public_boundary_separates_electrical_and_physical_work(self):
        expectations = {
            "README.md": (
                "Current hardware marker: `H3-R2.0.3`",
            ...
            "README.ru.md": (
                "Текущий маркер железа: `H3-R2.0.3`",
                "dual-RP GPIO/M1",
            ...
            "docs/roadmap.md": (
                "Current hardware boundary: `H3-R2.0.3`",
                "18 exact production",
            ...
            "docs/roadmap.ru.md": (
                "Текущая аппаратная граница: `H3-R2.0.3`",
    ...
    def test_h3_historical_review_is_preserved_but_not_current_r2_authority(self):
        ...
        self.assertEqual("H3-R2.0.3", state["current_substep"])
        self.assertEqual("current", r2_plan["status"])
        self.assertEqual("H3-R2.0.3", r2_plan["current_substep"])
