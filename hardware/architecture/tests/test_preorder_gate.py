...
class PreorderGateTests(unittest.TestCase):
    ...
    def test_gate_reports_actual_unfinished_state(self):
        ...
        self.assertIn("H5-R2.1 revalidates all 248", truth["joined_release"])
        self.assertIn("not current electrical qualification", truth["virtual_electrical"])
        self.assertIn("current_power_scope", truth["virtual_electrical"])
