...
class PreorderGateTests(unittest.TestCase):
    ...
    def test_gate_reports_actual_unfinished_state(self):
        ...
        self.assertIn("H2-R2.1.3 has controlled definitions and an exact allocation of all 1096 fitted instances", truth["current_ecad"])
        self.assertIn("joining native nets is current", truth["current_ecad"])
