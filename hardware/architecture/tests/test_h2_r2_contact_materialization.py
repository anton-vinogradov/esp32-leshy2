...
class H2R2ContactMaterializationTests(unittest.TestCase):
    ...
    def test_generator_is_current(self):
        ...
        self.assertIn("1556 board contacts", result.stdout)
    ...
    def test_every_contact_and_named_pad_is_accounted_for(self):
        ...
        self.assertEqual(1615, summary["source_ledger_logical_contact_count"])
        self.assertEqual(1556, summary["board_logical_contact_count"])
        self.assertEqual(1553, summary["pcb_footprint_contact_count"])
