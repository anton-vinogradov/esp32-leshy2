...
def render_svg(data: dict) -> str:
    ...
    out = [
        ...
        '<text x="630" y="66" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#526076">Reviewed H1-R2.37 projection; current H2-R2.0 closes electrical prerequisites before native R2 ECAD.</text>',
