    ...
    for candidate in candidates:
        ...
        if interboard is not None:
            ...
            required_nets = {
                ...
                "RESET_KILL_GATE", "UI_F1_N", "UI_F2_N",
...
def render_target_principled_section(
    ...
    if russian:
        ...
        roles = {
            ...
            "ui_dpad_switch": "четыре направления и OK под единой крестовиной D-pad",
        ...
        roles = {
            ...
            "ui_dpad_switch": "four directions and centre push below the single D-pad cross",
    ...
    diagrams = [
        ...
        (
            ...
            [
                ...
                node("ui_dpad_switch"), node("ui_switch_back"),
...
def _render_principled_pinout_bundle(
    ...
    lines = [
        ...
        *[node(instance, service_role(instance)) for instance in service_instance_names],
        ...
        node("rear_control_esd", "four-channel rear F1/F2/encoder-push ESD array"),
        node("ui_dpad_switch", "four-direction plus center-push navigation switch"),
        ...
        *[node(instance, evidence_role(instance)) for instance in evidence_support_instance_names],
        ...
        "  SLOW_IO_STOP_SENSE_PULLUP ~~~ SLOW_IO_S3_EVIDENCE_ISO ~~~ SLOW_IO_S3_EVIDENCE_ISO_BYPASS ~~~ SLOW_IO_S3_EVIDENCE_PULLUP ~~~ UI_MATRIX_IO ~~~ UI_MATRIX_IO_BYPASS ~~~ UI_INPUT_UP_PULLUP ~~~ UI_INPUT_DOWN_PULLUP ~~~ UI_INPUT_LEFT_PULLUP ~~~ UI_INPUT_RIGHT_PULLUP ~~~ UI_INPUT_OK_PULLUP",
        "  UI_INPUT_OK_PULLUP ~~~ UI_INPUT_BACK_PULLUP ~~~ UI_INPUT_OPT_PULLUP ~~~ UI_INPUT_F1_PULLUP ~~~ UI_INPUT_F2_PULLUP ~~~ UI_INPUT_ENCODER_PULLUP ~~~ UI_MATRIX_ESD ~~~ REAR_CONTROL_ESD",
        "  REAR_CONTROL_ESD ~~~ UI_DPAD_SWITCH ~~~ UI_SWITCH_BACK ~~~ UI_SWITCH_OPT ~~~ UI_SWITCH_F1 ~~~ UI_SWITCH_F2",
        "  UI_SWITCH_F2 ~~~ ENCODER ~~~ ENCODER_A_PULLUP ~~~ ENCODER_B_PULLUP ~~~ ENCODER_PTT_ESD ~~~ PTT_PULLUP ~~~ PTT_SERIES ~~~ PTT_FILTER_CAP ~~~ PTT_RAW ~~~ TOUCH_IRQ_PULLUP ~~~ TOUCH_IRQ_RAW ~~~ TOUCH_IRQ_BUFFER ~~~ TOUCH_IRQ_BUFFER_BYPASS",
