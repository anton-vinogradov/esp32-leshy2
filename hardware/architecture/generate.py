    ...
    for candidate in candidates:
        ...
        if interboard is not None:
            ...
            required_nets = {
                ...
                "RF_RESET_KILL_GATE", "S3_RESET_KILL_GATE", "UI_F1_N", "UI_F2_N",
...
def render_public_interconnect(
    ...
    if russian:
        ...
        footer = (
            ...
            "разъёма при одновременной нагрузке. Два резервных контакта остаются "
        ...
        footer = (
            ...
            "measurement under simultaneous load. Two reserve contacts remain physically "
            "unconnected."
        )
        ui_groups = (
...
def _render_principled_pinout_bundle(
    ...
    def evidence_role(instance: str) -> str:
        fixed = {
            ...
            "evidence_mask": "AON eight-bit evidence source mask on the private safety I2C bus",
