    ...
    for candidate in candidates:
        ...
        if interboard is not None:
            ...
            required_nets = {
                ...
                "FAULT_ASSERT_N", "S3_RESET_KILL_GATE",
...
def render_target_principled_section(
    ...
    if russian:
        ...
        roles = {
            ...
            "voice": "аналоговый UHF 400–480 МГц voice transceiver",
            "voice_v": "аналоговый VHF 134–174 МГц voice transceiver",
            ...
            "voice_external_sma": "SMA порт UHF 400–480 МГц voice",
            "voice_v_external_sma": "SMA порт VHF 134–174 МГц voice",
            ...
            "safe_rearm_buffer": "Schmitt-формирователь задержанного физического re-arm",
            "safe_latch": "асинхронная защёлка RUN_PERMIT / FAULT_KILL",
        ...
        labels = {
            ...
            "rf_ports": "Ten independent antenna ports",
        ...
        roles = {
            ...
            "voice": "analog UHF 400–480-MHz voice transceiver",
            "voice_v": "analog VHF 134–174-MHz voice transceiver",
            ...
            "voice_external_sma": "UHF 400–480-MHz voice SMA port",
            "voice_v_external_sma": "VHF 134–174-MHz voice SMA port",
            ...
            "safe_rearm_buffer": "delayed physical re-arm Schmitt buffer",
            "safe_latch": "asynchronous RUN_PERMIT / FAULT_KILL latch",
    ...
    diagrams = [
        ...
        (
            ...
            [
                ...
                node("safety_watchdog"), node("safe_conditioner"),
                node("safe_rearm_buffer"), node("safe_latch"),
            ],
            [
        ...
        (
            ...
            [
                ...
                node("voice_v"), node("voice_v_external_sma"),
            ],
            [
        ...
        (
            ...
            [
                ...
                node("safe_conditioner"), node("safe_rearm_buffer"), node("safe_latch"),
...
компонент имеет MPN, физические контакты, footprint, цепи и явные no-connect;
изготовляемые test-площадки явно исключены из BOM.

| Лист | Состояние | Замкнутая электрическая часть |
|---|---|---|
| [`UI_00_ROOT`](../hardware/ecad/kicad/LESHY2-UI/LESHY2-UI.kicad_sch) | точный ECAD | 9 дочерних листов, 95 межлистовых цепей, 232 явных pins/labels |
...
| [`UI_11_DISPLAY_TOUCH_STORAGE`](../hardware/ecad/kicad/LESHY2-UI/UI_11_DISPLAY_TOUCH_STORAGE.kicad_sch) | точный ECAD | 49 экземпляров, все 40 контактов display, все 11 контактов microSD, backlight/touch/isolation и 18 интерфейсов |
...
| [`UI_13_AUDIO_CODEC_HEADSET`](../hardware/ecad/kicad/LESHY2-UI/UI_13_AUDIO_CODEC_HEADSET.kicad_sch) | точный ECAD | 104 компонента, 21 контакт codec, 6 контактов CTIA jack, 5 аналоговых селекторов, power/interface isolation и 24 интерфейса |
| [`UI_20_C5_RADIO_IR_SERVICE`](../hardware/ecad/kicad/LESHY2-UI/UI_20_C5_RADIO_IR_SERVICE.kicad_sch) | точный ECAD | 59 BOM-компонентов плюс заводской ANT1, 32 carrier-pad C5, два IR RX, fail-closed IR TX, data-only USB/recovery и 18 интерфейсов |
...
[RF-side TX safety/evidence](../hardware/ecad/generated/H2-RF50-tx-safety-evidence.json) и
...
| [`UI_13_AUDIO_CODEC_HEADSET`](../hardware/ecad/kicad/LESHY2-UI/UI_13_AUDIO_CODEC_HEADSET.kicad_sch) | exact ECAD | 104 components, 21 codec contacts, 6 CTIA-jack contacts, 5 analog selectors, power/interface isolation and 24 interfaces |
...
def render_public_interconnect(
    ...
    if russian:
        ...
        rf_groups = (
            f"Радиодомен реального времени: `{mpn('rp')}`, три `{mpn('nrf0')}`, `{mpn('cc')}`, `{mpn('voice')}` и `{mpn('voice_v')}`.",
        ...
        rf_groups = (
            f"Real-time radio domain: `{mpn('rp')}`, three `{mpn('nrf0')}`, `{mpn('cc')}`, `{mpn('voice')}` and `{mpn('voice_v')}`.",
...
def _render_principled_pinout_bundle(
    ...
    ir_roles = {
        ...
        "ir_emitter_limit": "47-Ohm 1206 derated emitter current-limit resistor",
        "ir_tx_mosfet": "FAULT_KILL-qualified low-side IR emitter switch",
        "ir_tx_carrier_pulldown": "10-kOhm IR-carrier input fail-low resistor",
    ...
    evidence_support_instance_names = (
        ...
        "fault_assert_sense_series", "evidence_mask_p12_pulldown",
    ...
    def evidence_role(instance: str) -> str:
        fixed = {
            ...
            "fault_assert_sense_series": "100-kOhm isolated FAULT_ASSERT_N proof-sense resistor to P11",
    ...
    lines = [
        ...
        node("main_buck", "feedback-set 3.222-V 4-A main converter"),
        ...
        node("main_fb_top", "43.7-kOhm 0.1% main feedback top resistor"),
        node("main_fb_bottom", "10-kOhm 0.1% main feedback bottom resistor"),
        ...
        node("ext_rilm", "1.82-kOhm 1% eFuse current-limit resistor"),
        ...
        node("nrf_backup_gate", "independent FAULT_ASSERT_N nRF rail qualifier"),
        node("nrf_backup_gate_bypass", "100-nF nRF backup-gate bypass capacitor"),
        ...
        *[node(instance, voice_rf_roles[instance]) for instance in voice_rf_support_instance_names],
        node("voice_external_sma", "UHF dedicated 6-GHz IP67 standard-SMA edge-launch jack"),
        node("voice_v_external_sma", "VHF dedicated 6-GHz IP67 standard-SMA edge-launch jack"),
        ...
        node("unit_rilm", "1.82-kOhm native-Unit eFuse current-limit resistor"),
        ...
        *[node(instance, ir_roles[instance]) for instance in ir_instance_names],
        ...
        node("fault_assert_backup_pulldown", "1-MOhm fail-low FAULT_ASSERT_N backup bias"),
        ...
        node("safe_rearm_delay_res", "100-kOhm physical re-arm delay resistor"),
        node("safe_rearm_delay_cap", "2.2-uF physical re-arm delay capacitor"),
        node("safe_rearm_buffer", "SN74LVC1G17 physical re-arm Schmitt buffer"),
        node("safe_rearm_buffer_bypass", "100-nF re-arm-buffer bypass capacitor"),
        node("safe_latch", "asynchronous RUN_PERMIT / FAULT_KILL latch"),
        node("safe_latch_bypass", "100-nF asynchronous-latch bypass capacitor"),
        node("safe_latch_d_pullup", "10-kOhm physical fixed-high latch-D resistor"),
        ...
        node("safe_c5_reset_buffer", "UI-local RUN_PERMIT C5 reset inverter"),
        node("safe_c5_reset_buffer_bypass", "100-nF UI-local primary C5 reset bypass"),
        node("safe_c5_reset_gate_pullup", "10-kOhm UI-local C5 reset-gate pull-up"),
        node("safe_c5_fault_reset_buffer", "UI-local direct FAULT_ASSERT_N C5 reset sink"),
        node("safe_c5_fault_reset_buffer_bypass", "100-nF direct C5 fault-reset bypass"),
        node("safe_fault_reset_buffer", "direct FAULT_ASSERT_N RP reset and voice clamp"),
        node("safe_fault_reset_buffer_bypass", "100-nF independent fault-buffer bypass capacitor"),
        ...
        *[node(instance, evidence_role(instance)) for instance in evidence_support_instance_names],
        ...
        "  EXT_OVLO_BOTTOM ~~~ EXT_INPUT_CAP ~~~ EXT_OUTPUT_CAP ~~~ EXT_BLEEDER ~~~ NRF_POWER_SWITCH ~~~ NRF_BACKUP_GATE ~~~ NRF_BACKUP_GATE_BYPASS ~~~ CC_POWER_SWITCH ~~~ SD_POWER_SWITCH ~~~ CODEC_POWER_SWITCH ~~~ RECEIVER_POWER_SWITCH ~~~ S3 ~~~ S3_SUPPLY_BULK ~~~ S3_SUPPLY_BYPASS ~~~ S3_RESET_DELAY_CAP ~~~ SLOW_IO",
        ...
        "  VOICE ~~~ VOICE_V ~~~ " + " ~~~ ".join(instance.upper() for instance in voice_rf_support_instance_names) + " ~~~ VOICE_EXTERNAL_SMA ~~~ VOICE_V_EXTERNAL_SMA ~~~ " + " ~~~ ".join(instance.upper() for instance in expansion_instance_names) + " ~~~ UNIT_CONNECTOR ~~~ U214_CONNECTOR ~~~ U214 ~~~ PTT_SWITCH ~~~ POWER_COMMAND_SWITCH ~~~ RUN_LOOP_PULLUP ~~~ RUN_LOOP_FILTER ~~~ SAFETY_CONTROL_ESD",
        "  SAFETY_CONTROL_ESD ~~~ RUN_LOOP ~~~ SAFE_SUPERVISOR ~~~ SAFE_SUPERVISOR_BYPASS ~~~ SAFE_POR_PULLUP ~~~ SAFETY_CONTROLLER ~~~ SAFETY_WATCHDOG ~~~ SAFE_RUN_FAULT_ISO ~~~ SAFE_RUN_FAULT_ISO_BYPASS ~~~ FAULT_ASSERT_PULLUP ~~~ FAULT_ASSERT_BACKUP_PULLDOWN ~~~ SAFE_CONDITIONER ~~~ SAFE_CONDITIONER_BYPASS ~~~ SAFE_REARM_DELAY_RES ~~~ SAFE_REARM_DELAY_CAP ~~~ SAFE_REARM_BUFFER ~~~ SAFE_REARM_BUFFER_BYPASS",
        "  SAFE_REARM_BUFFER_BYPASS ~~~ SAFE_LATCH ~~~ SAFE_LATCH_BYPASS ~~~ SAFE_LATCH_D_PULLUP ~~~ SAFE_RESET_BUFFER ~~~ SAFE_RESET_BUFFER_BYPASS ~~~ SAFE_C5_RESET_BUFFER ~~~ SAFE_C5_RESET_BUFFER_BYPASS ~~~ SAFE_C5_RESET_GATE_PULLUP ~~~ SAFE_C5_FAULT_RESET_BUFFER ~~~ SAFE_C5_FAULT_RESET_BUFFER_BYPASS ~~~ SAFE_FAULT_RESET_BUFFER ~~~ SAFE_FAULT_RESET_BUFFER_BYPASS ~~~ SAFE_RESET_GATE_PULLUP ~~~ S3_RESET_GATE_PULLUP ~~~ SAFE_RESET_SINK_A ~~~ SAFE_RESET_SINK_B ~~~ S3_RESET_PULLUP ~~~ C5_RESET_PULLUP ~~~ RP_RESET_PULLUP ~~~ SAFE_GATE_A ~~~ SAFE_GATE_A_BYPASS ~~~ SAFE_GATE_B ~~~ SAFE_GATE_B_BYPASS ~~~ SAFE_PTT_OR ~~~ SAFE_PTT_OR_BYPASS ~~~ FAULT_LED_SERIES ~~~ FAULT_LED",
        "  FAULT_LED ~~~ DET_S3 ~~~ DET_C5 ~~~ DET_NRF0 ~~~ DET_NRF1 ~~~ DET_NRF2",
        "  DET_NRF2 ~~~ DET_CC ~~~ DET_VOICE ~~~ DET_VOICE_V ~~~ DET_IR ~~~ " + " ~~~ ".join(instance.upper() for instance in evidence_support_instance_names),
        ...
        "  SAFETY_CONTROLLER -->|\"deadline service\"| SAFETY_WATCHDOG -->|\"FAULT_ASSERT_N\"| SAFE_GATE_B -->|\"SAFE_CLEAR_N\"| SAFE_LATCH",
        "  FAULT_ASSERT_PULLUP --> FAULT_ASSERT_BACKUP_PULLDOWN",
        "  FAULT_ASSERT_PULLUP --> SAFE_FAULT_RESET_BUFFER",
        "  SAFE_CONDITIONER -->|\"RUN_EDGE\"| SAFE_REARM_BUFFER -->|\"SAFE_REARM_CLK\"| SAFE_LATCH",
        "  SAFE_LATCH -->|\"RUN_PERMIT\"| SAFE_RESET_BUFFER -->|\"RF_RESET_KILL_GATE\"| SAFE_RESET_SINK_B",
        "  SAFE_LATCH -->|\"RUN_PERMIT via M1\"| SAFE_C5_RESET_BUFFER --> SAFE_C5_RESET_GATE_PULLUP --> SAFE_RESET_SINK_A",
        "  FAULT_ASSERT_PULLUP -->|\"FAULT_ASSERT_N via M1\"| SAFE_C5_FAULT_RESET_BUFFER -->|\"direct C5 reset\"| C5",
        ...
        "  SAFE_FAULT_RESET_BUFFER -->|\"fault clamp\"| VOICE_EFUSE",
        ...
        "  VOICE_V -->|\"5.1-kOhm actual-TX sample\"| VOICE_V_DETECTOR_SERIES_ATTENUATOR --> DET_VOICE_V",
        "  DET_VOICE_V -->|\"52.3-Ohm RFIN shunt\"| VOICE_V_DETECTOR_MATCH",
        "  VOICE_V_DETECTOR_FILTER --> DET_VOICE_V",
        "  VOICE_V_DETECTOR_BYPASS --> DET_VOICE_V",
        "  SAFE_GATE_B --> VOICE_V_EVIDENCE_HOLD_DIODE --> VOICE_V_EVIDENCE_HOLD_CAP",
        "  VOICE_V_EVIDENCE_HOLD_DIODE --> VOICE_V_EVIDENCE_HOLD_PULLDOWN",
        "  VOICE_V_EVIDENCE_HOLD_DIODE --> DET_VOICE_V",
        ...
        "  SAFE_SUPERVISOR_BYPASS --> SAFE_SUPERVISOR --> SAFE_GATE_B --> SAFE_LATCH",
        "  SAFE_LATCH_BYPASS --> SAFE_LATCH",
        "  SAFE_LATCH_D_PULLUP -->|\"fixed D=1\"| SAFE_LATCH",
        "  SAFETY_CONTROLLER --> SAFETY_WATCHDOG --> SAFE_GATE_B",
        "  SAFETY_CONTROLLER --> SAFETY_FAULT_REQUEST_ISO --> SAFE_GATE_B",
        ...
        "  SAFE_LATCH -->|\"RUN_PERMIT via M1\"| SAFE_C5_RESET_BUFFER --> SAFE_C5_RESET_GATE_PULLUP --> SAFE_RESET_SINK_A",
        "  FAULT_ASSERT_PULLUP -->|\"FAULT_ASSERT_N via M1\"| SAFE_C5_FAULT_RESET_BUFFER -->|\"CHIP_PU\"| C5",
        ...
        "  SAFE_GATE_A --> NRF_BACKUP_GATE --> NRF_POWER_SWITCH",
        "  FAULT_ASSERT_PULLUP --> NRF_BACKUP_GATE",
        ...
        "  SAFE_GATE_B --> CC_BACKUP_GATE --> CC_POWER_SWITCH",
        "  FAULT_ASSERT_PULLUP --> CC_BACKUP_GATE",
        ...
        "  VOICE_V_EVIDENCE_THRESHOLD_TOP --> VOICE_V_EVIDENCE_THRESHOLD_BOTTOM --> EVIDENCE_CMP_VOICE_V",
        "  VOICE_V_EVIDENCE_HYSTERESIS --> EVIDENCE_CMP_VOICE_V",
        ...
        "  EVIDENCE_CMP_VOICE_V --> EVIDENCE_OR_3",
