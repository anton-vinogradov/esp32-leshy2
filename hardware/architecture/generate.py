...
def _render_principled_pinout_bundle(
    ...
    lines = [
        ...
        *[node(instance, evidence_role(instance)) for instance in evidence_support_instance_names],
        ...
        "  SAFETY_CONTROL_ESD ~~~ RUN_LOOP ~~~ SAFE_SUPERVISOR ~~~ SAFE_SUPERVISOR_BYPASS ~~~ SAFE_POR_PULLUP ~~~ SAFETY_CONTROLLER ~~~ SAFETY_WATCHDOG ~~~ SAFE_CONDITIONER ~~~ SAFE_CONDITIONER_BYPASS ~~~ SAFE_REARM_DELAY_RES ~~~ SAFE_REARM_DELAY_CAP ~~~ SAFE_REARM_BUFFER ~~~ SAFE_REARM_BUFFER_BYPASS",
        "  SAFE_REARM_BUFFER_BYPASS ~~~ SAFE_LATCH ~~~ SAFE_LATCH_BYPASS ~~~ SAFE_LATCH_D_PULLUP ~~~ SAFE_RESET_BUFFER ~~~ SAFE_RESET_BUFFER_BYPASS ~~~ SAFE_RESET_GATE_PULLUP ~~~ S3_RESET_GATE_PULLUP ~~~ SAFE_RESET_SINK_A ~~~ SAFE_RESET_SINK_B ~~~ S3_RESET_PULLUP ~~~ C5_RESET_PULLUP ~~~ RP_RESET_PULLUP ~~~ SAFE_GATE_A ~~~ SAFE_GATE_A_BYPASS ~~~ SAFE_GATE_B ~~~ SAFE_GATE_B_BYPASS ~~~ SAFE_PTT_OR ~~~ SAFE_PTT_OR_BYPASS ~~~ FAULT_LED_SERIES ~~~ FAULT_LED",
