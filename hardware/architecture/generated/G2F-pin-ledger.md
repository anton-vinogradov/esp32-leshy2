...
| `alps_skrtlae010` | `Alps Alpine SKRTLAE010` | `verified_exact_external_service_boot_reset_switch` | `standard_active_orderable` | [SKRTLAE010 official product page, dimensions, land pattern and circuit diagram live manufacturer product record](https://tech.alpsalpine.com/e/products/detail/SKRTLAE010/) | same primary source |
...
| `m5_u214` | `M5Stack U214 Cap LoRa-1262` | `verified_candidate` | `active` | [M5Stack Cap LoRa-1262 product documentation and official model-size drawing live product page / U214-00 dimension drawing](https://docs.m5stack.com/en/cap/Cap_LoRa-1262) | same primary source |
...
| `omron_b3s_1100p` | `OMRON B3S-1100P` | `verified_exact_direct_press_control_mechanical_hil_open` | `active_orderable` | [OMRON B3S Sealed Tactile Switch SMT datasheet B3S p2 terminal arrangement/internal connections, TOP view: 4/3 top, 2/1 bottom, ground 5; visually checked 2026-09-07](https://omronfs.omron.com/en_US/ecb/products/pdf/en-b3s.pdf) | same primary source |
...
| `ti_sn74lvc1g17_dckr` | `SN74LVC1G17DCKR` | `verified_exact_schmitt_buffer` | `active_orderable` | [SN74LVC1G17 Single Schmitt-Trigger Buffer datasheet Rev. Y, revised October 2025](https://www.ti.com/lit/ds/symlink/sn74lvc1g17.pdf) | same primary source |
...
| `ti_tpd2eusb30a_drtr` | `Texas Instruments TPD2EUSB30ADRTR` | `verified_exact_service_usb_esd` | `active_orderable` | [TPD2EUSB30A two-channel ESD protection datasheet SLVSAC2G, revised June 2021; DRT-3 drawings 4206292-2/D and 4211172/A visually checked; nominal 1.0x0.8-mm body, 0.50-mm maximum height](https://www.ti.com/lit/ds/symlink/tpd2eusb30a.pdf) | same primary source |
...
| `ti_tps3808g33_dbvr` | `TPS3808G33DBVR` | `verified_candidate` | `active` | [TPS3808 Low-Quiescent-Current Programmable-Delay Supervisory Circuit datasheet Rev. N, revised August 2026](https://www.ti.com/lit/ds/symlink/tps3808.pdf) | same primary source |
| `ti_tps3839k33_dbzr` | `Texas Instruments TPS3839K33DBZR` | `verified_candidate` | `active` | [TPS383x 150-nA Ultralow Power Supply Voltage Monitor datasheet SBVS193D, section 6: DBZ top-view GND=1, RESET=2, VDD=3; visually rechecked 2026-09-07](https://www.ti.com/lit/ds/symlink/tps3839.pdf) | same primary source |
...
| `uniroyal_0402wgf1603tce` | `UNI-ROYAL 0402WGF1603TCE` | `verified_exact_jlcpcb_stocked_standard_pcba` | `active_factory_stocked_standard_pcba` | [UNI-ROYAL Thick Film Chip Resistors official datasheet 2025-07-28 V.10](https://www.uni-royal.cn/en/images/userfile/file/1753752986c56505e6d9ab55c7.pdf) | same primary source |
...
| `yageo_cc0603krx7r0bb104` | `Yageo CC0603KRX7R0BB104` | `verified_no_worse_jlcpcb_stocked_standard_pcba` | `active_factory_stocked_standard_pcba` | [YAGEO CC0603KRX7R0BB104 exact product specification generated 2026-07-09](https://www.yageogroup.com/download/specsheet/CC0603KRX7R0BB104) | same primary source |
...
- Candidate status: `target_architecture_pre_schematic_reviewed`
- Validation scope: exposed-contact identity, unique allocation, strap proof, complete GPIO accounting, controller declaration, reciprocal programmable links and service-contact coverage.
