...
| `C5_FIXED_SDIO` | `c5.SDIO_SLAVE` | `GPIO7`, `GPIO8`, `GPIO9`, `GPIO10` | ESP32-C5 chip revision v1.0 or later uses fixed 1-bit SDIO-slave DAT1/IRQ, DAT0, CLK and CMD contacts; Espressif marks revision v0.1 SDIO unsupported; GPIO13/14 remain independent native USB |
