...
EXPECTED_GROUPS = {
    ...
    "rf_rp": [
        ...
        {16, 17, 18, 20, 21, 22}, {19, 24, 25, 26, 27}, {28, 29}, {35}, {36},
        {15}, {32, 33, 34, 37, 38},
    ],
}
    ...
    lines = [
        ...
        (
            ...
            + (
                ...
                "текущий маркер физического дизайна: **`H1-R2.38`**."
                if russian
                else f"Pin-map artifact marker: **`{source['marker']}`**; current physical-design marker: **`H1-R2.38`**."
            )
        ), "",
    ]
    for domain in ("hub_rp", "rf_rp"):
