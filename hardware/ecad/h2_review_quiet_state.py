...
GROUP_EVIDENCE = {
    "N24_QUIET": {
        ...
        "nets": {
            ...
            "NRF_GROUP_PWR_EN_PRIMARY": {"safe_gate_a", "nrf_backup_gate"},
            "NRF_GROUP_PWR_EN_SAFE": {"nrf_backup_gate", "nrf_power_switch", "nrf_power_on_pulldown"},
            "FAULT_ASSERT_N": {"m1_rf_receptacle", "nrf_backup_gate"},
        },
    ...
    "CC_QUIET": {
        ...
        "nets": {
            ...
            "CC_PWR_EN_PRIMARY": {"safe_gate_b", "cc_backup_gate"},
            "CC_PWR_EN_SAFE": {"cc_backup_gate", "cc_power_switch", "cc_power_on_pulldown"},
            "FAULT_ASSERT_N": {"m1_rf_receptacle", "cc_backup_gate"},
        },
        "class": "rail_off_plus_bidirectional_signal_isolation",
    },
    "U214_CAP_QUIET": {
        ...
        "nets": {
            ...
            "FAULT_ASSERT_N": {"m1_rf_receptacle", "ext_branch_gate"},
        },
    ...
    "VOICE_QUIET": {
        ...
        "instances": ("voice_buck", "voice_en_pulldown", "voice_efuse", "safe_gate_b",
                      "voice_efuse_en_pullup", "safe_fault_reset_buffer",
                      "safe_ptt_or", "voice_control_mux_b", "voice_ptt_pullup",
                      "voice_v_ptt_pullup", "voice_supervisor", "voice_band_io",
                      "voice_band_inverter", "voice_pd_gate"),
        "nets": {
            ...
            "VOICE_EFUSE_BACKUP_EN_N": {"voice_efuse_en_pullup", "safe_fault_reset_buffer", "voice_efuse"},
            "FAULT_ASSERT_N": {"m1_rf_receptacle", "safe_fault_reset_buffer"},
            "VOICE_PTT_REQ_N": {"rp", "safe_ptt_or"},
            "VOICE_PTT_SAFE_N": {"safe_ptt_or", "voice_control_mux_b"},
            "VOICE_U_PTT_N": {"voice_control_mux_b", "voice_ptt_pullup", "voice"},
            "VOICE_V_PTT_N": {"voice_control_mux_b", "voice_v_ptt_pullup", "voice_v"},
            "VOICE_READY": {"voice_supervisor", "voice_pd_gate"},
            "VOICE_V_SELECT": {"voice_band_io", "voice_band_inverter", "voice_pd_gate", "voice_control_mux_b"},
            "VOICE_U_PD": {"voice_pd_gate", "voice"},
            "VOICE_V_PD": {"voice_pd_gate", "voice_v"},
        },
    ...
    "VOICE_INTERFACE_QUIET": {
        "project": "LESHY2-RF",
        "instances": ("voice_io_power_switch", "voice_control_mux_a",
                      "voice_control_mux_b", "voice_audio_mux", "voice_band_io",
                      "voice_band_inverter", "voice_pd_gate", "voice_hl_driver"),
        "nets": {
            "VVOICE_IO_3V3": {"voice_io_power_switch", "voice_control_mux_a", "voice_control_mux_b", "voice_audio_mux"},
            "VOICE_V_SELECT": {"voice_band_io", "voice_control_mux_a", "voice_control_mux_b", "voice_audio_mux", "voice_pd_gate"},
            "VOICE_PTT_SAFE_N": {"safe_ptt_or", "voice_control_mux_b"},
            "VOICE_UART_TX": {"rp", "voice_control_mux_a"},
            "VOICE_UART_RX": {"rp", "voice_control_mux_a"},
            "VOICE_AUDIO_ON_N": {"rp", "voice_control_mux_b"},
            "VOICE_HL_OPEN_DRAIN": {"voice_hl_driver", "voice", "voice_v"},
        },
    ...
    "IR_QUIET": {
        ...
        "instances": ("ir_power_switch", "ir_power_on_pulldown", "ir_return_buffer",
                      "safe_c5_fault_reset_buffer",
                      "ir_safe_gate", "ir_tx_mosfet", "ir_tx_gate_pulldown"),
        "nets": {
            "IR_FRONTEND_PWR_EN": {"c5", "ir_power_switch", "ir_power_on_pulldown"},
            "FAULT_ASSERT_N": {"m1_ui_plug", "safe_c5_fault_reset_buffer"},
        },
