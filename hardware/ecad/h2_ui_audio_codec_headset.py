...
def footprint_for(instance: str, device_key: str) -> str:
    ...
    if device_key.startswith(("yageo_rc", "uniroyal_0402wgf", "panasonic_erj_2r", "vishay_crcw")):
...
def main() -> int:
    ...
    if args.write:
        ...
        if stale:
            ...
            return 1
        print("ok: H2.2.5 audio codec/headset sheet reproduces its historical R1 input (not current R2 evidence)")
    if args.kicad_check:
        kicad_check()
    return 0
