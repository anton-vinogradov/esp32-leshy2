...
def build() -> tuple[str, dict]:
    ...
    if ledger.get("status") != "reviewed_complete_circuit_inventory" or len(ledger["rows"]) != 1048:
        raise ValueError("H2 instance ledger is not the reviewed 1,048-row inventory")
