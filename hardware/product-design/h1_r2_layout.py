...
def render_doc(model: dict, result: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        bullets = [
            ...
            "Панель приклеивается прямо к плоской, свободной от компонентов внешней площадке UI-PCB одной вырубной периметральной рамкой PSA целевой толщины 0,17 мм. Отдельной рамки, угловых удерживающих рёбер и задней пены нет. Совмещение задают метки платы и съёмный установочный шаблон; PCB и PSA несут касание, отрыв и сдвиг, а FPC и ZIF нагрузки панели не несут.",
