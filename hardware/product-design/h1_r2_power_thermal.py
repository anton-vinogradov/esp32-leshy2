...
def render_doc(model: dict, result: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        footer = f'> Маркер результата: **{model["marker"]}**. Включено в проведённое ревью H1-R2.38.'
    else:
        ...
        footer = f'> Result marker: **{model["marker"]}**. Included in the reviewed H1-R2.38 result.'
