...
LANES_RU = {
    ...
    "main-rf-mechanics": (
        ...
        "Оставить GCT без общей рамки; безопасная экономия сейчас равна $0. Возвращаться к замене только для складской standard/reverse edge-launch пары до 6 ГГц с не большим профилем и контролируемым чертежом под плату 1,6 мм.",
    ),
    ...
    "ordinary-controls": (
        ...
        "B3S-1100P дают $10,25 на устройство и $74,58 за 80 штук для партии из пяти устройств. Первый складской кандидат отклонён: у него нет заземлённого вывода крышки.",
        "Сохранить посадку, достижимость из корпуса, усилие, высоту, ресурс, ESD-границу и утопленное нажатие.",
    ),
    "native-rf-jumpers": (
