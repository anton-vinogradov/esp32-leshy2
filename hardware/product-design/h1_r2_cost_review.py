...
LANES_RU = {
    "factory-preorder-penalty": (
        ...
        "После трёх безопасных пакетов 34 оставшиеся pre-order-строки стоят $726,0450 в нормализованном снимке партии из пяти устройств против $336,7395 по серийной материальной базе. Складской буфер Nexperia, байпасный конденсатор YAGEO и шесть номиналов UNI-ROYAL вместе убирают около $98,2581 из наблюдаемого маршрута и снижают публичную материальную базу на $1,5404 на устройство.",
