...
export default () => (
  <board width="80mm" height="140mm">
    ...
    <chip name="J1" pcbX="-12.8mm" pcbY="-66.0mm" footprint="jlcpcb:C2988369" />
    <resistor name="Rcc1" pcbX="-22.8mm" pcbY="-48.5mm" resistance="5.1k" footprint="0402" />
    <resistor name="Rcc2" pcbX="-17.3mm" pcbY="-48.5mm" resistance="5.1k" footprint="0402" />
    {/* VBUS bulk (10uF) + TVS/ESD (D1 proxy) on the J1 5 V input */}
    <capacitor name="Cvbus" pcbX="-33.8mm" pcbY="-54.0mm" capacitance="10uF" footprint="0805" />
    <resistor name="D1" pcbX="-28.3mm" pcbY="-54.0mm" resistance="1M" footprint="0603" /> {/* TVS proxy on VBUS_S3 */}
    {/* J2 -> C5 : data only, VBUS = ESD stub */}
    <chip name="J2" pcbX="17.2mm" pcbY="-66.0mm" footprint="jlcpcb:C2988369" />

    {/* ===================== BQ25887 2S BOOST charger ===================== */}
    <chip name="U2" pcbX="-33.8mm" pcbY="-32.0mm" footprint="jlcpcb:C2761614" />
    <inductor name="L1" pcbX="-28.3mm" pcbY="-32.0mm" inductance="2.2uH" footprint="1210" /> {/* boost inductor PMID<->SW */}
    <capacitor name="Cvbusic" pcbX="-22.8mm" pcbY="-32.0mm" capacitance="1uF" footprint="0402" /> {/* >=1uF at VBUS pin */}
    <capacitor name="Cpmid" pcbX="-17.3mm" pcbY="-32.0mm" capacitance="10uF" footprint="0805" /> {/* PMID input cap (25V) */}
    <capacitor name="Cregn" pcbX="-33.8mm" pcbY="-37.5mm" capacitance="4.7uF" footprint="0805" /> {/* REGN LDO bypass */}
    <capacitor name="Cbtst" pcbX="-28.3mm" pcbY="-37.5mm" capacitance="47nF" footprint="0402" /> {/* BTST->SW bootstrap */}
    <capacitor name="Csns" pcbX="-22.8mm" pcbY="-37.5mm" capacitance="47uF" footprint="1210" /> {/* SNS boost-output cap (ds 44uF) */}
    <capacitor name="Cbat" pcbX="-17.3mm" pcbY="-37.5mm" capacitance="10uF" footprint="0805" /> {/* BAT decoupling */}
    <resistor name="Rilim" pcbX="-33.8mm" pcbY="-43.0mm" resistance="383" footprint="0402" /> {/* input current limit set */}
    <resistor name="Rmid" pcbX="-28.3mm" pcbY="-43.0mm" resistance="300" footprint="0402" /> {/* MID cell-mid sense series */}
    <resistor name="Rcbset" pcbX="-22.8mm" pcbY="-43.0mm" resistance="10" footprint="0402" /> {/* cell-balance current limit (~9.5R) */}
    <resistor name="Rts_top" pcbX="-17.3mm" pcbY="-43.0mm" resistance="5.23k" footprint="0402" /> {/* TS divider top REGN->TS */}
    <resistor name="RT1" pcbX="-33.8mm" pcbY="-48.5mm" resistance="10k" footprint="0603" /> {/* 103AT NTC to GND (TS bottom) */}
    <resistor name="RT2" pcbX="-28.3mm" pcbY="-48.5mm" resistance="30.1k" footprint="0402" /> {/* TS: parallel to 103AT NTC (BQ25887 ref) */}

    {/* ===================== 2S pack + protection (S-8252A, low-side, common-drain) ===================== */}
    <chip name="BT1" pcbX="2.2mm" pcbY="-10.0mm" layer="bottom" footprint="pinrow3" pinLabels={{ pin1: "P_PLUS", pin2: "MID", pin3: "P_MINUS" }} />
    <chip name="U3" pcbX="18.2mm" pcbY="-32.0mm" footprint="jlcpcb:C468224" />
    ...
    <chip name="Q1" pcbX="24.7mm" pcbY="-32.0mm" footprint="jlcpcb:C20917" />
    <chip name="Q2" pcbX="31.2mm" pcbY="-32.0mm" footprint="jlcpcb:C20917" />
    <resistor name="Rvdd" pcbX="18.2mm" pcbY="-38.0mm" resistance="470" footprint="0402" /> {/* R1: VDD series to B+ */}
    <resistor name="Rvc" pcbX="24.7mm" pcbY="-38.0mm" resistance="470" footprint="0402" />  {/* R2: VC series to cell-mid */}
    <resistor name="Rvm" pcbX="31.2mm" pcbY="-38.0mm" resistance="2k" footprint="0402" />   {/* R3: VM series to EB-/GND */}
    <capacitor name="Cvdd" pcbX="18.2mm" pcbY="-44.0mm" capacitance="0.1uF" footprint="0402" /> {/* C1: VDD-VSS */}
    <capacitor name="Cvc" pcbX="24.7mm" pcbY="-44.0mm" capacitance="0.1uF" footprint="0402" />  {/* C2: VC-VSS */}
    <resistor name="F1" pcbX="31.2mm" pcbY="-44.0mm" resistance="0.05" footprint="1210" />  {/* PPTC fuse proxy (pack +) */}
    <resistor name="SW1" pcbX="18.2mm" pcbY="-50.0mm" resistance="0.01" footprint="1210" /> {/* master switch proxy (pack +) */}

    {/* ===================== +5 V buck : MP2315 ===================== */}
    <chip name="U4" pcbX="-8.8mm" pcbY="-31.0mm" footprint="jlcpcb:C45889" />
    <inductor name="L2" pcbX="-4.2mm" pcbY="-31.0mm" inductance="4.7uH" footprint="1210" />
    <capacitor name="Cin5" pcbX="0.4mm" pcbY="-31.0mm" capacitance="22uF" footprint="0805" />
    <capacitor name="Cout5" pcbX="5.0mm" pcbY="-31.0mm" capacitance="22uF" footprint="0805" />
    <capacitor name="Cbst4" pcbX="9.6mm" pcbY="-31.0mm" capacitance="100nF" footprint="0402" /> {/* bootstrap BST->SW */}
    <resistor name="Rbst4" pcbX="-8.8mm" pcbY="-36.0mm" resistance="20" footprint="0402" /> {/* MP2315 bootstrap series R (datasheet-required) */}
    <capacitor name="Cvcc4" pcbX="-4.2mm" pcbY="-36.0mm" capacitance="0.1uF" footprint="0402" /> {/* VCC decouple */}
    <resistor name="Raam4" pcbX="0.4mm" pcbY="-36.0mm" resistance="100k" footprint="0402" /> {/* AAM light-load set */}
    <resistor name="R1" pcbX="5.0mm" pcbY="-36.0mm" resistance="52.3k" footprint="0402" />
    <resistor name="R2" pcbX="9.6mm" pcbY="-36.0mm" resistance="10k" footprint="0402" />

    {/* ===================== +3V3 buck : MP2315 (wide Vin — sits on 8.4 V BAT) ===================== */}
    <chip name="U5" pcbX="-8.8mm" pcbY="-41.0mm" footprint="jlcpcb:C45889" />
    <inductor name="L3" pcbX="-4.2mm" pcbY="-41.0mm" inductance="2.2uH" footprint="1210" />
    <capacitor name="Cin3" pcbX="0.4mm" pcbY="-41.0mm" capacitance="22uF" footprint="0805" />
    <capacitor name="Cout3" pcbX="5.0mm" pcbY="-41.0mm" capacitance="22uF" footprint="0805" />
    <capacitor name="Cbst5" pcbX="9.6mm" pcbY="-41.0mm" capacitance="100nF" footprint="0402" /> {/* bootstrap BST->SW */}
    <resistor name="Rbst5" pcbX="-8.8mm" pcbY="-46.0mm" resistance="20" footprint="0402" /> {/* MP2315 bootstrap series R (datasheet-required) */}
    <capacitor name="Cvcc5" pcbX="-4.2mm" pcbY="-46.0mm" capacitance="0.1uF" footprint="0402" /> {/* VCC decouple */}
    <resistor name="Raam5" pcbX="0.4mm" pcbY="-46.0mm" resistance="100k" footprint="0402" /> {/* AAM light-load set */}
    <resistor name="R3" pcbX="5.0mm" pcbY="-46.0mm" resistance="31.6k" footprint="0402" /> {/* FB top: 0.8*(1+31.6/10)=3.33V */}
    <resistor name="R4" pcbX="9.6mm" pcbY="-46.0mm" resistance="10k" footprint="0402" />
    <resistor name="R_EN3H" pcbX="-8.8mm" pcbY="-51.0mm" resistance="100k" footprint="0402" /> {/* EN divider top (BAT) */}
    <resistor name="R_EN3L" pcbX="-4.2mm" pcbY="-51.0mm" resistance="47k" footprint="0402" />  {/* EN divider bottom (GND) */}

    {/* ===================== +3V3A LDO : TPS7A2033 (from +5V) ===================== */}
    <chip name="U6" pcbX="0.4mm" pcbY="-51.0mm" footprint="jlcpcb:C2862740" />
    <capacitor name="Cin3a" pcbX="5.0mm" pcbY="-51.0mm" capacitance="1uF" footprint="0402" />
    <capacitor name="Cout3a" pcbX="9.6mm" pcbY="-51.0mm" capacitance="2.2uF" footprint="0402" />
    <resistor name="R_RE5" pcbX="-8.8mm" pcbY="-56.0mm" resistance="100k" footprint="0402" />  {/* RAIL_EN_5V default off */}
    <resistor name="R_RE3A" pcbX="-4.2mm" pcbY="-56.0mm" resistance="100k" footprint="0402" /> {/* RAIL_EN_3V3A default off */}
    ...
    <chip name="U10" pcbX="-21.8mm" pcbY="0.0mm" footprint="jlcpcb:C3013944" />

    {/* ===================== m_U20 — ESP32-C5-WROOM-1U (co-processor) ===================== */}
    <chip name="m_U20" pcbX="-0.8mm" pcbY="0.0mm" footprint="jlcpcb:C49308183" />

    {/* ===================== U11 — 74HC138 3->8 chip-select decoder ===================== */}
    <chip name="U11" pcbX="17.2mm" pcbY="12.0mm" footprint="jlcpcb:C157527" />

    {/* ===================== U12 — PCA9555 #1 (0x20) radio/display control ===================== */}
    <chip name="U12" pcbX="24.2mm" pcbY="12.0mm" footprint="jlcpcb:C128392" />

    {/* ===================== U13 — PCA9555 #2 (0x21) user I/O + power gating + SP4T ===================== */}
    <chip name="U13" pcbX="31.2mm" pcbY="12.0mm" footprint="jlcpcb:C128392" />

    {/* I2C pull-ups live on Sheet 5 (single pair R40/R41 for the whole bus) */}
    <resistor name="R_C5BOOT" pcbX="17.2mm" pcbY="5.5mm" resistance="10k" footprint="0402" />
    <resistor name="R_C5S27" pcbX="24.2mm" pcbY="5.5mm" resistance="10k" footprint="0402" />
    <resistor name="R_HC138EN" pcbX="31.2mm" pcbY="5.5mm" resistance="10k" footprint="0402" />
    <resistor name="R_C5EN" pcbX="17.2mm" pcbY="-1.0mm" resistance="10k" footprint="0402" />
    <capacitor name="C_C5EN" pcbX="24.2mm" pcbY="-1.0mm" capacitance="1uF" footprint="0402" />
    ...
    <chip name="rf_U20" pcbX="-28.8mm" pcbY="44.0mm" footprint="pinrow8_p2.54_doublerow" pinLabels={{
      pin1: "GND", pin2: "VCC", pin3: "CE", pin4: "CSN",
      pin5: "SCK", pin6: "MOSI", pin7: "MISO", pin8: "IRQ",
    }} />
    <chip name="U21" pcbX="-28.8mm" pcbY="52.0mm" footprint="pinrow8_p2.54_doublerow" pinLabels={{
      pin1: "GND", pin2: "VCC", pin3: "CE", pin4: "CSN",
      pin5: "SCK", pin6: "MOSI", pin7: "MISO", pin8: "IRQ",
    }} />
    <chip name="U22" pcbX="-28.8mm" pcbY="60.0mm" footprint="pinrow8_p2.54_doublerow" pinLabels={{
      pin1: "GND", pin2: "VCC", pin3: "CE", pin4: "CSN",
      pin5: "SCK", pin6: "MOSI", pin7: "MISO", pin8: "IRQ",
    }} />
    {/* brownout: 150uF bulk + 100nF right at each VCC */}
    <capacitor name="Cb20" pcbX="-24.8mm" pcbY="63.0mm" capacitance="150uF" footprint="1210" />
    <capacitor name="Cd20" pcbX="-20.6mm" pcbY="63.0mm" capacitance="100nF" footprint="0402" />
    <capacitor name="Cb21" pcbX="-16.4mm" pcbY="63.0mm" capacitance="150uF" footprint="1210" />
    <capacitor name="Cd21" pcbX="-24.8mm" pcbY="58.5mm" capacitance="100nF" footprint="0402" />
    <capacitor name="Cb22" pcbX="-20.6mm" pcbY="58.5mm" capacitance="150uF" footprint="1210" />
    <capacitor name="Cd22" pcbX="-16.4mm" pcbY="58.5mm" capacitance="100nF" footprint="0402" />

    {/* ===================== nRF24 IRQ combiner: SN74LVC1G10 3-input NAND ===================== */}
    <chip name="U28" pcbX="-24.8mm" pcbY="54.0mm" footprint="jlcpcb:C485078" />

    {/* ===================== CC1101 bare IC + 26MHz xtal + balun ===================== */}
    <chip name="U23" pcbX="-5.8mm" pcbY="58.0mm" footprint="jlcpcb:C29953" />
    <crystal name="rf_Y1" pcbX="-12.8mm" pcbY="64.0mm" frequency="26MHz" loadCapacitance="10pF" footprint="crystal_3215_2" />
    <capacitor name="Cx1" pcbX="-8.6mm" pcbY="64.0mm" capacitance="10pF" footprint="0402" />
    <capacitor name="Cx2" pcbX="-4.4mm" pcbY="64.0mm" capacitance="10pF" footprint="0402" />
    <capacitor name="Cdc" pcbX="-0.2mm" pcbY="64.0mm" capacitance="100nF" footprint="0402" /> {/* DCOUPL: 1.8V reg bypass to GND */}
    <resistor name="rf_Rbias" pcbX="-12.8mm" pcbY="59.8mm" resistance="56k" footprint="0402" />   {/* RBIAS: 56k 1% to GND */}
    {/* RF balun proxy: balanced RF_P/RF_N -> single-ended CC1101_RF */}
    <chip name="BL1" pcbX="-8.6mm" pcbY="59.8mm" footprint="soic6" pinLabels={{
      pin1: "RFP", pin2: "RFN", pin3: "RFSE", pin4: "GND1", pin5: "GND2", pin6: "GND3",
    }} />
    {/* CC1101 local bulk */}
    <capacitor name="Cb23" pcbX="-4.4mm" pcbY="59.8mm" capacitance="100uF" footprint="1210" />
    <capacitor name="Cd23" pcbX="-0.2mm" pcbY="59.8mm" capacitance="100nF" footprint="0402" />
    ...
    <chip name="U24" pcbX="4.2mm" pcbY="46.0mm" footprint="jlcpcb:C255353" />
    {/* per-band matched networks (proxy: one inductor each) */}
    <inductor name="Lm315" pcbX="-1.8mm" pcbY="41mm" inductance="1nH" footprint="0402" />
    <inductor name="Lm433" pcbX="2.2mm" pcbY="41mm" inductance="1nH" footprint="0402" />
    <inductor name="Lm868" pcbX="6.2mm" pcbY="41mm" inductance="1nH" footprint="0402" />
    <inductor name="Lm915" pcbX="10.2mm" pcbY="41mm" inductance="1nH" footprint="0402" />

    {/* ===================== SX1262 / E22-900M22S module (real engine footprint) ===================== */}
    <chip name="U25" pcbX="26.2mm" pcbY="54.0mm" footprint="jlcpcb:C411293" />
    <capacitor name="Cb25" pcbX="18.2mm" pcbY="63.0mm" capacitance="100uF" footprint="1210" />
    <capacitor name="Cd25" pcbX="23.2mm" pcbY="63.0mm" capacitance="100nF" footprint="0402" />
    {/* 74LVC1G04 inverter: complementary RXEN from TXEN(LoRa_TR) */}
    <chip name="U27" pcbX="28.2mm" pcbY="63.0mm" footprint="jlcpcb:C7827" />
    ...
    <chip name="U30" pcbX="-3.8mm" pcbY="24.0mm" footprint="jlcpcb:C1526102" />
    {/* dedicated 32.768 kHz watch crystal + load caps (NOT from MCU) */}
    <chip name="a_Y1" pcbX="-10.8mm" pcbY="31.0mm" footprint="jlcpcb:C280830" />
    <capacitor name="CL1" pcbX="-6.6mm" pcbY="31.0mm" capacitance="12pF" footprint="0402" />
    <capacitor name="CL2" pcbX="-2.4mm" pcbY="31.0mm" capacitance="12pF" footprint="0402" />
    <capacitor name="Cvdd30" pcbX="1.8mm" pcbY="31.0mm" capacitance="1uF" footprint="0402" />
    <capacitor name="Cvdd30b" pcbX="-10.8mm" pcbY="26.5mm" capacitance="100nF" footprint="0402" /> {/* added: VDD HF decap */}
    {/* L+R -> mono summing resistor pair */}
    <resistor name="RsumL" pcbX="-6.6mm" pcbY="26.5mm" resistance="10k" footprint="0402" />
    <resistor name="RsumR" pcbX="-2.4mm" pcbY="26.5mm" resistance="10k" footprint="0402" />

    {/* ===================== SA868-U UHF voice walkie (U31, single-supply module) ===================== */}
    <chip name="U31" pcbX="-17.8mm" pcbY="24.0mm" footprint="jlcpcb:C3001507" />
    {/* local bulk on VBAT for the 2 W PA burst */}
    <capacitor name="Cbulk31" pcbX="-32.8mm" pcbY="32.0mm" capacitance="330uF" footprint="1210" />
    <capacitor name="Cbyp31" pcbX="-28.3mm" pcbY="32.0mm" capacitance="100nF" footprint="0402" />
    {/* electret mic + bias -> 1 uF coupling into SA868 MIC (1uF, not 10uF!) */}
    <resistor name="MK1" pcbX="-23.8mm" pcbY="32.0mm" resistance="2.2k" footprint="0603" /> {/* electret mic proxy */}
    <resistor name="a_Rbias" pcbX="-32.8mm" pcbY="27.5mm" resistance="4.7k" footprint="0402" />
    <capacitor name="Cmic" pcbX="-28.3mm" pcbY="27.5mm" capacitance="1uF" footprint="0402" />

    {/* ===================== 2:1 analog mux 74LVC1G3157 (U33) ===================== */}
    <chip name="U33" pcbX="16.2mm" pcbY="31.0mm" footprint="jlcpcb:C10426" />

    {/* ===================== PAM8302A class-D amp (U32) ===================== */}
    <chip name="U32" pcbX="21.7mm" pcbY="31.0mm" footprint="jlcpcb:C113367" />
    <resistor name="Rin32" pcbX="27.2mm" pcbY="31.0mm" resistance="10k" footprint="0402" /> {/* input series R */}
    <capacitor name="Cinp" pcbX="32.7mm" pcbY="31.0mm" capacitance="0.1uF" footprint="0402" /> {/* AC-couple IN+ (PAM8302 biases inputs to VDD/2) */}
    <capacitor name="Cinn" pcbX="16.2mm" pcbY="26.0mm" capacitance="0.1uF" footprint="0402" /> {/* matching AC-couple on IN- to GND */}
    <capacitor name="Cvcc32" pcbX="21.7mm" pcbY="26.0mm" capacitance="10uF" footprint="0805" />

    {/* speaker (BTL, no ground reference) */}
    <resistor name="LS1" pcbX="27.2mm" pcbY="26.0mm" resistance="4" footprint="1210" /> {/* 4-8 ohm speaker proxy */}

    {/* 3.5mm headphone jack — AC-couple BOTH legs (amp is BTL), mute on insert */}
    <chip name="J30" pcbX="32.7mm" pcbY="26.0mm" footprint="pinrow4" pinLabels={{
      pin1: "L", pin2: "R", pin3: "SLEEVE", pin4: "DET",
    }} />
    <capacitor name="Cjk1" pcbX="16.2mm" pcbY="21.0mm" capacitance="220uF" footprint="1210" /> {/* AC-couple SPK_P -> L */}
    <capacitor name="Cjk2" pcbX="21.7mm" pcbY="21.0mm" capacitance="220uF" footprint="1210" /> {/* AC-couple SPK_M -> R */}
    ...
    <chip name="U40" pcbX="31.2mm" pcbY="14.0mm" footprint="jlcpcb:C5447387" />
    {/* GPS supply decoupling (datasheet-typical; base soic8 model had none) */}
    <capacitor name="Cvcc40" pcbX="30.2mm" pcbY="7.0mm" capacitance="100nF" footprint="0402" /> {/* VCC HF decap */}
    <capacitor name="Cbulk40" pcbX="34.2mm" pcbY="7.0mm" capacitance="10uF" footprint="0805" /> {/* VCC bulk */}
    <capacitor name="Cio40" pcbX="30.2mm" pcbY="2.5mm" capacitance="100nF" footprint="0402" />  {/* VCC_IO decap */}
    {/* GPS backup: supercap + Schottky on V_BCKP for hot-start */}
    <chip name="D42" pcbX="34.2mm" pcbY="2.5mm" footprint="jlcpcb:C466635" />   {/* BAT54: +3V3 -> V_BCKP */}
    <chip name="BT40" pcbX="30.2mm" pcbY="-2.0mm" footprint="jlcpcb:C3019760" /> {/* 0.22F supercap on V_BCKP */}

    {/* ===================== I2C bus pull-ups (single pair for the whole bus) ===================== */}
    <resistor name="R40" pcbX="34.2mm" pcbY="-2.0mm" resistance="4.7k" footprint="0402" /> {/* SDA pull-up -> +3V3 */}
    <resistor name="R41" pcbX="30.2mm" pcbY="-6.5mm" resistance="4.7k" footprint="0402" /> {/* SCL pull-up -> +3V3 */}

    {/* ===================== Grove HY2.0-4P I2C ports x2 + per-port ESD ===================== */}
    <chip name="J40" pcbX="32.2mm" pcbY="-16.0mm" footprint="jlcpcb:C722729" />
    <chip name="J41" pcbX="32.2mm" pcbY="-22.0mm" footprint="jlcpcb:C722729" />
    <chip name="D40" pcbX="27.2mm" pcbY="-16.0mm" footprint="jlcpcb:C552572" />
    <chip name="D41" pcbX="27.2mm" pcbY="-22.0mm" footprint="jlcpcb:C552572" />

    {/* ===================== RFID2 Unit (WS1850S) — EXTERNAL Grove unit @0x28 (placeholder) ===================== */}
    <chip name="U44" pcbX="34.2mm" pcbY="-6.5mm" footprint="soic8" pinLabels={{ pin1: "V", pin2: "GND", pin3: "SDA", pin4: "SCL" }} />
    ...
    <led name="D50" pcbX="-27.8mm" pcbY="67mm" footprint="0603" />
    <chip name="Q50" pcbX="-27.8mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd50" pcbX="-27.8mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 51 = nRF24 #1 */}
    <led name="D51" pcbX="-19.8mm" pcbY="67mm" footprint="0603" />
    <chip name="Q51" pcbX="-19.8mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd51" pcbX="-19.8mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 52 = nRF24 #2 */}
    <led name="D52" pcbX="-11.8mm" pcbY="67mm" footprint="0603" />
    <chip name="Q52" pcbX="-11.8mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd52" pcbX="-11.8mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 53 = nRF24 #3 */}
    <led name="D53" pcbX="-3.8mm" pcbY="67mm" footprint="0603" />
    <chip name="Q53" pcbX="-3.8mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd53" pcbX="-3.8mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 54 = CC1101 */}
    <led name="D54" pcbX="4.2mm" pcbY="67mm" footprint="0603" />
    <chip name="Q54" pcbX="4.2mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd54" pcbX="4.2mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 55 = SA868 */}
    <led name="D55" pcbX="12.2mm" pcbY="67mm" footprint="0603" />
    <chip name="Q55" pcbX="12.2mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd55" pcbX="12.2mm" pcbY="61mm" resistance="4.7k" footprint="0402" />
    {/* chain 56 = SX1262 (LoRa) */}
    <led name="D56" pcbX="20.2mm" pcbY="67mm" footprint="0603" />
    <chip name="Q56" pcbX="20.2mm" pcbY="64mm" footprint="jlcpcb:C20526" />
    <resistor name="Rd56" pcbX="20.2mm" pcbY="61mm" resistance="4.7k" footprint="0402" />

    {/* ===================== WS2812 status LED + level shift ===================== */}
    {/* DS1 on S3 GPIO1 (RMT), +5V, DIN via 74AHCT1G125 (U51) 3V3->5V TTL buffer */}
    <chip name="DS1" pcbX="-30.8mm" pcbY="12.0mm" footprint="jlcpcb:C2761795" />
    <chip name="U51" pcbX="-26.8mm" pcbY="12.0mm" footprint="jlcpcb:C7484" />
    <capacitor name="Cds1" pcbX="-30.8mm" pcbY="7.8mm" capacitance="100nF" footprint="0402" /> {/* added: WS2812 VDD decap */}
    <capacitor name="Cu51" pcbX="-26.8mm" pcbY="7.8mm" capacitance="100nF" footprint="0402" /> {/* added: 74AHCT VCC decap */}

    {/* ===================== Buzzer ===================== */}
    {/* LS2 active buzzer via Q57, on +5V, gated by net.BUZZER (PCA9555 #1 P0.5) */}
    <resistor name="LS2" pcbX="-30.8mm" pcbY="3.6mm" resistance="0.01" footprint="1210" /> {/* active buzzer proxy */}
    <chip name="Q57" pcbX="-26.8mm" pcbY="3.6mm" footprint="jlcpcb:C20526" />

    {/* ===================== IR ===================== */}
    {/* TX: D57 IR LED driven by Q58 from GPIO2 (38kHz), +5V */}
    <led name="D57" pcbX="-30.8mm" pcbY="-0.6mm" footprint="0603" />
    <chip name="Q58" pcbX="-26.8mm" pcbY="-0.6mm" footprint="jlcpcb:C20526" />
    <resistor name="Rir" pcbX="-30.8mm" pcbY="-4.8mm" resistance="47" footprint="0603" />
    {/* RX: U50 TSOP38238 into GPIO42 (RMT), +3V3 */}
    <chip name="U50" pcbX="-26.8mm" pcbY="-4.8mm" footprint="jlcpcb:C141632" />
    <capacitor name="Cir" pcbX="-30.8mm" pcbY="-9.0mm" capacitance="100nF" footprint="0402" />

    {/* ===================== microSD (SPI mode) ===================== */}
    {/* J50 on shared SPI2, CS from 74HC138 Y0, CD on PCA9555 #1 P1.7, 3V3 native */}
    <chip name="J50" pcbX="-26.8mm" pcbY="-9.0mm" footprint="jlcpcb:C961683" />
    <capacitor name="Csd1" pcbX="-30.8mm" pcbY="-13.2mm" capacitance="10uF" footprint="0805" />
    <capacitor name="Csd2" pcbX="-26.8mm" pcbY="-13.2mm" capacitance="100nF" footprint="0402" />

    {/* ===================== Rotary encoder ===================== */}
    {/* SW10 quadrature A/B (GPIO40/41) + push (PCA9555 #1 P0.0) */}
    <chip name="SW10" pcbX="-22.8mm" pcbY="-12.0mm" footprint="jlcpcb:C361165" />

    {/* ===================== Physical buttons ===================== */}
    {/* SW11 RESET across S3 EN-GND (10k pull-up + 1uF RC) */}
    <resistor name="SW11" pcbX="-26.8mm" pcbY="-17.4mm" resistance="0.01" footprint="1210" /> {/* RESET button proxy */}
    <resistor name="Ren" pcbX="-30.8mm" pcbY="-21.6mm" resistance="10k" footprint="0402" />
    <capacitor name="Cen" pcbX="-26.8mm" pcbY="-21.6mm" capacitance="1uF" footprint="0402" />
    {/* SW12 BOOT: S3 GPIO0 -> GND */}
    <resistor name="SW12" pcbX="-30.8mm" pcbY="-25.8mm" resistance="0.01" footprint="1210" /> {/* BOOT button proxy */}
    {/* SW13 PTT: -> GND on PCA9555 #2 P0.0 */}
    <resistor name="SW13" pcbX="-26.8mm" pcbY="-25.8mm" resistance="0.01" footprint="1210" /> {/* PTT button proxy */}
