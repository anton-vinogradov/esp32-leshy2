...
[`H3-R2.2.3/.4`](power-transition-result.ru.md) завершили проверку inrush, load steps, watchdog и fault display. [`H3-R2.3`](analog-electrical-verification.ru.md), [`H3-R2.4`](digital-electrical-verification.ru.md), [`H3-R2.5`](rf-electrical-verification.ru.md), [`H3-R2.6`](thermal-fault-electrical-verification.ru.md), итог H3-R2.7 и фиксация H4-R2.0.1 проведены ревью; **текущий маркер: `H4-R2.2`.**
...
[`H3-R2.2.3/.4`](power-transition-result.md) completed inrush, load-step, watchdog and fault-display review. [`H3-R2.3`](analog-electrical-verification.md), [`H3-R2.4`](digital-electrical-verification.md), [`H3-R2.5`](rf-electrical-verification.md), [`H3-R2.6`](thermal-fault-electrical-verification.md), H3-R2.7 and the H4-R2.0.1 input freeze are reviewed; **current marker: `H4-R2.2`.**
