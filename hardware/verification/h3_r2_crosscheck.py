...
def phase_table(russian: bool) -> str:
    rows = [
        ("H3-R2.0", "Inputs, provenance and methods", "2 projects · 22 sheets · 1,210 schematic instances · 789 nets · 252 exact groups · 9 methods"),
...
def build() -> tuple[dict[Path, str], dict]:
    ...
    checks = {
        ...
        "all_current_component_groups_have_provenance": rows["H3-R2.0/parameter-provenance"]["summary"]["owned_component_groups"] == 252,
