...
**Статус:** `H3.2` проверено. Точный текущий маркер — `H3.4.3`: digital levels/defaults и no-back-power.
...
**Status:** `H3.2` reviewed. Exact current marker: `H3.4.3`, digital levels/defaults and no-back-power.
