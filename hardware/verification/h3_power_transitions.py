...
**Статус:** `H3.2` проверено. Точный текущий маркер — `H3.3.2`: codec/microphone/headset/speaker corners.
...
**Status:** `H3.2` reviewed. Exact current marker: `H3.3.2`, codec/microphone/headset/speaker corners.
