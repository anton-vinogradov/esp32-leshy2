...
**Статус:** `H3.2` проверено. Точный текущий маркер — `H3.3.1`: display supply, backlight и direct-QSPI electrical corners.
...
**Status:** `H3.2` reviewed. Exact current marker: `H3.3.1`, display supply, backlight and direct-QSPI electrical corners.
