...
**Статус:** `H3.2` проверено. Точный текущий маркер — `H3.3.3`: IR drive/receive/thermal corners.
...
**Status:** `H3.2` reviewed. Exact current marker: `H3.3.3`, IR drive/receive/thermal corners.
