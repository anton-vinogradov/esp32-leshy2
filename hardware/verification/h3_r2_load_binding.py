...
def render_doc(result: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        next_text = "**Точный текущий маркер:** `H3-R2.1.3` — worst-case rail voltage/current/protection/steady-thermal margins."
        ...
        next_text = "**Exact current marker:** `H3-R2.1.3` — worst-case rail voltage/current/protection/steady-thermal margins."
