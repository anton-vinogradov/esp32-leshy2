...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** численная модель H3.1.2 обновлена и проходит для `H1-R2.39`; вся фаза H3 ещё не закрыта."
        ...
        marker = "**Status:** the H3.1.2 numeric model is refreshed and passes for `H1-R2.39`; the complete H3 phase is not closed."
