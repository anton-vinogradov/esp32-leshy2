...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** `H3.1.2` завершено и проверено; текущий точный маркер — `H3.4.2`."
        ...
        marker = "**Status:** `H3.1.2` is complete and reviewed; the exact current marker is `H3.4.2`."
