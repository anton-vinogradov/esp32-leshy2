...
`H3-R2.5` is reviewed with **{len(checks)} passing machine checks** and no open analytical finding. [`H3-R2.6`](thermal-fault-electrical-verification.md), the H3-R2.7 phase package and H4-R2.0.1 input freeze are also reviewed; the current marker is `H4-R2.0.2`.
...
`H3-R2.5` проведён ревью: **{len(checks)} машинных checks проходят**, открытых аналитических findings нет. [`H3-R2.6`](thermal-fault-electrical-verification.ru.md), пакет фазы H3-R2.7 и фиксация H4-R2.0.1 также проведены ревью; текущий маркер — `H4-R2.0.2`.
