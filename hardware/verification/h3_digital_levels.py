...
SOURCES = {
    ...
    "ti_tca9534a": "https://www.ti.com/lit/ds/symlink/tca9534a.pdf",
    "ti_tmux1136": "https://www.ti.com/lit/ds/symlink/tmux1136.pdf",
    "ti_sn74lvc2g08": "https://www.ti.com/lit/ds/symlink/sn74lvc2g08.pdf",
    "nexperia_74lvc2g14": "https://assets.nexperia.com/documents/data-sheet/74LVC2G14.pdf",
...
def build() -> tuple[dict[Path, str], dict]:
    ...
    exact_instances = {
        ...
        "voice_audio_mux": "ti_tmux1136_dgsr",
    ...
    off_safe_pulls = (
        ...
        "ir_tx_gate_pulldown",
        "voice_en_pulldown",
        "voice_band_select_pulldown",
        "voice_ptt_pullup",
        "voice_v_ptt_pullup",
        "voice_uart_rx_pulldown",
        "voice_v_uart_rx_pulldown",
    ...
    interface_groups = [
        ...
        },
        {
            "id": "VOICE_DIGITAL",
            "signals": 8,
            "boundary": "one_hot_dual_sa818s_selection_and_switched_voice_io",
            "level_proof": "TCA9534A address 0x3A defaults P0 low; Schmitt complement plus dual AND create mutually exclusive PD, while three TMUX1136 bodies select UART, PTT/AUDIO_ON and AFOUT/MIC_IN",
            "minimum_high_margin_v": q(lvc_high_margin),
            "minimum_low_margin_v": q(lvc_low_margin),
            "reset_or_off_state": "both PTT inputs are pulled inactive-high, select defaults UHF without enabling either PD, mux rail is off and H/L is pulled to low power until VOICE_READY",
            "no_back_power": "VVOICE_IO_3V3 is off, TMUX1136 paths are high-Z and the low-or-open H/L driver never drives either module high",
        },
        {
            "id": "IR_RX_TX",
            "signals": 4,
    ...
    checks = {
        ...
        **direct_route_checks,
        ...
        "voice_selector_address_and_reset_default_are_exact": devices["ti_tca9534a_pwr"]["electrical_contract"]["address_range_7bit"] == ["0x38", "0x3F"] and devices["ti_tca9534a_pwr"]["electrical_contract"]["power_on_default"] == "all P0 through P7 are inputs",
        "voice_one_hot_contract_is_explicit": "exactly one module PD may be high" in candidate["voice_rf_electrical_contract"]["selection_and_isolation"],
