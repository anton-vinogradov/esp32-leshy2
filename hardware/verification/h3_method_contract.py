...
def render_doc(manifest: dict, russian: bool) -> str:
    if russian:
        ...
        marker = "**Статус:** `H3.0.3` завершено и проверено. Текущий точный маркер — `H3.4.2`, digital levels/defaults и no-back-power."
        ...
        marker = "**Status:** `H3.0.3` is reviewed. The current exact marker is `H3.4.2`, digital levels/defaults and no-back-power."
