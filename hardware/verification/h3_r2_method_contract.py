...
def render_doc(result: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        machine = "[Машинный контракт методов и 240 назначений](../hardware/verification/generated/H3-R2-method-contract.json). Исторический `H3-VRF03` не является authority R2."
    else:
        ...
        machine = "[Machine method contract and 240 assignments](../hardware/verification/generated/H3-R2-method-contract.json). Historical `H3-VRF03` is not R2 authority."
    method_rows = "\n".join(
