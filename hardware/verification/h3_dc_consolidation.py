...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** `H3.1` завершено и проверено. Текущий точный маркер — `H3.3.4`, battery sensing, thermistors и analog fault thresholds."
        ...
        marker = "**Status:** `H3.1` is reviewed. The exact current marker is `H3.3.4`, battery sensing, thermistors and analog fault thresholds."
