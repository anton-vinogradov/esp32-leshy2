...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** `H3.1` завершено и проверено. Текущий точный маркер — `H3.4.3`, digital levels/defaults и no-back-power."
        ...
        marker = "**Status:** `H3.1` is reviewed. The exact current marker is `H3.4.3`, digital levels/defaults and no-back-power."
