...
def build() -> tuple[dict[Path, str], dict]:
    ...
    checks = {
        ...
        "maximum_conversion_loss_below_2v7_w": d(source["summary"]["maximum_rail_conversion_loss_w"]) < d("2.700"),
        "maximum_efuse_loss_below_half_watt": d(source["summary"]["maximum_efuse_conduction_loss_w"]) < d("0.500"),
        "maximum_pack_current_below_3a": max_pack_current < d("3.000"),
        "pair_resistance_uses_two_40mohm_cells": pair_resistance_ohm == d("0.080"),
        "maximum_pack_i2r_is_bounded": max_cell_heat < d("0.750"),
