...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** `H3.1.1` завершено и проверено. Текущий маркер — `H3.4.3`, digital levels, pulls, reset defaults и no-back-power."
        ...
        marker = "**Status:** `H3.1.1` is complete and checked. Current marker is `H3.4.3`, digital levels, pulls, reset defaults and no-back-power."
