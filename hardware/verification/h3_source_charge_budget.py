...
def render_doc(manifest: dict, russian: bool) -> str:
    ...
    if russian:
        ...
        marker = "**Статус:** `H3.1.3` завершено и проверено; текущий точный маркер — `H3.3.4`."
        ...
        marker = "**Status:** `H3.1.3` is complete and reviewed; the exact current marker is `H3.3.4`."
