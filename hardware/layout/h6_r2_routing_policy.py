...
def doc(audit: dict, bootstrap: dict, *, ru: bool) -> str:
    ...
    if ru:
        ...
        lead = (
            ...
            "Проверенные `GENERAL_CONTROL`, все 12 кварцевых/генераторных сетей и `SAFETY_CONTROL` уже разведены полностью; "
            "в текущей H6.0.2 остаются аналоговые/audio/sense-сети. RF, USB, питание, i8080 и "
        ...
        notes = (
            ...
            "фазы: `ANALOG_AUDIO_SENSE` ещё разводится вручную.\n\n"
            ...
            "Это прямой экспорт из сохранённых `.kicad_pcb`, а не иллюстративный мокап. Картинки содержат хеши "
            "исходных плат и автоматически считаются устаревшими после любого изменения PCB.\n\n"
            "**Передняя/UI-плата**\n\n"
        ...
        lead = (
            ...
            "The reviewed `GENERAL_CONTROL` set, all 12 crystal/oscillator nets and `SAFETY_CONTROL` are now routed completely; "
            "manual H6.0.2 work on analogue/audio/sense nets remains current. RF, USB, power, i8080 "
        ...
        notes = (
            ...
            "not completion of the phase: `ANALOG_AUDIO_SENSE` is still routed manually.\n\n"
            "### What the real routing looks like now\n\n"
            "Blue is front copper and red is back copper; holes and vias appear across both layers. These are direct "
            "exports from the checked-in `.kicad_pcb` files, not illustrative mockups. Each image carries the source "
            "board hash and becomes stale automatically after any PCB change.\n\n"
            "**Front/UI board**\n\n"
