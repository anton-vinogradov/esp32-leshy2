...
def doc(audit: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        notes = (
            ...
            "нарушений нет. "
            "Обе кварцевые цепи RP2354 уже проведены раздельно и без via. "
        ...
        notes = (
            ...
            "switching-node net and selected local bypasses with zero violations. Both RP2354 crystal networks are "
            "already routed independently and without vias. Both boards have zero native DRC findings. "
