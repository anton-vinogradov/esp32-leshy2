...
def doc(audit: dict, manual_copper: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        notes = (
            ...
            "Помимо локальных цепей CC1101 и Airband полностью проведены S3-, C5- и все три nRF24-тракта от U.FL "
        ...
        notes = (
            ...
            "in addition to the local CC1101 and Airband networks, the complete S3, C5 and all three nRF24 paths from U.FL "
