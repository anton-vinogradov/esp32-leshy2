...
def doc(audit: dict, manual_copper: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        notes = (
            ...
            "помимо локальных цепей CC1101 и Airband полностью проведены S3-, C5-, nRF1- и nRF2-тракты от U.FL "
        ...
        notes = (
            ...
            "in addition to the local CC1101 and Airband networks, the complete S3, C5, nRF1 and nRF2 paths from U.FL "
