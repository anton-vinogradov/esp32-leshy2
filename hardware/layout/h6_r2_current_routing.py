...
def doc(audit: dict, ru: bool) -> str:
    ...
    if ru:
        ...
        notes = (
            ...
            "Первые десять controlled-RF маршрутов без via закрывают 11 соединений в локальных цепях "
            "CC1101 и Airband, включая 315-МГц ветвь, вход/выход BPF и ответвление детектора. "
        ...
        notes = (
            ...
            "RP2354s, CC1101, Si5351A and Si4732 — are routed and DRC-clean. The first ten via-free controlled-RF "
            "routes close 11 connections in the local CC1101 and Airband networks, including the 315-MHz branch, "
            "BPF input/output and detector sample. Both boards have zero native DRC findings. "
