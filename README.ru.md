...
> **Сейчас: H1-R2.1 · принятая функциональная архитектура превращается в новый физический дизайн.**
...
Компактная схема ниже — текущая R2-архитектура. Следующий чертёж H1-R2.1 —
...
![Внутреннее размещение Leshy2 H1-R2.1](docs/images/h1-r2-inner-placement.svg)

[Открыть читаемый результат размещения H1-R2.1](docs/h1-r2-physical-layout.ru.md).
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.1, реестр корпусов и внутреннее размещение** | [Текущий результат](docs/h1-r2-physical-layout.ru.md) |
...
**Железо находится на H1-R2.1.** H0-R2 фиксирует шесть вычислительных доменов,
...
точных устройства Airband, Hub RP2354B, TVP5150 и точный MMCX без коллизий на
одной стороне; 26 встречных проекций сохраняют минимум 2,44 мм при требовании
0,70 мм. Старый rail R1 2,5 А остаётся отменённым: H1 ещё должен закрыть ≥3,5 А
continuous / ≥4,0 А step и пересобрать все полные физические виды. Заказ не разрешён.

<!-- current-substep: H1-R2.1 -->

**Точный маркер: `H1-R2.1`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md)
