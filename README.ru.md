...
> **Сейчас: H1-R2.14 · K331 остаётся основным; открыт один gate production-пакета AKK.**
...
Компактная схема ниже — текущая R2-архитектура. H1-R2.14 теперь генерирует
...
![Полное внутреннее размещение Leshy2 H1-R2.14](docs/images/h1-r2-inner-complete.svg)

![Положение и зоны подключения MMCX Leshy2 H1-R2.14](docs/images/h1-r2-mmcx-service.svg)
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.14, K331 основной после поиска полнофункциональных fallback** | [Текущий результат](docs/h1-r2-physical-layout.ru.md) |
...
**Железо находится на H1-R2.14.** H0-R2 фиксирует шесть вычислительных доменов,
...
**Точный маркер: `H1-R2.14`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md),
