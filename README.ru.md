...
> **Сейчас: H5.0.2-R1 · поиск первичных источников и серийных альтернатив.**
...
**Железо находится на H5.0.2-R1.** Текущий [отчёт H4](docs/h4-prelayout-gate-report.ru.md)
...
**Точный маркер: `H5.0.2-R1`** — обновлённая [карта физических residuals](docs/component-evidence-map.ru.md)
связала все девять H5 residuals и 14 механических gates с dual-SA818S
продуктом. Сейчас исчерпываются первичные источники и полностью
документированные серийные замены до предложения любого образца. Закупка, placement, routing и
...
- ▶️ `H5.0.2-R1` — пересобрать поиск первичных источников и серийных альтернатив для `SA818S-U`, `SA818S-V` и qualified-pending замены `SA818S-CE`.
