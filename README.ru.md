...
- **По одному TX-тракту, а не все радио разом.** Девять антенн в одном малом объёме — включить все передатчики вместе значит забить приёмники. Прошивка делит TX-тракты по времени; единственное параллельное исключение — скан полосы на 3× nRF24, он только приём и ничего не передаёт.
