...
> **Сейчас: H1-R2.5 · выбран функциональный тракт аналогового FPV и точная антенна.**
...
> контролируемый чертёж корпуса и фабричный маршрут ещё открыты. Точная линейная
> антенна FPV выбрана. Фильтр Airband получил генерируемый nominal/stress-аудит
...
Компактная схема ниже — текущая R2-архитектура. Следующий чертёж H1-R2.5 —
...
![Внутреннее размещение Leshy2 H1-R2.5](docs/images/h1-r2-inner-placement.svg)
...
![Тракт аналогового FPV Leshy2 H1-R2.5](docs/images/h1-r2-fpv-path.svg)
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.5, FPV и внутреннее размещение** | [Текущий результат](docs/h1-r2-fpv.ru.md) |
...
**Железо находится на H1-R2.5.** H0-R2 фиксирует шесть вычислительных доменов,
...
34,62 дБ вместо требуемых 40 дБ. Это ещё не production BOM: под H3
зарезервирована экранированная землёй ячейка 24×11 мм с
альтернативными/DNP-площадками. Порты и антенны комплекта получили совпадающие
...
ручной установки. H3 ещё доказывает эффективную ёмкость, load-step,
switching loss и тепло корпуса. H1 должен пересобрать полные физические виды. Заказ не разрешён.

<!-- current-substep: H1-R2.5 -->

**Точный маркер: `H1-R2.5`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md),
