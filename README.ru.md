...
**Точный маркер: `H1.3.0`** — сгенерировать окончательные внешние стороны из
единого координатного source перед пользовательским gate `H1.3.1`.
...
- ▶️ **`H1.3.0` — сейчас:** сгенерировать из единого source внешние стороны, органы
