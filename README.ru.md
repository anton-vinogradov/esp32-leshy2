...
> **Сейчас: H1-R2.4 · размещена и проверена архитектура питания и теплового запаса шести доменов.**
...
> физическую проекцию. Фильтр Airband получил генерируемый nominal/stress-аудит
...
Компактная схема ниже — текущая R2-архитектура. Следующий чертёж H1-R2.4 —
...
![Внутреннее размещение Leshy2 H1-R2.4](docs/images/h1-r2-inner-placement.svg)

![Питание и тепловой запас Leshy2 H1-R2.4](docs/images/h1-r2-power-thermal.svg)

[Открыть читаемый результат размещения H1-R2.4](docs/h1-r2-physical-layout.ru.md) ·
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.4, питание/тепло и внутреннее размещение** | [Текущий результат](docs/h1-r2-physical-layout.ru.md) |
...
**Железо находится на H1-R2.4.** H0-R2 фиксирует шесть вычислительных доменов,
...
коллизий корпусов. H3 ещё доказывает эффективную ёмкость, load-step,
switching loss и тепло корпуса. H1 должен пересобрать полные физические виды. Заказ не разрешён.

<!-- current-substep: H1-R2.4 -->

**Точный маркер: `H1-R2.4`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md)
и [результат питания](docs/h1-r2-power-thermal.ru.md) проходят machine-аудиты.
