...
**Точный маркер: `H1.2`** — собрать обе платы, корпус, крепёж, внешние органы и
accessory keep-out в одной системе координат. Поздние виды пока остаются
черновыми.
...
- ▶️ **`H1.2` — сейчас:** создать единую систему координат двух плат и корпуса.
