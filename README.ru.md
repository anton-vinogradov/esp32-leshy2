...
snapshot из 209 строк остаются только историческими входами. Частичный ответ
JLCPCB от 26 августа подтверждает MOQ 1, типичные 8–15 рабочих дней pre-order
для exact SA818S-V и условную post-order цену Function Test. Аккумуляторы теперь
`J5-U`: их предоставляет пользователь, в поставку и supplier-gates они не
входят. Для закрытия H5.0.3-R1 ещё нужны подтверждение реальной
схемы с двумя designator U/V, остальные J4-F/J4-P и exact-MPN control. Резерв
уже сохранён: PCBWay подготовлен как кандидат на
