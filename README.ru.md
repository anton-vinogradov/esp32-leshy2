...
- ▶️ `H2.3` — реализовать и проверить листы RF/power PCB.
  - ✅ `H2.3.1` — проверен `RF_00_ROOT`: 12 дочерних листов, 133 точные
    межлистовые цепи и 302 явных pin/label; текущие ERC-находки точно
  ...
  - ▶️ **`H2.3.4` — сейчас:** основные rails и отключаемые домены.
  - ⏳ `H2.3.5` — RP2354 core, flash и service access.
