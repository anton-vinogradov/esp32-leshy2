...
### Вся задняя сторона — вид сверху

На плане задней стороны в едином миллиметровом масштабе показаны антенны,
поднятая планка и установленный LoRa Cap 84×24 мм, держатель батарей и все
задние органы управления.

![Полный вид сверху на заднюю сторону Leshy2](docs/images/u214-dock-top-view.svg?layout=3)
