...
> **Сейчас: H5.0.2 · поиск до образцов.** [Карта evidence H5](docs/component-evidence-map.ru.md)
> проведена; закупка, PCB routing и печать остаются заблокированы.
...
**Железо находится на H5.0.2.** [Карта evidence H5.0.1](docs/component-evidence-map.ru.md)
связывает все девять residuals H5 и все 14 механических gate’ов с точными выбранными
identities, источниками, недостающими данными и pass rules. Теперь H5 исчерпывает
...
**Точный маркер: `H5.0.2`** — найти первичные документы производителя/дистрибьютора
и оценить полностью документированные серийные замены для каждого недостающего
параметра. Набор образцов не предлагается, пока этот поиск не исчерпан.
...
- ▶️ **`H5.0.2` — сейчас:** исчерпать первичные документы и полностью документированные серийные замены до предложения образцов.
