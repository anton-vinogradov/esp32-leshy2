...
**🟡 WIP.** Свести листы в одну плату на реальных, проверенных деталях; отревьюить; достроить недостающее (swap деталей + детекторы огибающей / драйвер подсветки / лимитер Si4732). *Детали дополняются по мере проработки этапа.*
