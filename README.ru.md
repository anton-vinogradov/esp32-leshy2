...
![Внешние стороны Leshy2](docs/images/current-clamshell.svg?layout=8)

Здесь показаны обе обращённые друг к другу стороны бутерброда. На них видны
вычислители и радиомодули, динамик, микрофон, ON/OFF, межплатный разъём,
...
Задняя сторона показана перпендикулярно её плоскости — так, как её видит
пользователь сзади. В едином миллиметровом масштабе видны антенны, поднятая
планка, установленный LoRa Cap, держатель батарей и органы управления.

![Полный вид Leshy2 сзади](docs/images/u214-dock-top-view.svg?layout=4)
...
![Вид Leshy2 сверху со стороны антенного торца](docs/images/top-edge-view.svg?layout=1)
...
![Разрезы бутерброда Leshy2](docs/images/sandwich-section.svg?layout=8)
