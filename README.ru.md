...
- В текущей принятой версии готовой архитектуры ESP32-C5 владеет всеми тремя полнофункциональными nRF24 и IR TX/RX. Финальный межпроцессорный транспорт должен сохранить это владение без двойного назначения единственного GP-SPI C5.
