...
граница кабеля с дорожкой. Точная точка модульного IPX nRF до H5 не выдумывается.
...
![Внутренние стороны плат Leshy2](docs/images/internal-board-layout.svg?layout=16)
