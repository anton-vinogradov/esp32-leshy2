...
> **Сейчас: H1-R2.7 · фабричные альтернативы FPV-приёмника перепроверены без ухудшения архитектуры.**
...
Компактная схема ниже — текущая R2-архитектура. Следующий чертёж H1-R2.7 —
...
![Внутреннее размещение Leshy2 H1-R2.7](docs/images/h1-r2-inner-placement.svg)

![Положение и зоны подключения MMCX Leshy2 H1-R2.7](docs/images/h1-r2-mmcx-service.svg)
...
![Тракт аналогового FPV Leshy2 H1-R2.7](docs/images/h1-r2-fpv-path.svg)
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.7, механика MMCX и внутреннее размещение** | [Текущий результат](docs/h1-r2-physical-layout.ru.md) |
...
**Железо находится на H1-R2.7.** H0-R2 фиксирует шесть вычислительных доменов,
...
**Точный маркер: `H1-R2.7`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md),
