...
controlled-данные дисплея и U214 без размещения заказа. Поиск по открытым
...
- `H1.1` — собрать реестр физических первоисточников.
  ...
  - `H1.1.3` — классифицировать каждую оставшуюся физическую неопределённость.
    ...
    - ✅ `H1.1.3.2` — вести актуальную классификацию: сейчас два blocker H1 и
      одиннадцать received-sample gate H5.
