...
> **Сейчас: H1-R2.9 · функциональная интеграция K331 подтверждена официальными материалами; физический и фабричный гейты открыты.**
...
Компактная схема ниже — текущая R2-архитектура. Следующий чертёж H1-R2.9 —
...
![Внутреннее размещение Leshy2 H1-R2.9](docs/images/h1-r2-inner-placement.svg)

![Положение и зоны подключения MMCX Leshy2 H1-R2.9](docs/images/h1-r2-mmcx-service.svg)
...
![Тракт аналогового FPV Leshy2 H1-R2.9](docs/images/h1-r2-fpv-path.svg)
...
| **H1 · Физический дизайн устройства** | **▶️ Сейчас: H1-R2.9, свидетельства интеграции K331 и внутреннее размещение** | [Текущий результат](docs/h1-r2-physical-layout.ru.md) |
...
**Железо находится на H1-R2.9.** H0-R2 фиксирует шесть вычислительных доменов,
...
С этим увеличенным резервом 26 встречных проекций сохраняют минимум 1,44 мм при
требовании 0,70 мм. Точный `TPS7A2018PDBVR` для шины 1,8 В принят по текущей фабричной
...
<!-- current-substep: H1-R2.9 -->

**Точный маркер: `H1-R2.9`** — [текущее размещение](docs/h1-r2-physical-layout.ru.md),
