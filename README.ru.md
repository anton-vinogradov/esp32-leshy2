...
роадмапа обновляются тем же commit до перехода дальше. Поздняя правка,
изменяющая уже согласованный вид, повторно открывает его пользовательский gate
и все зависящие от него gates.
