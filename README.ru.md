...
> **Сейчас: H5.0.3-R1 · неустранимая корзина образцов и пересборка 210-строчной карты JLCPCB.**
...
Сейчас дедуплицируются только неустранимые получаемые образцы, их точные
измерения и стоимость, а также пересобираются все маршруты 210-строчного
dual-SA818S BOM. Закупка, placement, routing и
...
- ▶️ `H5.0.3-R1` — пересобрать неустранимую корзину и JLCPCB-карту для 210-строчного dual-SA818S BOM; закупка остаётся отдельным последующим gate.
