...
> **Сейчас: H5.0.3 · неустранимые образцы и стоимость.** [Поиск H5.0.2](docs/component-source-research.ru.md)
> проведён; закупка, PCB routing и печать остаются заблокированы.
...
**Железо находится на H5.0.3.** [Поиск источников H5.0.2](docs/component-source-research.ru.md)
исчерпал документальные и серийные альтернативы для всех девяти residuals и
14 mechanical gates. Четыре точных тестовых SKU закрыли два selection gap;
физические evidence, PCB layout и любые заказы всё ещё не разрешены.
...
**Точный маркер: `H5.0.3`** — дедуплицировать только те получаемые образцы,
которые нельзя заменить документами или серийной альтернативой, связать каждый
с точным измерением и опубликовать текущую стоимость для явного согласования.
Закупка пока не разрешена.
...
- ▶️ **`H5.0.3` — сейчас:** опубликовать единый недублирующийся набор неустранимых образцов, измерения и текущую стоимость для явного согласования.
