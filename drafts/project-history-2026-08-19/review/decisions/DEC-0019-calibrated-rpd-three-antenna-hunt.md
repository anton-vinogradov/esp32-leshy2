...
Три принятых nRF24 сохраняются как три одновременных приёмных тракта независимо от выбранного MCU owner. Базовая функция поиска сравнивает не RSSI, а калиброванную долю срабатываний бинарного RPD по трём антеннам/секторам.
...
- `FND-0019` остаётся открытой implementation finding до выбора physical owner/exact modules, доказательства transport/resource budget, power/RF/antenna path, STOP/TX state и HIL.
