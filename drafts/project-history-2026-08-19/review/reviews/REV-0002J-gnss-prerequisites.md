...
- на момент аудита был открыт ровно один owner-level выбор: `IMP-0012`.
...
Последующее состояние: владелец принял `IMP-0012/A` в `DEC-0014`, propagation review выполнен в `REV-0002K`.
