...
`REV-0003O` позднее повторно проверил набор после no-loss исправления `FND-0034`: полный U214/GNSS profile `SYN-2A` перенесён с переполненного S3 на свободные C5 interfaces. Candidate-set coverage и статус сохранены; это не architecture acceptance.
