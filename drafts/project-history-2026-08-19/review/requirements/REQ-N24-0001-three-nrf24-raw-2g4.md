...
- Статус набора: **Проведено ревью capability; `G2F-3I` leading owner/controller, full-mix policy принят `DEC-0047`, compact IPEX→external-SMA direction принят `DEC-0048`**
