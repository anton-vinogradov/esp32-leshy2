...
|---|---|---|
| `PW-BAT` | supervised `2S / 6.0…8.4 V` from `DEC-0065`, two individually replaceable cells behind fail-closed admission | exact worst-case scenario peak, protection, efficiency and shutdown behavior |
