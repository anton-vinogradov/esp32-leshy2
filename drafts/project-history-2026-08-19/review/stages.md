...
| 3 | Target product design | adapted legacy physical mockup, form factor, interaction, controls, interfaces, battery, antenna/service/environment/cost envelopes | **Активен**: `FND-0117/G3-0001/REV-0005CE` провели ревью current geometry re-entry и создали active generated `75×150-mm` clamshell starting projection; `PD-0001` — input, premature `LAY-0001` P1/P2/P3 — reference only; complete packing/ergonomics/connectors/HIL remain open and conflicts переоткрывают их G2F owner |
