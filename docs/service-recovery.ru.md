...
|---|---|---|---|
| ESP32-S3 | основной USB RF J1 через M1 к native USB, ручные BOOT/RESET | **Резервный UART не готов:** UI J2 выведен на GPIO7/8, не на ROM UART0 GPIO43/44; последние сейчас заняты Hub D2/D3 без требуемой изоляции | UI + RF |
