...
> Текущий точный маркер — **H1-R2.19**: физическая модель пересчитана под i8080-8, локальные острова 5+5 и полную 80-контактную M1; документ SP331RX сузил K331-блокер, но H1 ещё не завершён и не разрешает KiCad routing или заказ R2.
