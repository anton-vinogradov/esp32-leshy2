...
> Текущий точный маркер — **H1-R2.20**: физическая модель пересчитана под i8080-8, локальные острова 5+5 и полную 80-контактную M1; стабильные role/revision плат отделены от рабочего маркера, но H1 ещё не завершён и не разрешает KiCad routing или заказ R2.
