...
сканирования матрицы и восстановления ghost-клавиш. `BACK`, `OPT`,
...
чертёж, а не партномер поставщика. Оранжевый
...
![Размерная внешняя компоновка](images/current-clamshell.svg?layout=10)

![Размерная компоновка внутренних плат](images/internal-board-layout.svg?layout=7)
