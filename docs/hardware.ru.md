...
объём. Пунктирный колпачок каждой кнопки — только её небольшой внешний толкатель,
а не часть общей крышки.
...
На полном виде сверху задней стороны также показаны точные скрытые корпуса
энкодера, F1/F2, PTT, STOP и RE-ARM под их внешними колпачками и ручкой.
Сплошные корпуса уже выбраны; пунктирные колпачки и ручка остаются деталями
корпуса, для которых ещё проверяются глубина, усилие и герметизация.
