...
- Задний 14-контактный dock использует точный боковой разъём
  `Samtec SSW-107-02-S-D-RA` и принимает `M5Stack U214 Cap LoRa-1262`.
  Cap сдвигается в плоскости задней платы над батареями и выступает на 4,5 мм
...
![Размерный поперечный разрез бутерброда](images/sandwich-section.svg?layout=6)
