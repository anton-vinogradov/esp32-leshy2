...
вокруг заднего аккумулятора; энкодер находится над F1/F2. `STOP` использует
непосредственно нажимаемый SPDT tact-switch 6,0×6,1 мм; его нормально-замкнутый
...
объём. Пунктир на задней стороне остаётся только для защитного углубления
`RE-ARM` и ручки энкодера; общей крышки у них нет.
