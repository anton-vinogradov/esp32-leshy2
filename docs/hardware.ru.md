...
только `IPEX`, без поколения ответной части. Восемь подписанных индикаторов
...
Штатный U214 Cap и универсальный M5 Unit-разъём не выводят независимое
actual-RF evidence. Их приём и GNSS доступны; TX расширения остаётся выключенным
до выбора отдельно квалифицированного evidence-контракта. Управляемое питание
ветви и сигналы SX1262 BUSY/IRQ полезны для проверки состояния, но не выдаются
за доказательство того, что RF действительно вышел в антенну.
