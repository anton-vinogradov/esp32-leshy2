...
На полном виде сзади показаны точные корпуса всех органов управления.
Сплошные F1/F2/PTT/RE-ARM — сами непосредственно нажимаемые кнопки;
...
![Полный размерный вид сзади](images/u214-dock-top-view.svg?layout=4)
