...
![Размерная внешняя компоновка](images/current-clamshell.svg?layout=11)

![Размерная компоновка внутренних плат](images/internal-board-layout.svg?layout=8)

![Размерный вид сверху со стороны антенного торца](images/top-edge-view.svg?layout=2)
