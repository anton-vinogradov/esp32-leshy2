...
| LoRa/GNSS Cap | `M5Stack U214 Cap LoRa-1262` или evidence-aware Leshy Cap | RP2354B | Штатный Cap: RX/GNSS; evidence-aware Cap: квалифицированные RX/TX |
...
состояние, а квалифицированный Leshy LoRa Cap может притянуть
`EXT_TX_EVIDENCE_N` к нулю только по сигналу детектора на своём конечном внешнем
50-омном RF-тракте. `BUSY`, `IRQ`, питание ветви и состояние firmware остаются
диагностическим контекстом, но не заменяют измерение RF.
