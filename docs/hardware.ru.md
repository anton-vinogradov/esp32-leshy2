...
![Размерная внешняя компоновка](images/current-clamshell.svg?layout=12)

![Размерная компоновка внутренних плат](images/internal-board-layout.svg?layout=9)

![Размерный вид сверху со стороны антенного торца](images/top-edge-view.svg?layout=3)

![Размерные разрезы зон LoRa Cap и батарей](images/sandwich-section.svg?layout=9)
