...
| Canonical nets | 826 |
| Connected logical endpoints / explicit NCs | 4,065 / 258 |
| Controller-pin rows | 173 |
| Cross-project / cross-sheet nets | 51 / 236 |
...
controller map, 51 cross-project nets and 236 cross-sheet nets. Fourteen named
