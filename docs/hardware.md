...
| MCU | Role | Radios | I/O |
|-----|------|--------|-----|
| **ESP32-S3-WROOM-1U-N8R2** (quad-PSRAM, dual-core) | **Main brain** — UI, display, all wired radios, SD, every bus | native 2.4 GHz Wi-Fi + BLE | **36 / 36** GPIO — full |
...
| Sub-GHz | bare CC1101 + balun + **SP4T (SKY13414-485LF)** + 4 matched nets | 315 / 433 / 868 / 915 MHz OOK/FSK capture & replay | [3](../hardware/rf/rf.md) |
