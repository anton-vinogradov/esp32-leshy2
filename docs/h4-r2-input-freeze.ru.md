...
Затем H4-R2.0.2/H4-R2.1 нашли один назначенный пробел генерации BSP C5/Pack/Safety. H4-R2.2 закрыл все 38 недостающих строк и повторно квалифицировал каждую target-сборку; [H4-R2.3 проведён ревью](h4-r2-acceptance.ru.md). **Текущий маркер: `H5.0.3-R1`.**
