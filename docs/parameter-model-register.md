...
- `1034` instances and `217` used device types.
- A primary source exists for `217` of `217` types; missing: `0`.
- `68` types already have structured parameters; `149` are extracted by class during H3.1–H3.6.
...
**Status:** `H3.0.2` is reviewed; current marker is `H3.3.3`.
