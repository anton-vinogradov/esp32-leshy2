...
- `1032` instances and `216` used device types.
- A primary source exists for `216` of `216` types; missing: `0`.
- `67` types already have structured parameters; `149` are extracted by class during H3.1–H3.6.
...
**Status:** `H3.0.2` is reviewed; current marker is `H3.3.2`.
