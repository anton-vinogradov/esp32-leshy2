...
| Физический дизайн устройства | ▶️ [H1-R2.5](h1-r2-fpv.ru.md): функциональная/пиновая совместимость K331 и точная антенна TBS FPV добавлены к размещённым Hub, Airband, MMCX/LDO и main-rail 3,75 А continuous / 4,25 А step; физический/фабричный gates K331 и полные виды ещё открыты |
...
размеров и фабричного маршрута JLCPCB либо явной установки после PCBA.
