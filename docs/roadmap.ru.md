...
| Электрические и переходные evidence | ▶️ H3.3.4: DC, transitions, display, audio и IR проверены; идёт battery analog |
...
**Точный маркер: `H3.3.4`** — [IR-тракт](ir-electrical-verification.ru.md)
