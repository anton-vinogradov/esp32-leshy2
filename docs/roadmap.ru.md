...
Сейчас — [автоматическая трассировка и воспроизводимость](h6-r2-routing-automation.ru.md). Геометрический рубеж двух блоков на 474 связи пройден с тремя холодными повторами каждого; полная пересборка плат и электрическая квалификация ещё впереди. Эксперименты идут на копиях, рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
