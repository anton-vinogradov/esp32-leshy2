...
| Актуальная production ECAD-схема | ▶️ H2.3.9: задние органы управления и энкодер; H2.3.8 с независимо защищёнными U214/M5 Unit проведено ревью |
...
**Точный маркер: `H2.3.9`** — реализовать и проверить задние органы управления
и энкодер на `RF_35_REAR_CONTROLS`.
...
- ▶️ `H2.3` — реализовать и проверить листы RF/power PCB.
  ...
  - ▶️ **`H2.3.9` — сейчас:** `RF_35_REAR_CONTROLS`.
