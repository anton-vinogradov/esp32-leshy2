...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи пройден; параллельная команда приёмки теперь выявляет текущие проблемы питания, незавершённые связи и недостающую квалификацию. Далее — ограниченный пилот генерации схем и независимая проверка на текущем проекте. Эксперименты идут на копиях, рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
