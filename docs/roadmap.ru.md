...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи и ограниченный пилот генерации индикаторов прошли проверки в своих рамках; электрическая квалификация открыта. Автоматический выбор запаса по току MAIN и совместный статический подбор делителей питания/монитора работают в объявленных моделях. Далее — квалификация полного узла: нагрузка/утечки, верная формула новой защиты, применимость исходных данных и динамика. Существующие проблемы питания остаются видны; кандидаты MPN и изменения рабочей схемы не принимаются. Эксперименты идут на копиях, рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
