...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи и ограниченный пилот генерации индикаторов прошли проверки в своих рамках; электрическая квалификация открыта. Автоматический переподбор делителей MAIN теперь связан с поиском порога новой защиты по её собственной формуле, с учётом токов через защиту и в обход неё. Независимый более широкий перебор E192 подтверждает условные оптимумы порога; ngspice проверяет уравнения делителей. Неизвестные вспомогательные токи, применимость источников и динамика пока запрещают квалификацию полного узла. Далее — привязать все вспомогательные цепи питания и реальные границы источников, затем проверить запуск и динамическую защиту перед перестроением рабочего узла. Существующие проблемы питания остаются видны; кандидаты MPN и изменения рабочей схемы не принимаются. Рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
