...
> **▶️ Текущая аппаратная граница: H1-R2.10 — основной K331 и контролируемый fallback AWM666V.**
...
| Физический дизайн устройства | ▶️ [H1-R2.10](h1-r2-physical-layout.ru.md): пиновая/силовая совместимость K331, точная TBS FPV-антенна и механика MMCX проходят; контролируемый AWM666V входит в ту же ячейку как деградированный семиканальный fallback; сейчас H1 блокируют только контролируемый корпус и маршрут установки K331, затем пересобираются полные виды |
| Принципиальные диаграммы на сайте | Функциональная карта H0-R2, FPV/MMCX/размещение H1-R2.10 и диаграммы фильтра/rail H1-R2.4 актуальны; полные размерные виды R1 явно обозначены входами для пересборки |
...
## Текущий H1-R2.10 и сохранённое evidence R1

<!-- current-substep: H1-R2.10 -->

**Точный маркер: `H1-R2.10`** — [инкрементальный физический результат](h1-r2-physical-layout.ru.md)
...
Текущая граница — `H1-R2.10`. Второй Hub RP, точные активные детали Airband,
