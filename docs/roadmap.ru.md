...
**Точный маркер: `H1.3.0`** — сгенерировать из единого координатного source
окончательные внешние стороны перед пользовательским gate `H1.3.1`.
...
- ▶️ **`H1.3.0` — сейчас:** сгенерировать из единого source внешние стороны: экран, D-pad,
