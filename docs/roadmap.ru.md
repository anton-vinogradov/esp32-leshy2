...
> **▶️ Текущая аппаратная граница: H5.0.2 — поиск до образцов.**
...
| Evidence компонентов | ▶️ H5.0.2 ищет первичные источники и серийные замены; образцы не заказаны, тесты не проводились |
...
**Точный маркер: `H5.0.2`** — [карта evidence H5.0.1](component-evidence-map.ru.md)
связала все девять residuals H5 и 14 механических gate’ов с выбранными identities,
источниками, недостающими данными и pass rules. Теперь исчерпываются первичные
документы и полностью описанные серийные замены; закупка, layout и печать не разрешаются.
...
- ▶️ **`H5.0.2` — сейчас:** исчерпать первичные evidence и полностью документированные серийные замены.
...
| **H5. Evidence компонентов** | ▶️ Сейчас `H5.0.2`; закупка заблокирована | [Точная карта завершена](component-evidence-map.ru.md); сначала документы и серийные замены; только неустранимая неопределённость входит в одобряемый по стоимости набор образцов | Полная карта MPN/evidence/pass-rule; полученные образцы, если всё ещё нужны, доказывают identity, mating, stack-up и критические размеры |
...
Текущая граница — `H5.0.2`: все физические residuals H5 уже связаны, а теперь
исчерпываются первичные источники и полностью документированные серийные замены
до предложения образцов. PCB placement/routing и закупка остаются заблокированы.
