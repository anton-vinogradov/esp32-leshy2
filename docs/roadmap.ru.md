...
> **▶ Текущая аппаратная граница: `H1-R2.37`.** H0 проведено ревью. H1 готово к визуальному принятию, но ещё не прошло ревью.
...
| Физический дизайн | ▶ [H1-R2.37](h1-r2-physical-layout.ru.md): бортовое видео и требующая ручной пайки зона приёмника удалены; точная dual-RP/C5 authority, серийный EastRising-дисплей с адаптером, все 18 компонентов U219, NFC-loop, swept volume штатной антенны и все восемь полных TX-evidence-островов проходят fail-closed аудит; до явного принятия мокапа физических блокеров нет; [все 208 MPN-групп базового BOM ранжированы, AD8314 и точная складская упаковка Hirose U.FL дают $10,42 принятой экономии, текущий минимум электроники — $273,42; все группы топ-20 сохранены, а шесть более дешёвых антенных сравнений с бумажной экономией $89,13 отклонены 2026-08-30](h1-r2-cost.ru.md) |
...
**Точный маркер: `H1-R2.37`.** Пакет компоновки готов к принятию; H1 не является
...
| **H1 · Физический дизайн продукта** | **▶ Готово к принятию · `H1-R2.37`** | Внешний вид, отдельные внутренние стороны, разрезы, точные корпуса, RF-локальность, сервис и power-envelope | Нет коллизий bodies/fasteners/silkscreen/antennas/accessories/opposing sides; точный MPN или контролируемый reserve; мокап принят |
