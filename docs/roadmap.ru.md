...
> **▶️ Текущая аппаратная граница: H1-R2.9 — официальные свидетельства интеграции K331 и инкрементальное физическое размещение.**
...
| Физический дизайн устройства | ▶️ [H1-R2.9](h1-r2-physical-layout.ru.md): официальные материалы AKK подтверждают схему включения K331, функции всех 14 контактов и таблицу 24 каналов; пиновая/силовая совместимость, точная TBS FPV-антенна и механика MMCX проходят; сейчас H1 блокируют только контролируемый корпус и маршрут установки K331, затем пересобираются полные виды |
| Принципиальные диаграммы на сайте | Функциональная карта H0-R2, FPV/MMCX/размещение H1-R2.9 и диаграммы фильтра/rail H1-R2.4 актуальны; полные размерные виды R1 явно обозначены входами для пересборки |
...
## Текущий H1-R2.9 и сохранённое evidence R1

<!-- current-substep: H1-R2.9 -->

**Точный маркер: `H1-R2.9`** — [инкрементальный физический результат](h1-r2-physical-layout.ru.md)
...
Текущая граница — `H1-R2.9`. Второй Hub RP, точные активные детали Airband,
