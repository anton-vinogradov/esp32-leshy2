...
> **▶️ Текущая аппаратная граница: H1-R2.5 — функциональный тракт аналогового FPV, точная антенна и инкрементальное размещение.**
...
| Физический дизайн устройства | ▶️ [H1-R2.5](h1-r2-fpv.ru.md): функциональная/пиновая совместимость K331 и точная антенна TBS FPV добавлены к размещённым Hub, Airband, MMCX/LDO и main-rail 3,75 А continuous / 4,25 А step; запросы AKK/JLCPCB отправлены, физический/фабричный gates K331 и полные виды ещё открыты |
| Принципиальные диаграммы на сайте | Функциональная карта H0-R2, тракт FPV/размещение H1-R2.5 и диаграммы фильтра/rail H1-R2.4 актуальны; полные размерные виды R1 явно обозначены входами для пересборки |
...
## Текущий H1-R2.5 и сохранённое evidence R1

<!-- current-substep: H1-R2.5 -->

**Точный маркер: `H1-R2.5`** — [инкрементальный физический результат](h1-r2-physical-layout.ru.md)
...
Текущая граница — `H1-R2.5`. Второй Hub RP, точные активные детали Airband,
