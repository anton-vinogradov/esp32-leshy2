...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи и ограниченный пилот генерации индикаторов прошли проверки в своих рамках; электрическая квалификация открыта. Автоматический выбор запаса по току MAIN и совместный подбор делителей теперь включают ограниченный переподбор сопротивлений после отказа с нагрузкой и знаковыми входными токами. Две новые пары проходят объявленную DC-модель; 242 теста и 2304 независимых сочетания ngspice проверяют механизм, не чипы. Далее — связать новую защиту и все вспомогательные ветви, подтвердить реальные границы источников и проверить динамику перед квалификацией полного узла. Существующие проблемы питания остаются видны; кандидаты MPN и изменения рабочей схемы не принимаются. Эксперименты идут на копиях, рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
