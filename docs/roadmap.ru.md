...
| Физический дизайн устройства | ▶️ [H1-R2.6](h1-r2-physical-layout.ru.md): функциональная/пиновая совместимость K331 и точная антенна TBS FPV добавлены к размещённым Hub/Airband/power; точная геометрия MMCX, выводы wave soldering и wall/plug keepout проходят, а физический/фабричный gates K331 и полные виды ещё открыты |
