...
> **▶ Текущая аппаратная граница: `H1-R2.15`.** H0 проведено ревью. H1 — нет.
...
| Физический дизайн | ▶ [H1-R2.15](h1-r2-physical-layout.ru.md): полные функциональные острова, основные антенные банки `5 + 5` и отдельный вертикальный задний FPV MMCX |
...
**Точный маркер: `H1-R2.15`.** Это один подшаг физического дизайна, а не
закрытый отчёт H1.
...
- ✅ GPIO переднего RP: `45/48`; заднего RP: `46/48`.
...
| **H1 · Физический дизайн продукта** | **▶ Сейчас · `H1-R2.15`** | Внешний вид, отдельные внутренние стороны, разрезы, точные корпуса, RF-локальность, сервис и power-envelope | Нет коллизий bodies/fasteners/silkscreen/antennas/accessories/opposing sides; точный MPN или контролируемый reserve; мокап принят |
