...
| H3 · Виртуальная электрическая проверка | Проведено ревью аналитической базы · `H3-R2.7`; питание текущей схемы [вновь открыто в H6](h6-r2-electrical-semantics.ru.md) | все считаемые до layout углы проверены для фактической схемы, физические остатки назначены; сохранённые расчёты пока не подтверждают текущее питание | [H3-R2](h3-r2-acceptance.ru.md) |
