...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи и ограниченный пилот генерации индикаторов прошли проверки в своих рамках; электрическая квалификация открыта. Автоматический подбор делителей MAIN и порога защиты теперь также проверяет функции выводов замены, точные узлы вспомогательного питания и условия источников. Он обнаруживает несовместимость PGTH/FLT на контакте 4 U21 и привязывает существующую подтяжку R266 к защищённой MAIN; неизвестные токи остаются неизвестными. Прошли 270 выбранных регрессионных тестов, два повтора команды совпали; это не квалификация полного узла. Далее — описать обвязку кандидата и принадлежность нагрузок бюджетам, установить применимые границы источников, затем проверить запуск и динамическую защиту перед перестроением рабочего узла. Существующие проблемы питания остаются видны; кандидаты MPN и изменения рабочей схемы не принимаются. Рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
