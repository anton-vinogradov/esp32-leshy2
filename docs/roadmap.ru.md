...
accessory keep-out в одной системе координат. Реестр H1.1 зафиксирован; более
поздние виды остаются черновыми и ещё не считаются проведёнными.
...
- `H1.1` — реестр физических первоисточников.
  ...
  - `H1.1.3` — классифицировать каждую физическую неопределённость; inferred-
    ...
    - ✅ `H1.1.3.2` — записать все blocker H1 и received-sample gate H5 в
      machine source.
    - `H1.1.3.3` — закрыть оставшиеся source-data blocker и custom D-pad
      actuator design.
...
- ▶️ **`H1.2` — сейчас:** единая система координат двух плат, корпуса, крепежа и keep-outs;
