...
Сейчас — [проверка скорости и воспроизводимости трассировки](h6-r2-routing-automation.ru.md). Рабочие PCB не трассируем до прохождения этого gate; эксперименты идут на копиях. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
