...
Сейчас — [автоматическая трассировка и приёмка проекта](h6-r2-routing-automation.ru.md). Геометрический рубеж на 474 связи и ограниченный пилот генерации индикаторов прошли проверки в своих рамках; электрическая квалификация открыта. Автоматический выбор запаса по току MAIN и совместный статический подбор делителей работают в объявленных моделях; проверка нагрузки и знаковых входных токов отбраковала первые пары при явных тестовых допущениях, уравнения независимо проверены ngspice. Далее — автоматический переподбор и подтверждение реальных границ источников, новой защиты и динамики перед квалификацией полного узла. Существующие проблемы питания остаются видны; кандидаты MPN и изменения рабочей схемы не принимаются. Эксперименты идут на копиях, рабочая трассировка приостановлена. Это внутренний шаг H6.0.3, не закрытие H6 и не разрешение изготовления.
