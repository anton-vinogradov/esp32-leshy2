...
| Физический дизайн | ▶ [H1-R2.35](h1-r2-physical-layout.ru.md): бортовое видео и требующая ручной пайки зона приёмника удалены; точная dual-RP/C5 authority, серийный EastRising-дисплей с адаптером, все 18 компонентов U219, NFC-loop и swept volume штатной антенны проходят fail-closed аудит; до явного принятия мокапа физических блокеров нет; [все 210 MPN-групп базового BOM ранжированы, для полного all-in-one принят коридор $220–260, отдельный Core отложен до работающего EVT1](h1-r2-cost.ru.md) |
