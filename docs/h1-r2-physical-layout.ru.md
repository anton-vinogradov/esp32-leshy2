# H1-R2.30 · компоновка готового устройства
...
- вывести и провести ревью точного порядка GPIO для обоих независимых доменов RP2354B и получающихся M1 endpoints из принятых функциональных групп H0
- доказать точное назначение C5 mux/SDIO на контактах, физически выведенных у выбранного ESP32-C5-WROOM-1U-N8R8-V1.2

> Точный текущий маркер: **H1-R2.30**. H1 продолжается.
