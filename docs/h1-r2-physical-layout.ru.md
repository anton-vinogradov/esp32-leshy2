# H1-R2.39 · рабочая компоновка целевого устройства

Полная проверяемая физическая модель двух плат 80×150 мм принята 2026-08-30; H1 закрыто. Все корпуса, Cap-профили, внешний объём U219-антенны и медные резервы сведены без открытых geometry-gates. Это не разрешает трассировку KiCad: сначала в R2 H2 должны быть закрыты перечисленные ниже электрические prerequisites.
