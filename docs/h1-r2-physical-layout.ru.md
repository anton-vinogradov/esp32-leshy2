...
- выбрать одну точную документированную production-панель дисплея, контролируемый чертёж и mating envelope с детерминированным маршрутом фабричной установки до закрытия H1 и старта R2 H2
...
- выбрать одну точную документированную production-панель дисплея, контролируемый чертёж, electrical map и детерминированный маршрут фабричной стыковки; HMX остаётся только legacy evidence
