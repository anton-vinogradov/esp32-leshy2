# H1-R2.38 · рабочая компоновка целевого устройства
...
- Длина microcoax: две 30-мм перемычки native-radio и три 60-мм перемычки nRF имеют не меньше `9.39 мм` расчётного запаса; каждый nRF проверен до самого дальнего угла полного корпуса SP4, а не до предположенной оси IPEX.
...
| прямой 50-контактный ZIF шлейфа дисплея на UI-плате | `FH34SRJ-50S-0.5SH(50)` | [`C3169104`](https://jlcpcb.com/partdetail/HRS_Hirose-FH34SRJ_50S_0_5SH_50/C3169104) | показано 2 679 шт., доступны к заказу 2 614, MOQ 1, $0.5832 при 1 шт. |
...
> Итоговый маркер: **H1-R2.38**. H1 принято 2026-08-30.
