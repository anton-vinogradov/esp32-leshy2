...
`H3.5` is reviewed: three leaf packages contribute `125` passing checks and this consolidation adds `22` cross-domain checks. No analytical finding remains open. The exact current marker is `H3.6.1`.
