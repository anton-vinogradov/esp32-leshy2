...
| `3V3_MAIN` | 91.110000 | 3046.000 | 71.079 | -44.118 | нарушение |
...
Максимальный рассматриваемый скачок `3V3_MAIN` — **2656.000 мА**. Сравнения модели: запуск **4 / 5**, скачки нагрузки **3 / 4**. Округление аналитического времени с шагом 0.010 мс и вдвое меньше даёт максимальное расхождение 0.005000 мс. Классификация тока не зависит от этого шага; совпадение — да, включая одинаковое нарушение MAIN. Это проверка округления, не пошаговая симуляция схемы и не подтверждение исходных пределов.
