...
Ёмкости больше не переписываются вручную: генератор собирает все реальные capacitor instances, подключённые к каждой шине, прямо из единой карты компонентов и сетей. Сейчас учтено `103` установленных конденсаторов.

| Шина | Номинальная C, мкФ | Worst active load, мА | Итог |
|---|---:|---:|---|
| `AON_SAFE_3V3` | 24.4 | 89.5 | pass_current_limited_start |
| `3V3_MAIN` | 59.8 | 2493.0 | pass |
