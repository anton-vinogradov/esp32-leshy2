...
Ёмкости больше не переписываются вручную: генератор собирает все реальные capacitor instances, подключённые к каждой шине, прямо из единой карты компонентов и сетей. Сейчас учтено `93` установленных конденсаторов.
