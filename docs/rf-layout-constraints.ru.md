# Ограничения RF layout · historical R1

`H3.5.2` проведён ревью: `23` машинных checks, незакрытых аналитических findings нет. Исторический маркер прогресса R1 — `H3.6.1`.
