...
| Точные группы компонентов | 242 MPN-группы, 1 197 позиций на готовое устройство |
...
В принятом H1 было 210 групп и 1 099 позиций. Проверенная граница
Pack/Safety и полный точный тракт преобразования Airband дают текущий
итог: 242 точные группы и 1 197 позиций. Display, опциональный U214,
...
Точный ledger этих 242 групп прошёл ревью как
[`H2-R2.1.2`](h2-r2-symbol-footprint-ledger.ru.md), а следующая
[сверка 4 323 endpoints](h2-r2-net-ledger.ru.md) и
