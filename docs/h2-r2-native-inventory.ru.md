...
| Точные группы компонентов | 240 MPN-групп, 1 195 позиций на готовое устройство |
...
итог: 240 точных групп и 1 195 позиций. Display, опциональный U214,
...
Точный ledger этих 240 групп прошёл ревью как
