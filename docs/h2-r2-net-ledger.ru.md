...
| Контакты, назначенные native nets | 4 063 |
| Явные board no-connects | 260 |
| Неразрешённые или скрытые внешние контакты | 0 |
| Канонические native nets | 827 |
...
Для переноса неизменившихся цепей обвязки использованы 3 168 подсказок
