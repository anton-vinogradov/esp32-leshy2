...
**Исторический результат:** ✅ ревизия `H2.8.2-R1` была принята пользователем 2026-08-26 и остаётся связанной SHA-256. Она явно запрещена как authority для R2. Текущий аппаратный маркер — `H1-R2.30`.
