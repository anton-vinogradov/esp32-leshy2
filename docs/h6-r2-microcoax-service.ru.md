...
**Статус:** ✅ все пять устанавливаемых владельцем microcoax имеют точные H6-коридоры, свободные площадки фиксации, ненатянутый запас длины и доступ для осмотра разъёмов/антенных паек на базе 80 × 150 мм. Это закрывает `H6.0.1-R1`; сейчас выполняется **`H6.0.3-R1` — повторная квалификация разводки.** Закупка и производство не разрешены.
