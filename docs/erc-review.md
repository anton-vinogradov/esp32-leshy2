...
| Intentional NCs | 202 physical contacts · each has a pin, marker and rationale |
| Local symbols | 1146 comparisons moved from the noisy KiCad rule into an exact shared-library check |
