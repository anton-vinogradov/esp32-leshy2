...
| Intentional NCs | 191 physical contacts · each has a pin, marker and rationale |
| Local symbols | 1114 comparisons moved from the noisy KiCad rule into an exact shared-library check |
