...
Для каждого отказа указаны обнаружение, основной путь отключения, независимый или fail-safe путь, безопасный результат и восстановление. Автоматического повторного запуска нет.
