...
M1 выполняет только электрическую функцию и совмещение. Четыре точных 11,00-мм compression-stop, не менее двух противосдвиговых упоров корпуса и независимые захваты обеих PCB не дают платам разойтись или сдвинуться даже при одном ослабленном винте. Нагрузки обычного обращения, установки аккумуляторов и изгиба корпуса несут винты, упоры и захваты, а не SMT-пайка M1.
...
| `35–36` | 1 NC-резерв + bounded reset S3 fault-UI |
