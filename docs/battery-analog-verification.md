...
H3.3.4 is reviewed with `38` machine checks and four source corrections. No component or BOM-cost change is required. The exact current marker is `H3.4.1`: digital levels/defaults and no-back-power.
