...
`H3-R2.1.3` проведён ревью. Все 629 физических и внешних строк нагрузки имеют ровно одного владельца тока либо явный перенос source/pack-строки в H3-R2.1.4. Скрытой строки «прочее» нет.
