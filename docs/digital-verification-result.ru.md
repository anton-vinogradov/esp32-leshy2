...
`H3.4` проведён ревью: проходят все три leaf-пакета, `171` их checks и `28` сквозных сводных checks. Незакрытых аналитических findings нет. Точный текущий маркер — `H3.6.1`.
