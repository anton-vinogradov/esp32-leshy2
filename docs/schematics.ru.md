...
Здесь собраны актуальные принципиальные схемы `H0-R2`/`H1-R2.26` готового
...
K331/AWM666V FPV, M5/U214, задний RP, питание и безопасность.
...
ноль коллизий корпусов на одной стороне и минимальный встречный зазор 3,31 мм
