...
Здесь собраны актуальные принципиальные схемы `H0-R2`/`H1-R2.20` готового
...
![Внешние стороны и прямые виды после переворота плат](images/h1-r2-four-faces.svg?rev=h1-r2.20-board-id-6)
