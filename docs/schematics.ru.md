...
Здесь собраны актуальные принципиальные схемы `H0-R2`/`H1-R2.21` готового
...
voice-радио, broadcast/Airband, аудио, взаимоисключающую post-PCBA-зону K331/AWM666V FPV, M5/U214, задний RP, питание и
безопасность.
...
![Внешние стороны и прямые виды после переворота плат](images/h1-r2-four-faces.svg?rev=h1-r2.21-dual-fpv-7)
...
ноль коллизий корпусов на одной стороне и минимальный встречный зазор 1,05 мм
