...
- Worst case SYS: `16.777 Вт`; pack: `2.796 А` с запасом `257.654%` до 10-А контракта.
...
**Статус:** `H3.1` завершено и проверено. Текущий точный маркер — `H3.3.2`, codec/microphone/headset/speaker corners.
