...
| `H3-PHY-024` | `H5+H8` | `H3.3` | verify received TSOP95238TT/TSMP95000TT identity, orientation, two-channel capture, 20-ms startup guard, 5-ms QOD quiet guard and no-back-power |
