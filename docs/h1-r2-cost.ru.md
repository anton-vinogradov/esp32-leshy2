...
- Цель готового базового устройства: **не более $150.00** без аккумуляторов и полного набора специализированных внешних антенн.
- Чтобы внутри этой цены остались PCB, PCBA и корпус, электроника должна стоить примерно **$108.00–$125.00**.
...
- После них до самой границы $150 всё ещё не хватает **$104.05**, причём платы, сборка и корпус ещё не оплачены. До целевой электронной BOM не хватает **$129.05–$146.05**.
...
|---|---:|---:|---|
| Текущая схема | $278.55 | больше $278.55 | `$150` невозможно |
| Только уже paper-qualified замены | $254.05 | больше $254.05 | всё ещё недостаточно |
| Те же встроенные пользовательские функции и тот же safety-результат после полного cost-resynthesis | $189.00–$216.00 | $216.00–$261.00 | реалистичная цель около `$220–260`, не `$150` |
| Модульная community-база; специализированные тракты ставятся Cap/Unit по задаче | $108.00–$125.00 | $135.00–$165.00 | `$150` правдоподобно, но это уже не полностью начинённый all-in-one |
