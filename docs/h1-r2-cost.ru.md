...
Этот рейтинг `H1-R2.30` был сформирован до принятия host-overlay U219. Точные
активные добавления сейчас дают **$0.6845 на устройство**; после удаления одного
резистора 22 Ом известный active-net равен **$0.669 на устройство** или **$3.345
для EVT5**. Это намеренно не называется фиксированной суммой: точные значения,
MPN и количества вспомогательных пассивов остаются блокером H1. См.
[предварительную дельту U219](../hardware/architecture/generated/H1-R2-U219-bom-delta.csv).
