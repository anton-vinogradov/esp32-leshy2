# H1-R2.22 · стоимость компонентов
...
- С обязательным модулем K331, устанавливаемым после PCBA: **$315.99** на устройство или **$1,579.94** на пять устройств до стоимости плат, сборки, корпуса, антенн, доставки, налогов, брака и теста.
...
- **`Nexperia 74LVC2G126DP,125`:** Коды DP и DC — корпусные варианты одного семейства Nexperia 74LVC2G126: логика, порядок выводов, Schmitt-входы, Ioff и тайминги при 3,0–3,6 В совпадают. TSSOP крупнее VSSOP, поэтому до замены всё равно нужен повторный прогон компоновки. [JLCPCB](https://jlcpcb.com/partdetail/Nexperia-74LVC2G126DP125/C503392)
...
- **`HenryTech HL2-SMA-KEP-13.5 / HL2-RP-SMA-KEP-13.5`:** Карточки JLCPCB подтверждают standard/reverse-пару 50 Ом до 6 ГГц, собственные силовые лапки каждого корпуса, фабричный SMT-маршрут, отсутствие гайки и достаточный остаток для пяти устройств. Но контролируемого производителем чертежа обоих корпусов нет, поэтому посадку, выступ центрального контакта, захват платы по толщине и допустимый момент пока нельзя фиксировать. [JLCPCB](https://jlcpcb.com/partdetail/HenryTech-HL2_SMA_KEP_135/C53278703)
...
2. ✅ **Заменить десять GCT SMA/RP-SMA на индивидуально удерживаемую фабричную пару без общей рамки** — Десять текущих GCT дают $24,65 на устройство и пока не имеют доказанного маршрута JLCPCB. Складская пара HenryTech уже убирает гайки, герметизацию и идею общей рамки, но для неё пока нет контролируемого механического чертежа. Квалифицировать standard/reverse пару с собственными силовыми лапками, чертежом под плату 1,6 мм и рейтингом не ниже 6 ГГц; общую антенную рамку не вводить.
