...
- Достижимый плановый минимум: **$284.66** на устройство; ещё `5` базовых строк не оценены.
- С обязательным модулем K331, устанавливаемым после PCBA: **$314.65** на устройство или **$1,573.25** на пять устройств до стоимости плат, сборки, корпуса, антенн, доставки, налогов, брака и теста.
- Частичный JLCPCB-снимок партии из пяти устройств: **$1,234.40** по `180` найденным строкам; `22` live-проверок дают **$1,300.42**, ещё `30` строки не входят.
