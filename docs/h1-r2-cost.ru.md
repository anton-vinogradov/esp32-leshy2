...
- Серийная материальная база: **$235.35** на устройство; цены известны для `199/210` строк.
- Достижимый плановый минимум: **$263.76** на устройство; ещё `6` базовых строк не оценены.
- С обязательным модулем K331, устанавливаемым после PCBA: **$293.75** на устройство и **$293.75** на один целевой прототип до стоимости плат, сборки, корпуса, антенн, доставки, налогов, брака и теста.
- Исторический JLCPCB capture на пять плат: **$1,234.40** по `180` строкам; `22` live-проверок дают **$1,300.42**, ещё `30` строк не входят; это evidence, а не целевой quantity.
