...
`H3-R2.7` фиксирует результат реализованного аналитического охвата H3. Все `20` актуальных evidence-artifacts и `129` записанных source hashes сведены без единого mismatch и без открытого finding в пределах этих модельных проверок.
...
|---|---|---|
| `H3-R2.0` | Входы, provenance и методы | 2 projects · 22 sheets · 1,208 schematic instances · 788 nets · 251 exact groups · 9 methods |
