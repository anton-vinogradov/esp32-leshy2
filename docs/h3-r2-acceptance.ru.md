...
Публикация пересчитывает 20 evidence-artifacts и проверяет 157 привязок к источникам. Несовпадений хешей: 0. Открытых агрегированных findings: 4. Применимость к нынешнему железу **не наследуется** из исторического закрытия H3.
