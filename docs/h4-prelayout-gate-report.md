...
At the time of this preserved report, the project position was `H1-R2.38`: the exact `H1-R2.31` dual-RP GPIO/M1 and C5 SDIO/USB mux baseline plus the complete Cap/evidence body register were closed. Current R2 work has since advanced through H2–H5 to `H6.0.3-R1`; the former transition to `H5.0.1-R1` was cancelled by the architecture change.
