...
The [live routing checkpoint](h6-r2-current-routing.md) binds 4,605 DRC-clean
track/via items to the current board hashes: 608 physical connections are
resolved and 2,657 remain. This includes a complete UI `ANALOG_AUDIO_SENSE`
class and a complete `VOICE_EFUSE_BACKUP_EN_N`
