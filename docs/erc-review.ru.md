...
| Намеренные NC | 191 физических контактов · у каждого есть pin, marker и причина |
| Локальные символы | 1114 сравнений вынесены из шумного KiCad-правила в точную проверку общей библиотеки |
