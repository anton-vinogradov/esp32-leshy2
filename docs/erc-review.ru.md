...
| Намеренные NC | 189 физических контактов · у каждого есть pin, marker и причина |
| Локальные символы | 1098 сравнений вынесены из шумного KiCad-правила в точную проверку общей библиотеки |
