...
![Four matched PCB faces](images/h1-r2-four-faces.svg?rev=h1-r2.38-one-piece-psa-1)

## Component legend

![Numbered component legend](images/h1-r2-component-legend.svg?rev=h1-r2.38-one-piece-psa-1)

[Detailed exterior at full scale](images/h1-r2-external-layout.svg?rev=h1-r2.38-one-piece-psa-1)

![External service access](images/h1-r2-service-access.svg?rev=h1-r2.38-one-piece-psa-1)

## What is inside

![Direct display ZIF and mechanical retention](images/display-mount.svg?rev=h1-r2.38-one-piece-psa-1)
