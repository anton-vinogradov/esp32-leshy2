...
> **▶ Current hardware boundary: `H3-R2.1.2`.** Inside H3-R2.1, H0, H1 and [H2-R2.1.5](h2-acceptance.md) are reviewed. [H3-R2.0.1](h3-r2-input-freeze.md) freezes 14 stable inputs, [H3-R2.0.2](parameter-model-register.md) binds all 242 R2 groups, [H3-R2.0.3](verification-methods.md) freezes nine methods and twelve rules, and [H3-R2.1.1](power-state-register.md) reviews 2,266 legal states. Exact load binding is current.
...
2026-08-31. The current hardware marker is `H3-R2.1.2`.
...
| **H3 · Virtual electrical verification** | **▶ Current · `H3-R2.1.2`** | Complete power, digital, RF, audio, timing, thermal and fault simulation | Every legal state and transition passes before fabrication |
...
9. ▶ `H3-R2.1`: verify worst-case DC, source, charge and power states.
   ...
   - ▶ `H3-R2.1.2`: bind every powered instance to an explicit worst-case load line.
