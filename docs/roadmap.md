...
Current focus: [automatic routing and design acceptance](h6-r2-routing-automation.md). The 474-connection geometry milestone and bounded indicator-generation pilot passed their scopes; electrical qualification remains open. Automatic MAIN divider and circuit-breaker threshold selection now also checks replacement pin roles, exact auxiliary supply nodes and source conditions. It detects the U21 pin-4 PGTH/FLT incompatibility and binds the existing R266 pullup to protected MAIN; unknown currents remain unknown. The selected regression passes 270 tests and two command replays agree; this does not qualify the whole cell. Next: declare candidate auxiliary wiring and budget ownership, establish applicable source bounds, then validate startup and dynamic protection before rebuilding the native cell. Existing power failures remain visible; no candidate MPN or production schematic is adopted. Production routing stays paused. This is an internal H6.0.3 step, not H6 closure or fabrication authorization.
