...
Current focus: [automatic routing and design acceptance](h6-r2-routing-automation.md). The 474-connection geometry milestone and bounded indicator-generation pilot passed their scopes; electrical qualification remains open. Automatic MAIN divider reselection now feeds a candidate-specific circuit-breaker threshold search, accounting for both protected and bypass divider currents. Independent wider E192 enumeration confirms the conditional threshold optima; ngspice checks the divider equations. Unknown auxiliary currents, source applicability and dynamics still prevent full-cell qualification. Next: bind all auxiliary supply paths and actual source bounds, then validate startup and dynamic protection before rebuilding the native cell. Existing power failures remain visible; no candidate MPN or production schematic is adopted. Production routing stays paused. This is an internal H6.0.3 step, not H6 closure or fabrication authorization.
