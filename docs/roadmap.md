...
> **▶ Current hardware boundary: `H3-R2.0.2`.** H0, H1 and [H2-R2.1.5](h2-acceptance.md) are reviewed. [H3-R2.0.1](h3-r2-input-freeze.md) hash-binds 14 exact inputs and assigns all 23 native sheets exactly once across seven workstreams. H3 now rebuilds exact parameter/model provenance.
...
2026-08-30. The current hardware marker is `H3-R2.0.2`.
...
| **H3 · Virtual electrical verification** | **▶ Current · `H3-R2.0.2`** | Complete power, digital, RF, audio, timing, thermal and fault simulation | Every legal state and transition passes before fabrication |
...
7. ▶ `H3-R2.0.2`: rebuild the exact parameter and model-provenance register for current R2.

The exact parameter/model provenance register is the next action. Placement, routing, quoting and
