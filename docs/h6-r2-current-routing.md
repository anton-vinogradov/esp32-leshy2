...
All 1,208 bodies are placed; all 181 local-part → owner pairs meet their limits and locality has zero violations. Both boards have zero native DRC findings. The deliberate restart leaves 3,265 physical connections, summarized in the table above.
