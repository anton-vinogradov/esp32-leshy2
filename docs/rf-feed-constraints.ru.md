...
`H3.5.1` проведён ревью: `75` машинных checks охватывают все десять внешних антенных портов, незакрытых аналитических findings нет. Точный текущий маркер — `H3.6.1`.
