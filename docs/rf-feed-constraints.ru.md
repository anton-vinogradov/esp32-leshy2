# Ограничения антенных трактов

`H3.5.1` проведён ревью: `72` машинных checks охватывают все девять внешних антенных портов, незакрытых аналитических findings нет. Точный текущий маркер — `H3.5.2`.
