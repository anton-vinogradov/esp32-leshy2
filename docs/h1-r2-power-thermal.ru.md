...
- Худшая группа — `AIRBAND_RX`: `2.823 А` на `3V3_MAIN`. Приняты `3.75 А` continuously и `4.25 А` step; запас до continuous-границы — `0.927 А` (`32.8%`).
...
> Маркер результата: **H1-R2.4**. H1 продолжается.
