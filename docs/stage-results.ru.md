...
**Статус:** ▶️ сейчас **`H3-R2.1.2`** внутри H3-R2.1.
...
Сейчас каждый питаемый экземпляр связывается с явной нагрузкой до расчёта DC margins. Ожидаемый результат — полная проверка power, digital, RF,
