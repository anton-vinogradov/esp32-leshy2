...
обе платы. Трассировка не начиналась. [Точный результат механического
стека](h6-r2-mechanical-stack.ru.md) уже фиксирует 20-мм нейлоновые винты M2.5,
...
кончик винта без несущей роли M1. H6.0.1 остаётся открытым только из-за пяти
ненатянутых microcoax-коридоров и их зазоров корпуса/окон осмотра.
