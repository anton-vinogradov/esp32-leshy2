...
**Статус:** ▶️ сейчас `H5.0.2`; поиск разрешён, закупка — нет.

Текущий [машинный план](../hardware/verification/h5-component-evidence-plan.json)
фиксирует [проведённую карту H5.0.1](component-evidence-map.ru.md): девять
residuals H5 и 14 механических gate’ов связаны с точными выбранными identities,
источниками, недостающими данными и pass rules. H5.0.2 теперь исчерпывает документы
производителя и полностью описанные серийные замены. Только неустранимый набор образцов позже может стать отдельно
