...
`GENERAL_CONTROL` + `OSCILLATOR` полностью разведены 177 сетей / 366 соединений;
обе сохранённые платы проходят свежий DRC KiCad 10.0.5 без нарушений. Текущими
остаются safety-control и аналоговые/audio/sense-сети.
