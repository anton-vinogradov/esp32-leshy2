...
**Статус:** ▶️ сейчас **`H3-R2.1.3`** внутри H3-R2.1.
...
устанавливаемых питаемых экземпляров и шести внешних нагрузок. Сейчас по этим
строкам считаются запасы шин. Ожидаемый результат — полная проверка power, digital, RF,
