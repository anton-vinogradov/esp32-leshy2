...
двенадцать pass/fail rules для всех 242 групп. Сейчас проверяются worst-case DC,
source, charge и power states. Ожидаемый результат — полная проверка power, digital, RF,
