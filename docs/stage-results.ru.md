...
к H5/H7. Пять активных host-корпусов U219 и их source-backed courtyards уже
помещаются в два выделенных острова; полный канонический реестр
существующих Cap/evidence-корпусов, footprints вспомогательных пассивов, геометрия NFC pickup
и swept volume установленной антенны — четыре блокера финального принятия мокапа.
