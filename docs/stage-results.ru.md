...
позиций. Сейчас фиксируются воспроизводимые методы, допуски и pass/fail rules. Ожидаемый результат — полная проверка power, digital, RF,
