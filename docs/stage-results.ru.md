...
7. ✅ Nets `H2-R2.1.3`: 4 323 контакта устанавливаемых экземпляров сведены в
   823 канонических nets либо 256 явных board no-connects; незакрытых endpoints нет;
8. ✅ `H2-R2.1.3`: три native-проекта KiCad материализуют 4 323 физических pins
