...
встречный зазор — 1,05 мм. Увеличенная зона 30×24×8 мм содержит
...
к H5/H7. Инженерных блокеров нет; явное принятие полного мокапа — финальное действие H1.
