...
**Статус:** ▶️ сейчас **`H1-R2.35`**.

- [Текущий физический дизайн](h1-r2-physical-layout.ru.md)
- [Внешние стороны](images/h1-r2-external-layout.svg?rev=h1-r2.35-full-power-nrf24-1)
...
Единая координатная модель содержит 215 тел: все корпуса компонентов, все 18
