...
**Статус:** ▶️ сейчас, точный маркер `H3.5.1`.
...
27 сквозными checks поверх всех 162 leaf checks. В `H3.5.1` выводятся 50-омные
ограничения feed, connectors, matching и потерь.
