...
7. ✅ Nets `H2-R2.1.3`: 4 302 контакта устанавливаемых экземпляров сведены в
   823 канонические nets либо 238 явных board no-connects; незакрытых endpoints нет;
...
1 208/1 208 устанавливаемых экземпляров и все 823 канонические сети; машинный
...
окон осмотра антенных паек при минимальном запасе кабеля 9,13 мм. H6.0.1
завершён; H6.0.2 теперь владеет трассировкой всех 823 сетей, паритетом native
