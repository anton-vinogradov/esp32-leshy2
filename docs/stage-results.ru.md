...
**Статус:** ▶️ сейчас **`H3-R2.0.1`**.

Текущая работа фиксирует прошедшие ревью входы H2, source hashes и полную
матрицу проверки R2. Ожидаемый результат — полная проверка power, digital, RF,
