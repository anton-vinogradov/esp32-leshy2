...
**Статус:** ▶️ сейчас `H1-R2.1`; результат R1 сохранён как evidence, а не как текущая приёмка.

- [Текущее физическое размещение H1-R2.1](h1-r2-physical-layout.ru.md) — новые
...
- [Машинный аудит H1-R2.1](../hardware/product-design/generated/H1-R2-placement-audit.json).
