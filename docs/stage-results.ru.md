...
жёстких коллизий placement нет. В текущих платах сохранено 3 665 чистых по DRC
элементов дорожек/via, включая полный путь `VOICE_EFUSE_BACKUP_EN_N` через
новый коридор обычными дорожками 0,15 мм и via 0,4/0,2 мм. Свежий DRC KiCad
...
[политике трассировки H6.0.2](h6-r2-routing-policy.ru.md#как-сейчас-выглядит-реальная-разводка).
