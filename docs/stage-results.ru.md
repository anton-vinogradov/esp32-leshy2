...
**Статус:** ▶️ сейчас **`H3-R2.0.2`**.

[`H3-R2.0.1`](h3-r2-input-freeze.ru.md) провёл ревью hash-bound входа H2 и полной
матрицы проверки R2. Текущая работа заново строит точное происхождение параметров и моделей. Ожидаемый результат — полная проверка power, digital, RF,
