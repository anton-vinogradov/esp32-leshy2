...
- Выбрано: `Vishay TSOP95238TT`; `Vishay TSMP95000TT`; `Vishay VSMY14940`.
...
- Осталось доказать: полную внешнюю ёмкость AMI для полученных SMA, разведённой PCB и собранного точного pod.
- Критерий: полученный и однозначно идентифицированный образец напрямую подтверждает пункт; несовпадение повторно открывает связанный результат H1/H2/H3.
