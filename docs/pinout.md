...
This is the exact H1-R2.31 working GPIO map for the two independent RP2354B domains and their five M1 signals. The exact C5 module-pad/IO-mux electrical contract is joined. It still does not authorize KiCad: the live FSUSB42MUX/C11355 production route and the exact service-VBUS detector/latch/release implementation are reviewed, while the Pack/Safety I²C powered-off-Ioff boundary remains fail-closed before a new R2 H2 export.
