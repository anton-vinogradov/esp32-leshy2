...
- Still to prove: current-lot complete FPC construction and fit in the direct FH34SRJ-50S-0.5SH(50), including the folded maximum component stack, safe 180-degree bend radius, exact acrylic-foam thickness/material and rounded-slot insertion; received ER-TFT035IPS-6 plus ER-TPC035-6 identity/readback, measured VDD/VDDI ramp equality and one-prototype adhesive/FPC assembly record. The one-piece pad cut and the separate PSA and DISPLAY/FPC-UP silkscreen datums are already fixed.
- Pass rule: the factory assembly record confirms the exact ER-TFT035IPS-6 + ER-TPC035-6, one carrier-backed PSA pad correctly located on the PCB, free FPC pocket and direct-FH34SRJ insertion, then the panel located by the second datum; owner bring-up of the sole prototype confirms ILI9488/FT6236, VDD/VDDI, reset, image and touch; a mismatch reopens H1/H2/H3
...
- `H5-MECH-DISPLAY-TAIL` — `EastRising ER-TFT035IPS-6 + ER-TPC035-6`; `Hirose FH34SRJ-50S-0.5SH(50)`; open: Current-lot folded FPC maximum component stack, actual insertion, exact 180-degree bend radius and the assembler's accepted thicker acrylic-foam material/process remain properties of the one-prototype route. The production intent is one carrier-backed pad applied to the PCB: a 54.54×58.46-mm lower field plus two connected 3.32×24.50-mm upper shoulders, about 69.8% panel support, no separately handled top strip, and separate PSA and DISPLAY/FPC-UP silkscreen datums. The old 0.17-mm 3M 9495LE candidate is not sufficient unless measurement unexpectedly proves the required 0.20-mm clearance.
