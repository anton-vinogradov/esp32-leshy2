...
- Still to prove: current-lot complete FPC construction and fit in the direct FH34SRJ-50S-0.5SH(50), including the folded maximum component stack, safe 180-degree bend radius, exact traceable stocked 50×50-mm acrylic-foam MPN/thickness and rounded-slot insertion; received ER-TFT035IPS-6 plus ER-TPC035-6 identity/readback, measured VDD/VDDI ramp equality and one-prototype adhesive/FPC assembly record. The stock rectangle position and the separate PSA and DISPLAY/FPC-UP silkscreen datums are already fixed.
- Pass rule: the factory assembly record confirms the exact ER-TFT035IPS-6 + ER-TPC035-6, one stocked 50×50-mm PSA rectangle correctly located on the PCB, free upper FPC zone and direct-FH34SRJ insertion, then the panel located by the second datum; owner bring-up of the sole prototype confirms ILI9488/FT6236, VDD/VDDI, reset, image and touch; a mismatch reopens H1/H2/H3
