...
- Still to prove: current-lot complete FPC construction and fit in the direct FH34SRJ-50S-0.5SH(50), including the folded maximum component stack, safe 180-degree bend radius, exact acrylic-foam spacer thickness/cut and rounded-slot insertion; received ER-TFT035IPS-6 plus ER-TPC035-6 identity/readback, measured VDD/VDDI ramp equality and one-prototype adhesive/FPC assembly record.
...
- `H5-MECH-DISPLAY-TAIL` — `EastRising ER-TFT035IPS-6 + ER-TPC035-6`; `Hirose FH34SRJ-50S-0.5SH(50)`; open: Current-lot folded FPC maximum component stack, actual insertion, exact 180-degree bend radius, the safe rear adhesive perimeter and the assembler's accepted thicker acrylic-foam spacer material/process remain properties of the one-prototype route. The old 0.17-mm 3M 9495LE candidate is not sufficient unless measurement unexpectedly proves the required 0.20-mm clearance.
