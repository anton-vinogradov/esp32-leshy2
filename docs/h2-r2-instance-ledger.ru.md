...
|---|---:|
| Устанавливаемые экземпляры на платах | 1 185 |
| Точные группы компонентов плат | 234 |
| Native-проекты | 3 |
...
- [Сгенерированный ledger 1 185 экземпляров](../hardware/ecad/generated/H2-R2-native-instance-ledger.json)
