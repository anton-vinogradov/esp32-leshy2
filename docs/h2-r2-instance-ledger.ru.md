...
|---|---:|
| Устанавливаемые экземпляры на платах | 1 183 |
| Точные группы компонентов плат | 232 |
| Native-проекты | 2 |
...
- [Сгенерированный ledger 1 183 экземпляров](../hardware/ecad/generated/H2-R2-native-instance-ledger.json)
