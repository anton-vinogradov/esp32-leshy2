...
**Current marker:** `H3.6.1` — [RF verification](rf-verification-result.md) is consolidated; the worst-case board, battery and enclosure thermal model is being built.
