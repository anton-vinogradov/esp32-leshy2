...
**Current hardware marker:** `H5.0.1` — H3 and the [joined H4 gate](h4-prelayout-gate-report.md) are reviewed; physical evidence is being reduced with documents and serial alternatives before purchase.
