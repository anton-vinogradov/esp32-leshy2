...
**Result:** `14/14` scenarios and `51` endpoint checks pass. **Current marker:** `H3-R2.2.2` — USB↔pack handover, DPM, brownout and source loss. Ordering and routing remain forbidden.
