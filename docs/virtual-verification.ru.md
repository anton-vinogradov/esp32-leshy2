...
Ревизия H2 с независимыми SA818S-V/U принята 26 августа 2026 года и привязана к исходникам SHA-256. Заморожено 44 файла; изменение любого из них повторно открывает затронутые проверки.
