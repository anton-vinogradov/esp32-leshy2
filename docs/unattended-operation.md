...
The pre-physical engineering target is `0 to 35 °C`, not a datasheet guarantee. At 35 °C H6 must achieve no worse than `16.713 K/W` for quiet and `4.803 K/W` for heavy voice RX.
