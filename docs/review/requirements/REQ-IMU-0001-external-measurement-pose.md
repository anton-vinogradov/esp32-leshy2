...
| `REQ-IMU-09` | IMU cannot make security/destructive decisions. | No transmit, Controlled-Zone entry, secret erase/unlock, tamper or fall decision is triggered solely by IMU data. |
