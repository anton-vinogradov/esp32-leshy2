...
- Статус набора: **На ревью; ожидает решения `IMP-0012`**
- Этап: 2 — возможности и исключения
- Источники кандидатов: `C-GPS-01`–`C-GPS-04`, `C-X-06`, `C-X-07`, `C-X-11`, GNSS-часть `C-UX-01`
- Обязательные решения: `DEC-0002`, `DEC-0005`, `DEC-0006`, `DEC-0008`, `DEC-0010`, `DEC-0013`
- Открытые входы: `FND-0009`, `IMP-0012`; pin/power/profile proof следующих этапов
...
### Advanced profile при принятии `IMP-0012/A`
...
Base hardware не дорожает: GNSS остаётся внешним по `DEC-0006`/`DEC-0008`. Вариант `IMP-0012/A` добавляет firmware/HIL NRE, но не BOM; эта работа необходима, чтобы сохранить legacy-пользовательский результат честно. Удаление advanced-функций по варианту B считается сокращением scope, а не экономией без потерь. Третий backend по варианту C добавляется только при отдельном принятом требовании.
