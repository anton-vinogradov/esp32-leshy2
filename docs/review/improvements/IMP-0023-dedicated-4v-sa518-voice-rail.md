# ⚠️ IMP-0023 — dedicated 4.0 V rail для SA518
...
⚠️ **Принимаем вариант A: отдельный регулируемый `VVOICE` около 4.0 V для SA518, а SA868S fallback — только как отдельный явно квалифицированный stuffing profile?**
