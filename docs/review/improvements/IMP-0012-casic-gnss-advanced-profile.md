...
Принимаем **вариант A**: оставить дешёвый NMEA baseline и сохранить assistance + индикатор помех/подмены как advanced CASIC-функции только после проверки конкретной прошивки каждого M5-профиля, без добавления третьего GNSS и без ложного обещания «детектор всегда есть»?
