...
- Статус: **⚠️ Предложение; открыто, решение отложено до сводного pin budget по `DEC-0012`**
- Связано: `FND-0006`, `FND-0007`, `IMP-0006`, `DEC-0003`, `DEC-0005`, `DEC-0008`, `DEC-0009`
- Этап решения: 3 — после сводного pin/GPIO/resource budget; схемная реализация и proof — этапы 3–9
...
## Условие возврата на решение

По `DEC-0012` варианты ниже сейчас не выносятся владельцу. Предложение возвращается на решение только после сводного бюджета всей системы: прямых GPIO S3/C5, expander lines, fixed-function/strap pins, S3↔C5 transport, audio, UI/touch, внешних модулей и фактически освобождённых onboard GNSS/LoRa ресурсов. До этого `U14`, matrix и конкретная STOP-реализация не считаются выбранными.
