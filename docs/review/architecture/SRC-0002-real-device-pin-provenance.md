...
| downstream rail tree | `TPS629203DRLR`, 3×`TPS564252DRLR`, `WPN201612H2R2MT`, 2×`MWSA0503S-3R3MT`, `MWSA0503S-4R7MT`, 5×`TPS22919DCKR`, 2×`MMBT3904-7-F`, `TPS259470LRPWR` | official package tables prove every real pin; independent fixed 4/5-V feedback removes the SA518 overvoltage selector fault; exact current/ripple and stock evidence are in `PWR-0008/PWR-0009` | `DEC-0068/REV-0005Y` active topology reviewed; `DEC-0069` makes the external fault boundary latch-off; `DEC-0070` prevents optional-off PG from becoming a false fault; passive/DC-bias, hot-loss and HIL remain I3 |
