...
| downstream rail tree | `TPS629203DRLR`, `TPS3808G33DBVR`, 3×`TPS564252DRLR`, `WPN201612H2R2MT`, 2×`MWSA0503S-3R3MT`, `MWSA0503S-4R7MT`, 5×`TPS22919DCKR`, 2×`MMBT3904-7-F`, `TPS259470LRPWR`, 24 exact converter energy/configuration/feedback passives and 10 exact control/POR resistors | official package tables prove every real IC pin; independent fixed 4/5-V feedback removes the SA518 overvoltage selector fault; `PWR-0011/0012/0019` verify exact passive MPNs, tolerance/loading screens, physical instances and AON-PG/POR/main sequencing | `DEC-0068/REV-0005Y` active topology reviewed; `DEC-0069` makes the external fault boundary latch-off; `DEC-0070` prevents optional-off PG from becoming a false fault; `DEC-0072/0073/0080` close converter energy/feedback/control/source sequencing; hot-loss and HIL remain I3 |
