...
| supervised 2S manager circuit | `MAX17320G20+T`, `MSPM0C1104SDGS20R`, `CSD87313DMST`, 2×`0451005.MRL`, `WSL25125L000FEA`, 2×`B57332V5103F360`, `2N7002DW-7-F`, `BAV70LT1G`, `BAT54-7-F`; diagnostic `TPUL2G223BQBR`, `DMN2056U-7`, `CRCW251210R0JNEGIF` and exact divider/filter passives | manufacturer package tables prove every exposed contact; MAX17320 references require the common-drain pair; TPUL is non-retriggerable; exact MSPM0 DGS20 exposes PA25/A2 pin 20 and PA26/A1 pin 1, while PA24 permits no injection current | `DEC-0067/REV-0005X` manager circuit and `DEC-0074/REV-0005AE` exact diagnostic frontends reviewed; PA24 mismatch closed by `FND-0078`; mechanical coupling, thresholds/cooldown and hot/fault/source-handover HIL remain I3 |
| downstream rail tree | `TPS629203DRLR`, 3×`TPS564252DRLR`, `WPN201612H2R2MT`, 2×`MWSA0503S-3R3MT`, `MWSA0503S-4R7MT`, 5×`TPS22919DCKR`, 2×`MMBT3904-7-F`, `TPS259470LRPWR`, 24 exact converter energy/configuration/feedback passives and 9 exact control resistors | official package tables prove every real IC pin; independent fixed 4/5-V feedback removes the SA518 overvoltage selector fault; `PWR-0011/0012` verify exact passive MPNs, tolerance/loading screens and physical instances | `DEC-0068/REV-0005Y` active topology reviewed; `DEC-0069` makes the external fault boundary latch-off; `DEC-0070` prevents optional-off PG from becoming a false fault; `DEC-0072/0073` close converter energy/feedback/control passives; hot-loss and HIL remain I3 |
