...
| `I8` | consolidated BOM evidence, lifecycle, availability, cost and alternates | `I1…I7` | **inventory, current-source batch, display sourcing strategy, substitution-policy coverage and two cost batches reviewed; qualification active** by `FND-0109/BOM-0008`, source repairs, `BOM-0011`, `BOM-0012/DEC-0104/REV-0005BK` and `BOM-0013…0014/DEC-0105…0106/REV-0005BL…BM`: 858 architecture instances include 1 assembly-internal evidence node, leaving 857 supplied/costed placements / 187 purchase lines, 186 source records, 187 alternate/no-substitution dispositions, 23 costed lines / 440 placements, five explicit unpriced gates and four explicit uninstantiated physical families; standalone `HMX035CTFT-001`, 164 prices and specific alternate qualification remain open | every base function maps to exact first target plus equivalence/alternate and sourcing gate |
...
high-placement passive prices and explicit RFQ/retail gates. Current coverage
is 23/187 prices / 440 placements; the USD 68.8226 subtotal is partial
base-product material only. Five of 164 remaining price gaps now have explicit
routes, and full COGS remains open.
