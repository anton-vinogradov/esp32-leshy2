...
| `I3` | battery, charging, power path, rails, load switches, monitoring and thermal | `I1/I2`, `PWR-0001`, scenario ledger | **active; supervised 2S and USB-PD frontend reviewed** by `DEC-0065/0063`; exact manager gate `IMP-0054`, rails/passives/calculation/HIL open | complete rail tree and sequencing with exact first targets, loss/thermal/fault budget |
...
`DEC-0065/REV-0005T`; `IMP-0054` is again the current manager gate. `IMP-0053/B` is
...
S3 USB2 and leave GPIO47 free. I3 now closes the exact 2S cell manager and the
complete rail/loss/thermal/fault tree from `PWR-0005/IMP-0054`.
