...
| `I3` | battery, charging, power path, rails, load switches, monitoring and thermal | `I1/I2`, `PWR-0001`, scenario ledger | **active; supervised 2S, exact manager/frontend/surrounding circuit and active rail tree reviewed** by `DEC-0063/0065/0066/0067/0068` and `PWR-0007/0008`; passive values, hot calculation and HIL open | freeze passives and complete loss/thermal/fault/source-transition budget |
