...
| `I3` | battery, charging, power path, rails, load switches, monitoring and thermal | `I1/I2`, `PWR-0001`, scenario ledger | **active; battery behavior and USB-PD frontend reviewed** by `DEC-0062/0063` and `REV-0005Q/R`: two replaceable 18650 cells behind fail-closed admission; exact sink-only 30-W TPS25751D/BQ25798 path accepted; manager/rails/passives/calculation/HIL open | complete rail tree and sequencing with exact first targets, loss/thermal/fault budget |
