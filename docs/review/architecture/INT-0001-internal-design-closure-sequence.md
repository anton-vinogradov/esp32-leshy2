...
| `I3` | battery, charging, power path, rails, load switches, monitoring and thermal | `I1/I2`, `PWR-0001`, scenario ledger | **active; supervised 2S, exact manager/frontend and surrounding circuit reviewed** by `DEC-0063/0065/0066/0067` and `PWR-0007/REV-0005X`; passive values, rails/calculation/HIL open | complete rail tree and sequencing with exact first targets, loss/thermal/fault budget |
...
continues through exact cell-tap/passive/diagnostic values and the
