...
`BOM-0013…0024/DEC-0105…0106/REV-0005BL…BX` then validate the cost-evidence
contract, explicit RFQ/retail gaps and first 162/187 prices covering 816
placements. Their USD 150.4157 base-product subtotal is deliberately partial;
25 prices and full factory COGS remain open.
