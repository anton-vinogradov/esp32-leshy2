...
`BOM-0013/DEC-0105/REV-0005BL` then validate the cost-evidence contract and
review the first 15/187 prices covering 22 placements. Their USD 57.2502
base-product subtotal is deliberately partial; 172 prices and full factory
COGS remain open.
