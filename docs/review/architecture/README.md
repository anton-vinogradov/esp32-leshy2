...
`BOM-0013…0014/DEC-0105…0106/REV-0005BL…BM` then validate the cost-evidence
contract, explicit RFQ/retail gaps and first 23/187 prices covering 440
placements. Their USD 68.8226 base-product subtotal is deliberately partial;
164 prices and full factory COGS remain open.
