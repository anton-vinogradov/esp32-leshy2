...
|---|---|---|---|
| nRF24 #0/#1/#2 | отдельные PIO0 SM0/1/2 и отдельные SCK/MOSI/MISO/CSN/CE/IRQ | отсутствует на bus/IRQ уровне | existing IRQ/FIFO HIL, simultaneous full-function PRX |
