...
| `C-006` | `DEC-0099/SVC-0002`: S3 protected product USB plus two independently board-off-isolated data-only USB-C; three keyed DBG10 and separate BOOT+RESET controls; exact USB4105/TPD2/FSUSB42/FTSH-P/SKQG/TPD4 parts, passive IDs and conflict-free STOP reset sinks | project-local CAD, USB SI/ESD/backfeed, exact lot/alternate/assembly/mechanics, accidental access and erased/corrupt-image/multi-host HIL |
