...
| `P-004` | F | exact `TPS564252DRLR + MWSA0503S-3R3MT + MMBT3904-7-F` dedicated `VVOICE=4.0 V` ≥1.25/1.5 A with exact 68/12-kOhm feedback, energy/Cff, EN/PG/base passives and qualified fault evidence | E2; E3 partial | SA518 startup/TX transient, ripple, effective capacitance/discharge and STOP dominance HIL |
...
| `P-006` | F | exact `TPS629203DRLR + WPN201612H2R2MT` `AON_SAFE` regulator, direct SYS enable, open VSET fixed 3.3 V, 42.2-kOhm mode, 47-kOhm PG into exact `TPS3808G33DBVR.MR_N`, exact 10-kOhm POR pull-up/100-kOhm main fail-low and exact input/output capacitors | E2; E3 partial | capacitor hold-up and AON-PG/SENSE/CT/POR/main transition plus valid STOP latch/indicator/gates through application-rail collapse and brownout |
