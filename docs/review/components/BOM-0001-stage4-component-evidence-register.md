...
| `P-005` | F | exact `TPS564252DRLR + MWSA0503S-4R7MT + MMBT3904-7-F + TPS259470LRPWR` protected `5V_EXT`: 1.25 A continuous, controlled startup and bounded 2.0-A post-start transient; eight exact eFuse passives | E2; E3 partial | DC-bias/inrush/hot-loss/OVLO/fault/discharge HIL, high-current geometry, connector fault and per-profile isolation |
