...
- [FND-0052: draft maps do not close slow control or S3 UART fallback](findings/FND-0052-draft-maps-do-not-close-slow-control.md)
...
- [⚠️ IMP-0037: complete slow-control plane and isolate external I²C — решение открыто](improvements/IMP-0037-slow-control-and-external-i2c-isolation.md)
...
- [REV-0004K: slow-control/external-I²C fact review — проведено ревью; proposal open](reviews/REV-0004K-slow-control-and-i2c-fact-review.md)
