...
- [SRC-0001: primary package/controller/peripheral facts — проведено ревью](architecture/SRC-0001-primary-hardware-resource-facts.md)
...
- [PIN-0002: zero-based exact pin/controller maps — проведено ревью](architecture/PIN-0002-zero-based-exact-pin-maps.md)
