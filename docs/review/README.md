...
- [FND-0040: current competitor benchmark missing — G2 повторно на ревью](findings/FND-0040-current-competitor-benchmark-missing.md)
...
- [FND-0048: accepted 5 GHz does not imply 6 GHz/Wi-Fi 6E](findings/FND-0048-5ghz-does-not-imply-6ghz.md)
...
- [⚠️ IMP-0034: 6 GHz/Wi-Fi 6E placement — требуется решение](improvements/IMP-0034-6ghz-wifi6e-placement.md)
...
- [AUD-0004: current competitor capability/product-design gap — на ревью](audits/AUD-0004-current-competitor-capability-gap.md)
...
- [AUD-0012: 6 GHz/Wi-Fi 6E scope — проведено ревью фактов](audits/AUD-0012-6ghz-wifi6e-product-scope.md)
