...
- [⚠️ IMP-0036: task-based display performance or hard full-frame path — требуется решение](improvements/IMP-0036-task-based-display-performance.md)
...
- [DSP-0001: display/touch/storage real-device evidence — факты проведены ревью](architecture/DSP-0001-display-storage-real-device-evidence.md)
...
- [BUD-0002: historical memory/traffic model — display row requires repeat review](architecture/BUD-0002-zero-based-memory-traffic-budget.md)
...
- [REV-0003Z: display/touch/storage exact-device facts — проведено ревью, target открыт](reviews/REV-0003Z-display-storage-real-device-evidence.md)
