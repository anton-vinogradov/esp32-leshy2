...
- [⚠️ IMP-0026: connectorless owner recovery fixture — требуется решение](improvements/IMP-0026-connectorless-owner-recovery-fixture.md)
...
- [REV-0004F: compute recovery/link prerequisites — проведено ревью; IMP-0026 открыт](reviews/REV-0004F-compute-recovery-link-prerequisites.md)
