...
- [⚠️ IMP-0028: M5-first, not M5-only expansion platform — требуется решение](improvements/IMP-0028-m5-first-not-m5-only-expansion.md)
...
- [AUD-0005: M5 expansion ecosystem coverage — проведено ревью фактов; proposal открыт](audits/AUD-0005-m5-expansion-ecosystem-coverage.md)
