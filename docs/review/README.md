...
- [⚠️ IMP-0032: physical keyboard as a whole-product archetype — требуется решение](improvements/IMP-0032-keyboard-whole-product-comparison.md)
...
- [AUD-0009: physical-keyboard product archetype — проведено ревью фактов; решение открыто](audits/AUD-0009-physical-keyboard-product-archetype.md)
