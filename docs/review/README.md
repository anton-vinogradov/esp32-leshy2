...
- [DEC-0035: open personal FIDO authenticator](decisions/DEC-0035-open-personal-fido-authenticator.md)
...
- [REQ-FIDO-0001: open personal FIDO authenticator — проведено ревью требований](requirements/REQ-FIDO-0001-open-personal-authenticator.md)
...
- [FND-0043: open multitool is not automatically a hardware security key](findings/FND-0043-open-multitool-is-not-a-hardware-security-key.md)
...
- [IMP-0029: open personal FIDO authenticator — принят A/DEC-0035](improvements/IMP-0029-open-personal-fido-authenticator.md)
...
- [⚠️ IMP-0033: native High-Speed USB host — требуется решение](improvements/IMP-0033-native-high-speed-usb-host.md)
...
- [AUD-0006: FIDO authenticator capability/security boundary — проведено ревью фактов](audits/AUD-0006-fido-authenticator-security-boundary.md)
...
- [AUD-0010: High-Speed USB host use cases — проведено ревью фактов; решение открыто](audits/AUD-0010-high-speed-usb-host-use-cases.md)
...
- [REV-0002AG: U2F/FIDO prerequisite review — проведено ревью фактов](reviews/REV-0002AG-fido-prerequisites.md)
- [REV-0002AH: open personal FIDO decision propagation — проведено ревью](reviews/REV-0002AH-fido-decision-propagation.md)
