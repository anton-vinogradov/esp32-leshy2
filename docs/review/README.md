...
- [IMP-0024: C5 v1.2 production floor — принят DEC-0029](improvements/IMP-0024-c5-v1.2-production-floor.md)
- [IMP-0025: repository-vendored critical CAD libraries — принят DEC-0030](improvements/IMP-0025-repository-vendored-critical-cad-libraries.md)
- [IMP-0026: physical development access — принят вариант B в DEC-0031](improvements/IMP-0026-connectorless-owner-recovery-fixture.md)
...
- [CAP-0001: hardware-neutral capability input — проведено ревью](architecture/CAP-0001-zero-based-capability-input.md)
- [CON-0001: hardware-neutral concurrency/failure model — проведено ревью](architecture/CON-0001-hardware-neutral-concurrency-model.md)
- [RES-0001: hardware-neutral resource demand — проведено ревью](architecture/RES-0001-hardware-neutral-resource-demand.md)
