...
- [FND-0030: legacy 5 V voice rail превышает принятый SA518 1 W profile](findings/FND-0030-sa518-legacy-5v-exceeds-accepted-1w-profile.md)
...
- [⚠️ IMP-0023: dedicated 4.0 V rail для SA518 — предложение](improvements/IMP-0023-dedicated-4v-sa518-voice-rail.md)
...
- [BUD-0001: numeric traffic/memory/power envelope — power в работе](architecture/BUD-0001-traffic-memory-power-envelope.md)
