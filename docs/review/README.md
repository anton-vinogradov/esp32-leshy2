...
- [DEC-0028: принят единый zero-based target `PKG-0001/SYN-3A`](decisions/DEC-0028-accept-zero-based-syn-3a.md)
- [DEC-0029: C5 v1.2 production floor и controlled fresh-revision policy](decisions/DEC-0029-c5-v1.2-production-floor.md)
- [DEC-0030: repository-vendored critical CAD libraries](decisions/DEC-0030-vendored-critical-cad-libraries.md)
- [DEC-0031: permanent USB/debug/BOOT/RESET access каждого compute domain](decisions/DEC-0031-permanent-three-domain-development-access.md)
...
- [Zero-based architecture workspace — активная точка этапа 3](architecture/README.md)
...
- [PKG-0001: принятый единый zero-based target `SYN-3A` — проведено ревью](architecture/PKG-0001-zero-based-target-architecture-proposal.md)
...
- [REV-0003U: принятие и cross-repository propagation — проведено ревью](reviews/REV-0003U-stage3-acceptance-propagation.md)
- [Этап 4: components/BOM — активный реестр](components/README.md)
- [BOM-0001: component evidence register — проведено ревью реестра](components/BOM-0001-stage4-component-evidence-register.md)
...
- [REV-0004E: vendored critical CAD libraries — проведено ревью](reviews/REV-0004E-vendored-critical-cad-libraries.md)
...
- [SVC-0001: permanent three-domain development access — проведено ревью topology/candidates](components/SVC-0001-three-domain-development-access.md)
- [REV-0004G: three-domain development access — проведено ревью](reviews/REV-0004G-three-domain-development-access.md)
