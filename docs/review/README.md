...
- [⚠️ IMP-0030: haptic feedback placement — требуется решение](improvements/IMP-0030-haptic-feedback-placement.md)
...
- [AUD-0007: haptic product/mechanical/cost boundary — проведено ревью фактов](audits/AUD-0007-haptic-product-mechanical-cost.md)
