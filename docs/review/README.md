...
- [⚠️ IMP-0031: external IMU measurement annotation — требуется решение](improvements/IMP-0031-external-imu-measurement-annotation.md)
...
- [AUD-0008: IMU instrument value/placement — проведено ревью фактов](audits/AUD-0008-imu-instrument-value-and-placement.md)
