...
- [⚠️ IMP-0039: three-nRF full-mix RF acceptance — ожидает решения](improvements/IMP-0039-three-nrf-full-mix-acceptance.md)
...
- [RFQ-0002: G2F-3I physical RF concurrency boundary — facts reviewed, nRF envelope open](architecture/RFQ-0002-g2f-3i-rf-concurrency-boundary.md)
...
- [REV-0004M: G2F-3I RF concurrency facts — проведено ревью фактов; IMP-0039 open](reviews/REV-0004M-g2f-3i-rf-concurrency-fact-review.md)
