...
- [⚠️ PKG-0001: единое zero-based target-architecture proposal — требуется решение](architecture/PKG-0001-zero-based-target-architecture-proposal.md)
...
- [REV-0003T: readiness atomic package — готово к решению владельца](reviews/REV-0003T-atomic-package-readiness.md)
