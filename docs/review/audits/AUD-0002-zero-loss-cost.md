...
| USB/debug | один разъём или connectorless fixture вместо независимого доступа S3/C5/RP | экономия connectors/ESD/CC/headers/buttons/корпусных отверстий | ухудшение ежедневного prototype bring-up, диагностики и независимого recovery | отклонено владельцем в `DEC-0031`: три USB-C, три DBG10 и BOOT/RESET каждого MCU являются принятым product/service contract |
