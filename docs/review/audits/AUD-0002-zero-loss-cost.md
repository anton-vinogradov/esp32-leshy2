...
| 3×nRF24 | exact identical qualified PA/LNA modules; direct CS против decoder после pin budget | quote/land/decoder зависит от exact module и серии | 1 radio+RF switch теряет parallel RX; 1 PA+2 иных frontend меняет sensitivity/calibration/TX symmetry | число три сохраняется; generic `$10` estimate не quote; `FND-0019`, `REQ-N24-0001` |
