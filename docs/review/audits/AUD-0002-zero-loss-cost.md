...
| IR learning | dual `TSOP38238` + `TSMP95000` против single-learning или fixed-38 RX | вариант A добавляет receiver/GPIO/passives; B/C дешевле | B теряет robust range/noise, C теряет measured carrier | `IMP-0015`; выбор владельца после prerequisite review |
