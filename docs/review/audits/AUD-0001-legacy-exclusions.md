...
| OUT-06 | NFC emulation/relay, ISO15693, FeliCa, LF 125 kHz, hardnested/darkside | PN7160 официально даёт ISO15693, FeliCa и card emulation; LF 125 kHz и тяжёлые crypto-атаки остаются отдельными задачами | Чтение/эмуляция только своих или явно разрешённых credentials | `reopen`; декомпозировать, PN7160-вариант → `IMP-0005` |
