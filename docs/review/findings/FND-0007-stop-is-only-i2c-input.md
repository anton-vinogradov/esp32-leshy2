...
- Статус: **Открыто; архитектурное safety-решение после сводного pin budget этапа 3**
...
Рекомендуемый вариант и его цена для pin-map описаны в `IMP-0010`. По `DEC-0012` выбор не запрашивается до выпуска сводного pin/GPIO/resource budget; требование физического аварийного прекращения TX при этом остаётся в силе.
