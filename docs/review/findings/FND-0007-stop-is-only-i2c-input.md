...
Целевая latched hard-STOP topology принята как `DEC-0024`. Выбор matrix/U14/pin-map остаётся в `IMP-0010`. Находка не закрывается полностью до target schematic/netlist, exact rail/gate BOM, measured kill time и fault-injection HIL каждого TX path.
