...
- Статус: **Проведено ревью фактов; target decision не проведено**
- Дата: 2026-08-17
...
- Open proposal: [`IMP-0036`](../improvements/IMP-0036-task-based-display-performance.md)
...
| target display accepted | нет; owner decision `IMP-0036` required first |
