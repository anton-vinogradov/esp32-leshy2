...
- Статус: **Проведено ревью фактов; disposition `IMP-0024` и qualification gates открыты**
- Дата: 2026-08-16
...
Проверенные факты непротиворечивы `PKG-0001/PIN-0002/BUD-0002`. `FND-0035` устраняет supply-chain ошибку без смены architecture. `IMP-0024` выделен отдельно, поскольку смена production stepping влияет на procurement, manufacturing identity и firmware restrictions и потому не может быть применена молча.
