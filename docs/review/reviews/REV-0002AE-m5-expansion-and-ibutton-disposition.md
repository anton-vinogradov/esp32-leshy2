...
| M5-only reaches 90% product-result coverage | no; at this review point `FND-0044` gave 27.8% full/44.4% partial/50% with custom iButton; later `DEC-0036/FND-0045` give current 23.5%/41.2%/47.1% over 17 live classes |
