...
- Статус: **Проведено ревью фактов; nRF full-mix повторно открыт**
- Дата: 2026-08-17
...
| local nRF TX preserves arbitrary same/near-channel weak RX sensitivity | not proven and not a universal nRF24 guarantee; exact envelope requires `IMP-0039` plus HIL |
...
shields, conducted/OTA measurements и full-mix RF acceptance `IMP-0039`
остаются открыты; поэтому physical nRF mix ещё не получает status «Проведено
ревью».
