...
Fact/prerequisite slice receives **«Проведено ревью»**. `W-EXTRA-14` remains
`needs-owner` through `IMP-0031`; no IMU behavior is accepted into target yet.
Recommendation A preserves base cost and limits the function to truthful
