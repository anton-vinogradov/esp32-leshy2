...
`BOM-0024/REV-0005BX` preserve this reviewed third-batch checkpoint and advance
the current snapshot to 162/187 lines / 816 placements / USD 150.4157 partial
base subtotal.
