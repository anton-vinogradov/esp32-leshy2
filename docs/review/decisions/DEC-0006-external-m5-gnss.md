...
`IMP-0007` рассматривает более дешёвый комбинированный аксессуар M5Stack Cap LoRa-1262 `U214`, который может заменить одновременно этот GPS Unit и бортовой LoRa. До решения по обязательному LoRa-диапазону предложение не изменяет настоящее решение.
