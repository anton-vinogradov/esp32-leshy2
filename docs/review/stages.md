...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I owner/net/pad projection остаётся `S3 32/3/1`, `C5 14/6/1`, `RP 48/0/0`, slow `24/0/0`; paper `I2` exact AON STOP/evidence закрыт. `DEC-0062` сохраняет два отдельно заменяемых 18650 slots с fail-closed admission; `DEC-0064/PWR-0006` переоткрывают их электрическую топологию через `IMP-0055`. `DEC-0063/PWR-0004/REV-0005R` закрывают exact sink-only 30-W USB-PD frontend без нового S3 GPIO. Cell manager, rail tree, `FND-0060/0066/0067`, antenna lots/feeds/protection, physical RF, peripherals и prototype HIL остаются открыты |
