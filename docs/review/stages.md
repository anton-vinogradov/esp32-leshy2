...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I projection is `S3 33/3/0`, `C5 14/6/1`, `RP 48/0/0`, main slow I/O `24/0/0` and dedicated UI I/O `7/1/0`. I1…I7 have **«Проведено ревью»** in paper scope after the MAX17320 and actual-TX support repairs. I8 inventory and current sourcing batch are reviewed at 858 placements/188 used lines, 187/188 source records plus four explicit physical-gap families; exact display sourcing, cost and alternate qualification remain active. Gate 2F remains open through I8, antenna lots/feeds/protection, physical RF and peripherals |
...
а exact `HMX035CTFT-001` остаётся открыт. Cost/alternate
qualification активен, KiCad не разрешён.
