...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: `DEC-0044/NIF-0001/REV-0004L` выбрали `G2F-3I`; `IMP-0040` exact nRF module/antenna decision, physical RF, exact peripherals/power/HIL next |
