...
| 2 | Capabilities | полный wishlist, competitors, requirements, exclusions, concurrency/failure needs | **Требуется повторное ревью**: прежние 125 leaves сохранены; `W-EXTRA-11` закрыт `DEC-0033`, M5 infrastructure — `DEC-0034`, `W-EXTRA-12` — `DEC-0035`, haptic rejected `DEC-0036`; IMU facts reviewed `AUD-0008`, owner disposition and `W-EXTRA-15..17` open (`FND-0040/AUD-0004..0008`) |
