...
| 2 | Возможности и исключения | этап 1 | полный `INV-0002`, матрица `REQ-*`, zero-loss boundaries и owner-confirmed wishlist freeze | В работе |
| 3 | Системная архитектура и владение | wishlist freeze этапа 2 | единый demand model, минимум три полные компоновки, MCU ownership, transport, сводный pin/GPIO/resource budget, power/reset/update contracts | Не начато; layout запрещён как решение до `DEC-0022` gate; известны `FND-0001`–`FND-0003`, `FND-0006`, `FND-0007`, `FND-0011`, `FND-0013`, `FND-0015`, `FND-0017`, `FND-0019`, `FND-0022`–`FND-0024`, `FND-0026`–`FND-0028` |
