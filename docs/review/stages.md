...
| 4 | Компоненты и BOM | этап 3 | проверенные компоненты, доступность и пределы | В работе; entry/register **Проведено ревью** (`BOM-0001`, `REV-0004A`), component qualification открыта |
