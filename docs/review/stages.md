...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: `DEC-0044/NIF-0001/REV-0004L` выбрали `G2F-3I`; `DEC-0048` фиксирует external-SMA/compact-IPEX direction; `DEC-0049/REV-0004Q` принимают 9 labelled SMA и split Si4732 inputs; exact production lots/feeds/protection, physical RF, peripherals/power/HIL next |
