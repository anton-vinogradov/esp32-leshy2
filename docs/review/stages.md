...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: `DEC-0044/NIF-0001/REV-0004L` выбрали `G2F-3I`; `DEC-0049/REV-0004Q` принимают 9 labelled SMA и split Si4732 inputs; `DEC-0050/REV-0004T` принимают 2 native-Wi-Fi RP-SMA + 7 standard SMA; `ANT-0002/REV-0004U` review sourcing candidates, но `IMP-0043` decision, `FND-0058` two-source/assembled HIL, lots/feeds/protection, physical RF, peripherals/power/HIL остаются открыты |
