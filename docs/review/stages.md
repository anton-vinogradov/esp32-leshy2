...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I owner/net/pad projection остаётся `S3 32/3/1`, `C5 14/6/1`, `RP 48/0/0`, slow `24/0/0`; paper `I2` exact AON STOP/evidence закрыт. `PWR-0002/REV-0005P` проводят ревью пререквизитов `I3` и отклоняют legacy power как target; `IMP-0052` battery-format decision открыт. `FND-0060/0066/0067`, antenna lots/feeds/protection, physical RF, peripherals и prototype HIL остаются открыты |
