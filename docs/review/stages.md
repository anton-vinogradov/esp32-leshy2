...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I owner/net/pad projection остаётся `S3 32/3/1`, `C5 14/6/1`, `RP 48/0/0`, slow `24/0/0`; paper `I2` exact AON STOP/evidence закрыт. `DEC-0062/0065/0066/0067` принимают supervised 2S, exact MAX17320G20+T/MSPM0C1104SDGS20R fail-closed manager, отсутствие in-device deep-cell recovery и exact active surrounding packages; current DGS20 budget — `12/3/3`. `DEC-0063/PWR-0004/REV-0005R` закрывают exact sink-only 30-W USB-PD frontend; `DEC-0068…0076/PWR-0008…0015` закрывают rail/eFuse/converter/diagnostic/BQ/TPS support profiles. `DEC-0077/PWR-0016/REV-0005AH` фиксируют exact polarized `Keystone 1048P`, четыре независимых контакта, protected-button-top boundary и три NTC coupling roles; `DEC-0078/PWR-0017/REV-0005AI` исправляют TPUL WQFN map, добавляют `>=350-ms` аппаратный diagnostic lockout и две 20-Ом/2-Вт ветви нагрузки; `DEC-0079/PWR-0018/REV-0005AJ` выбирают 2×`XTAR 18650 4000mAh`, 28,8 Вт·ч и 2-А charge ceiling; `DEC-0080/PWR-0019/REV-0005AK` заменяют abstract source sequencer точной AON-PG/MR/SENSE/CT/POR/main цепью и 85% system-first input reserve; `DEC-0081/PWR-0020/REV-0005AL` добавляют независимую post-buck защиту AON/main/voice, protected-side PG и reviewed single-fault/loss profile. `DEC-0082/PWR-0021/REV-0005AM` дают всему бумажному I3 статус **«Проведено ревью»** и активируют I4: certification перенесена в I8, а exact-cell/lot/source-transition/rail/destructive/thermal evidence остаётся явным prototype HIL. Gate 2F в целом остаётся открыт до I4…I7, `FND-0060/0066/0067`, antenna lots/feeds/protection, physical RF и peripherals |
