...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: `PIN-0003/REV-0004V/REV-0005A` проводят ревью current G2F-3I owner/net/pad projection (`S3 31/3/2`, `C5 14/6/1`, `RP 48/0/0`, slow `23/1/0`) и exact SA518/Si4732/HMX routes; `FND-0060` remaining exact electrical endpoints, `IMP-0043/FND-0058` antenna decision/qualification, lots/feeds/protection, physical RF, peripherals/power/HIL остаются открыты |
