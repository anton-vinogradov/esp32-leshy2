...
| 4 | Компоненты и BOM | этап 3 | проверенные компоненты, доступность и пределы | В работе; entry/register **Проведено ревью** (`BOM-0001`, `REV-0004A`); compute facts and C5 v1.2 decision **Проведено ревью** (`BOM-0002`, `DEC-0029`, `REV-0004B/C`), schematic/qualification открыты |
