...
| 2 | Capabilities | полный wishlist, competitors, requirements, exclusions, concurrency/failure needs | **Требуется повторное ревью**: прежние 125 leaves сохранены; `W-EXTRA-11` закрыт `DEC-0033`, M5 infrastructure — `DEC-0034`, `W-EXTRA-12` — `DEC-0035`; haptic reviewed/open `IMP-0030`, `W-EXTRA-13..17` требуют disposition (`FND-0040/AUD-0004..0007`) |
