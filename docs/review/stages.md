...
|---:|---|---|---|---|
| 0 | Система ревью и baseline | — | правила, baseline двух SHA, реестры | На ревью |
| 1 | Видение и границы | этап 0 | проверенная формулировка назначения и ограничений | Требуется решение |
| 2 | Возможности и исключения | этап 1 | матрица возможностей `REQ-*` | Не начато |
| 3 | Системная архитектура и владение | этап 2 | MCU ownership, транспорт, power/reset/update contracts | Не начато |
