...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I owner/net/pad projection остаётся `S3 32/3/1`, `C5 14/6/1`, `RP 48/0/0`, slow `24/0/0`; paper `I2` exact AON STOP/evidence закрыт. `DEC-0062/0065/0066` принимают два отдельно заменяемых 18650 в supervised 2S и exact MAX17320G20+T/MSPM0C1104SDGS20R fail-closed manager; его current DGS20 budget — `10/5/3`. `DEC-0063/PWR-0004/REV-0005R` закрывают exact sink-only 30-W USB-PD frontend без нового S3 GPIO. `PWR-0007/REV-0005W` проводят ревью invariants surrounding circuit; `IMP-0056` recovery/FET owner gate, rail tree, `FND-0060/0066/0067`, antenna lots/feeds/protection, physical RF, peripherals и prototype HIL остаются открыты |
