...
flowchart TD
  ...
  I8["▶ МЫ ЗДЕСЬ — Gate 2F / I8<br/>components · sources · cost · alternates<br/>169/187 цен · 823/857 placements · USD 157.1927 partial<br/><b>В РАБОТЕ</b>"]
...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I projection is `S3 33/3/0`, `C5 14/6/1`, `RP 48/0/0`, main slow I/O `24/0/0` and dedicated UI I/O `7/1/0`. I1…I7 have **«Проведено ревью»** in paper scope after the MAX17320 and actual-TX support repairs. I8 inventory/current source batch/display sourcing strategy/substitution policy and thirteen cost batches are reviewed at 858 architecture instances / 857 supplied placements / 187 purchase lines, 186/187 source records, 187/187 disposition classes and 169/187 cost records covering 823 placements; twelve unpriced lines have explicit gates and four physical-gap families remain. Standalone display RFQ, 18 prices and specific alternate qualification are active. Gate 2F remains open through I8, antenna lots/feeds/protection, physical RF and peripherals |
...
no-silent-substitution policy 187/187; `BOM-0013…0025/DEC-0105…0106/
REV-0005BL…BY` проводят ревью cost contract, explicit RFQ/retail gates и
первых 169/187 строк / 823 placements с partial subtotal USD 157.1927. Ещё 18
