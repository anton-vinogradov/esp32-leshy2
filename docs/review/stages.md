...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: current G2F-3I projection is `S3 33/3/0`, `C5 14/6/1`, `RP 48/0/0`, main slow I/O `24/0/0` and dedicated UI I/O `7/1/0`. I1…I7 have **«Проведено ревью»** in paper scope after the MAX17320 and actual-TX support repairs. I8 inventory/current source batch/display sourcing strategy/substitution policy are reviewed at 858 architecture instances / 857 supplied placements / 187 purchase lines, 186/187 source records and 187/187 disposition classes plus four explicit physical-gap families; standalone display RFQ, cost and specific alternate qualification are active. Gate 2F remains open through I8, antenna lots/feeds/protection, physical RF and peripherals |
...
no-silent-substitution policy 187/187; cost/specific alternate qualification активен, KiCad не
разрешён. `FND-0112/BOM-0011/DEC-0103/REV-0005BJ` отдельно исправляют
