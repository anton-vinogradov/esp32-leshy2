...
| 4 | Компоненты и BOM | этап 3 | проверенные компоненты, доступность и пределы | В работе; entry/register, compute facts and C5 v1.2 decision **Проведено ревью** (`BOM-0001/0002`, `DEC-0029`, `REV-0004A…C`); CAD availability facts **Проведено ревью** (`LIB-0001`, `REV-0004D`), `IMP-0025`/assets/schematic/qualification открыты |
