...
| 2 | Capabilities | полный wishlist, competitors, requirements, exclusions, concurrency/failure needs | **Требуется повторное ревью**: прежние 125 leaves сохранены; `W-EXTRA-11` закрыт `DEC-0033`, M5 infrastructure — `DEC-0034`, `W-EXTRA-12` — `DEC-0035`, haptic rejected `DEC-0036`, IMU external accepted `DEC-0037`, no integrated keyboard + phone-assisted text — `DEC-0038`; `W-EXTRA-16` facts reviewed `AUD-0010`, owner decision and `W-EXTRA-17` open (`FND-0040/AUD-0004..0010`) |
