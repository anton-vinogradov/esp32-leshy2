...
| 2F | Logical/electrical feasibility | neutral signal demand, real-device pin provenance, ≥2 complete owner/bus/GPIO maps and working baseline | **В работе**: `PIN-0003/REV-0004V/REV-0005A/REV-0005D/REV-0005E` проводят ревью current G2F-3I owner/net/pad projection (`S3 32/3/1`, `C5 14/6/1`, `RP 48/0/0`, slow `24/0/0`), exact SA518/Si4732/HMX/audio routes и принятую структуру antenna kit; `FND-0060/0066/0067` remaining exact electrical/HIL endpoints, `FND-0058` antenna qualification, lots/feeds/protection, physical RF, peripherals/power/HIL остаются открыты |
