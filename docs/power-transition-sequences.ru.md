...
**Результат:** `14/14` сценариев и `51` endpoint-проверок проходят. H3-R2.3, [цифровая проверка H3-R2.4](digital-electrical-verification.ru.md) и [RF-проверка H3-R2.5](rf-electrical-verification.ru.md) проведены ревью; **текущий маркер — `H3-R2.6`**. Заказ и трассировка всё ещё запрещены.
