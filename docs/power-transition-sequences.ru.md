...
**Результат:** `14/14` сценариев и `51` endpoint-проверок проходят. H3-R2.3, [цифровая проверка H3-R2.4](digital-electrical-verification.ru.md), [RF-проверка H3-R2.5](rf-electrical-verification.ru.md), [thermal/fault H3-R2.6](thermal-fault-electrical-verification.ru.md), итоги H3-R2.7 и H4-R2 проведены ревью; **текущий маркер — `H5.0.3-R1`**. Заказ и трассировка всё ещё запрещены.
