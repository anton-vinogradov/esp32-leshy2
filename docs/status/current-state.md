...
The 3×nRF24 capability audit passed `REV-0002T`/`REV-0002U`: [`REQ-N24-0001`](../review/requirements/REQ-N24-0001-three-nrf24-raw-2g4.md) preserves three simultaneous full-function radios and accepted [`DEC-0019`](../review/decisions/DEC-0019-calibrated-rpd-three-antenna-hunt.md), a calibrated binary RPD hit-rate sector comparison that is never RSSI/dBm/bearing/VSWR. After the full-function clarification, physical ownership was reopened. `REV-0002Z` and [`AUD-0003`](../review/audits/AUD-0003-three-nrf24-owner-placement.md) produced preliminary S3/C5 variants; on the currently known scope **⚠️ [`IMP-0021/A`](../review/improvements/IMP-0021-s3-owns-three-full-function-nrf24.md)** is a strong S3-heavy candidate. Under `DEC-0022` there is no decision now: [`INV-0002`](../review/inventories/INV-0002-product-wishlist.md) is completed first, then variants are recalculated on the full demand model and pass pin/recovery/performance HIL. `FND-0019` and `FND-0021` remain implementation gates.
