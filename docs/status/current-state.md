...
The next active work is RF zoning/coexistence and a dated comparable cost snapshot. Target READMEs remain unchanged until atomic acceptance under `DEC-0026`.
