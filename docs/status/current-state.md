...
The new active chain starts with [`CAP-0001`](../review/architecture/CAP-0001-zero-based-capability-input.md). It covers 15/15 owner invariants, 9/9 wishlist groups and 13/13 requirement documents without pin/bus allocation and is **Reviewed** under [`REV-0003J`](../review/reviews/REV-0003J-zero-based-stage3-restart.md). The next hardware-neutral artifact, [`CON-0001`](../review/architecture/CON-0001-hardware-neutral-concurrency-model.md), separates mandatory parallelism, time-sharing, qualification-only pairs and exclusions, covers all 21 capability atoms plus failure scenarios, and is **Reviewed** under [`REV-0003K`](../review/reviews/REV-0003K-zero-based-concurrency-model.md). [`RES-0001`](../review/architecture/RES-0001-hardware-neutral-resource-demand.md) then derives compute/interface/timing/memory/power/safety/recovery demand and sizing equations without MCU/GPIO placement; `REV-0003L` reviews it.
