...
Stage 4 is active. [`BOM-0001`](../review/components/BOM-0001-stage4-component-evidence-register.md) and [`REV-0004A`](../review/reviews/REV-0004A-stage4-entry-register.md) provide the reviewed complete evidence register. [`BOM-0002`](../review/components/BOM-0002-compute-clock-recovery-evidence.md) and [`REV-0004B`](../review/reviews/REV-0004B-compute-clock-recovery-evidence.md) review the compute/clock/recovery facts, exact RP order codes and manufacturer reference crystal without falsely granting component `Q`. One decision remains open: [`IMP-0024`](../review/improvements/IMP-0024-c5-v1.2-production-floor.md) proposes C5 v1.2 as the production floor while retaining v1.0 only for restricted engineering samples. Schematic/AVL/assembly/recovery/HIL gates still prevent final `BOM-0002` closure.
