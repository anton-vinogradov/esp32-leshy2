...
[`CST-0001`](../review/architecture/CST-0001-dated-candidate-cost-burden.md) passes [`REV-0003S`](../review/reviews/REV-0003S-zero-based-cost-burden.md). At the original 2026-08-16 qty-500 snapshot, candidate-specific recurring ranges are `2B $0.5017…0.6517`, `2A $0.6313…0.7813`, and `3A $1.7359…1.8859`. The approximately $1.10 midpoint premium of `3A` over `2A` buys direct radio controls, deterministic isolation and seven free C5 GPIO, not a parts-count saving. [`FND-0035`](../review/findings/FND-0035-rp2354a-order-code-stock-correction.md) corrects the former below-500 RP stock conclusion: exact `SC1511-A4` public stock clears 500, while written quotes, lot traceability and QFN60 assembly/yield remain open. The old range stays a conservative historical comparison until a coherent exact production quote replaces it.
...
Stage 4 is active. [`BOM-0001`](../review/components/BOM-0001-stage4-component-evidence-register.md) and [`REV-0004A`](../review/reviews/REV-0004A-stage4-entry-register.md) provide the reviewed complete evidence register. [`BOM-0002`](../review/components/BOM-0002-compute-clock-recovery-evidence.md) and [`REV-0004B`](../review/reviews/REV-0004B-compute-clock-recovery-evidence.md) review the compute/clock/recovery facts, exact RP order codes and manufacturer reference crystal without falsely granting component `Q`. The owner accepted [`IMP-0024/A`](../review/improvements/IMP-0024-c5-v1.2-production-floor.md) as [`DEC-0029`](../review/decisions/DEC-0029-c5-v1.2-production-floor.md): C5 production/release/qualification requires ≥v1.2, while v1.0 is restricted engineering-only; [`REV-0004C`](../review/reviews/REV-0004C-c5-v1.2-propagation.md) reviews cross-repository propagation. The owner then accepted [`IMP-0025/A`](../review/improvements/IMP-0025-repository-vendored-critical-cad-libraries.md) as [`DEC-0030`](../review/decisions/DEC-0030-vendored-critical-cad-libraries.md). [`LIB-0001`](../review/components/LIB-0001-compute-cad-library-audit.md) and [`REV-0004D/E`](../review/reviews/REV-0004E-vendored-critical-cad-libraries.md) now review the project-local C-001…005 symbols/footprints, pinned provenance/licensing, CI pin/pad/hash gate and KiCad 10.0.5 parser checks. `FND-0036` is closed at CAD-representation level. [`REC-0001/REV-0004F`](../review/components/REC-0001-compute-recovery-and-link-prerequisites.md) review the C-006/C-007 ROM/debug/link prerequisites and close [`FND-0037`](../review/findings/FND-0037-c5-usb-download-strap-misidentified.md): C5 USB/UART Joint Download Boot uses physical GPIO28-low plus GPIO27-high and CHIP_PU, not GPIO26-low. All compute peers remain on common `3V3_CORE`, so reset-only direct links need separable damping/test provisions rather than an active power-domain mux; individual future core power gates would reopen isolation. Exact physical access now awaits the owner choice in [`IMP-0026`](../review/improvements/IMP-0026-connectorless-owner-recovery-fixture.md); schematic/AVL/assembly/recovery/HIL gates still prevent final `BOM-0002` closure.
