...
[`ADR-0001`](../review/architecture/ADR-0001-stage3-dependency-register.md) сопоставил весь stage-3 graph с demand/hard-fail rows и получил статус **«Проведено ревью»** в `REV-0003I`. Он показал, что owner/transport/memory, matrix/audio/recovery, external ports/power и actual-TX/coexistence нельзя закрывать независимо.
