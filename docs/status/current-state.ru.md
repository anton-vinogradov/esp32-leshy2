...
Этап 4 активен. [`BOM-0001`](../review/components/BOM-0001-stage4-component-evidence-register.md) и [`REV-0004A`](../review/reviews/REV-0004A-stage4-entry-register.md) дают полный проверенный evidence register. [`BOM-0002`](../review/components/BOM-0002-compute-clock-recovery-evidence.md) и [`REV-0004B`](../review/reviews/REV-0004B-compute-clock-recovery-evidence.md) проводят ревью compute/clock/recovery facts, exact RP order codes и manufacturer reference crystal, не присваивая ложный component `Q`. Владелец принял [`IMP-0024/A`](../review/improvements/IMP-0024-c5-v1.2-production-floor.md) как [`DEC-0029`](../review/decisions/DEC-0029-c5-v1.2-production-floor.md): production/release/qualification C5 требует ≥v1.2, а v1.0 остаётся restricted engineering-only; [`REV-0004C`](../review/reviews/REV-0004C-c5-v1.2-propagation.md) проверяет cross-repository propagation. Schematic/AVL/assembly/recovery/HIL gates пока не дают закрыть `BOM-0002` целиком.
