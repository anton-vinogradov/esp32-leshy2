...
Этап 4 активен. [`BOM-0001`](../review/components/BOM-0001-stage4-component-evidence-register.md) и [`REV-0004A`](../review/reviews/REV-0004A-stage4-entry-register.md) дают полный проверенный evidence register. [`BOM-0002`](../review/components/BOM-0002-compute-clock-recovery-evidence.md) и [`REV-0004B`](../review/reviews/REV-0004B-compute-clock-recovery-evidence.md) проводят ревью compute/clock/recovery facts, exact RP order codes и manufacturer reference crystal, не присваивая ложный component `Q`. Открыто одно решение: [`IMP-0024`](../review/improvements/IMP-0024-c5-v1.2-production-floor.md) предлагает C5 v1.2 как production floor, оставляя v1.0 только для ограниченных engineering samples. Schematic/AVL/assembly/recovery/HIL gates пока не дают закрыть `BOM-0002` целиком.
