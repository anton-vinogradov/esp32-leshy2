...
Следующий активный шаг — количественно свести memory, traffic, power, RF coexistence и dated cost для тех же трёх maps. Целевые README не меняются до атомарной приёмки всей архитектуры по `DEC-0026`.
