...
Следующая активная работа — датированный сопоставимый recurring cost и implementation/update/HIL burden snapshot. Целевые README не меняются до атомарной приёмки по `DEC-0026`.
