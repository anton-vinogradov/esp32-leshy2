...
`H3-R2.6` проведён ревью: **25 checks**, `56` thermal-профилей и `30` single-fault сценариев проходят без открытых аналитических findings. Итоги H3-R2.7 и H4-R2 также проведены ревью; текущий маркер — `H5.0.3-R1`.
