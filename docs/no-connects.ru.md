# Намеренно неподключённые контакты Leshy2

[English](no-connects.md) · [На главную](../README.ru.md) · [Роадмап](roadmap.ru.md)

Это полный реестр физических NC H2.6.2. Каждая строка проверена по символу, точному контакту и NC-маркеру KiCad; причина не заменяется общим словом «резерв».

| Лист | Контакт | Физический pin | Обоснование |
|---|---|---:|---|
...
✅ **Проведено ревью:** 189 NC / 22 листов; отсутствующих контактов, маркеров и обоснований нет.
