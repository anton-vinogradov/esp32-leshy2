...
`H3-R2.5` is reviewed with **71 passing machine checks** and no open analytical finding. [`H3-R2.6`](thermal-fault-electrical-verification.md), the H3-R2.7 phase package and H4-R2.0.1 input freeze are also reviewed; the current marker is `H4-R2.0.2`.
