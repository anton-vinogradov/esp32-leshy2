...
This `H1-R2.30` ranking predates the accepted U219 host overlay. Its exact active
additions currently total **$0.6845/device**; after removing one 22-ohm part the
known-active net is **$0.669/device** or **$3.345 for EVT5**. This is deliberately
not called a fixed total: exact support-passive values, MPNs and quantities remain
an H1 blocker. See the [provisional U219 delta](../hardware/architecture/generated/H1-R2-U219-bom-delta.csv).
