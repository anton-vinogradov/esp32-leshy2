...
- With the required post-PCBA K331: **$315.99** before PCB/PCBA, enclosure, antennas, freight, tax, yield and test.
...
| MPN | Role | Per device | Unit on accepted basis | Device line | For 5 devices | JLC capture / live |
|---|---|---:|---:|---:|---:|---:|
