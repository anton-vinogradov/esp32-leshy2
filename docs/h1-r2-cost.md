...
- Volume material basis: **$291.58** per device; `239/248` lines are priced.
- Reachable planning subtotal: **$311.39** per device, with `5` base-product lines still unpriced.
- Current planned component minimum with no mandatory post-PCBA active module: **$311.39** per device and **$311.39** for the one target prototype before PCB/PCBA, enclosure, antennas, freight, tax, yield and test.
- The same accepted price basis scales linearly to **$3,113.86** for ten devices. This compares groups; it is not a batch quote.
- The top 10 / 20 / 40 groups contribute **36.69% / 54.89% / 74.24%** of the known base BOM.
...
- The current base BOM has `246` MPN groups and `1213` fitted components. The accepted no-function-loss AD8314 and Hirose U.FL routes already save **$10.42** and leave the exact current planning floor at **$311.39**. The cheaper SMA/RP-SMA pair was checked and rejected, so its hypothetical saving is not counted.
- A further **$95.39–$122.39** must be removed to reach the electronics band. The formal margin to the complete-device ceiling is only **$-51.39**, so boards, assembly and enclosure do not fit without further resynthesis.
...
|---|---:|---:|---|
| Current circuit | $311.39 | above $311.39 | already above the accepted ceiling before boards, assembly and enclosure |
| After the accepted AD8314 and Hirose U.FL changes | $311.39 | above $311.39 | exact current planning floor; still insufficient |
...
[Unified top 20 — CSV](../hardware/product-design/generated/H1-R2-cost-top20.csv) · [Complete 248-line ranking — CSV](../hardware/product-design/generated/H1-R2-cost-ranked.csv)
