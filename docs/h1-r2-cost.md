...
## Highest-cost finished-device groups

| MPN and role | Qty ×1 | Unit on accepted basis | Group ×1 | Qty ×10 | Group ×10 | BOM share |
|---|---:|---:|---:|---:|---:|---:|
...
| `Yageo RC0402FR-0710KL`<br><sub>203 grouped placements; complete list in CSV</sub> | 203 | $0.01 | $1.97 | 2030 | $19.69 | 0.71% |
...
| 2 | 10 outward SMA/RP-SMA | $24.65 | GCT cost is no longer justified by a low-profile requirement; a robust stocked pair needs a fresh placement check | up to ~$19.01 |
| 3 | 8 RF detectors | $24.92 | Real-TX evidence remains required; six AD8314 can move to the stocked package of the same IC after placement review | ~$6.17 |
...
- **`DreamLNK SMA-KWE902 / SMA-KWE901`:** This is a fully documented, stocked, no-nut 6-GHz right-angle standard/reverse pair with a stronger through-board soldered load path. Its approximately 10.2-mm axis and through-hole tails change the selected 3.9-mm GCT envelope, but low profile is no longer a product requirement. It is therefore the leading cost-reduction candidate, not an accepted production MPN: all ten placements, opposing clearances and the JLCPCB wave-solder route still need to pass together. [JLCPCB](https://jlcpcb.com/partdetail/DreamLNK-SMAKWE902/C914554)
...
3. ▶ **Replace the expensive GCT pair with a robust stocked standard/reverse pair if it fits** — Ten GCT RFPC-SMA31/32 connectors contribute USD 24.6456 per device. Low profile is no longer a product requirement; the stocked nutless DreamLNK pair would reduce the line by about USD 19.01, but its through-hole tails and roughly 10.2-mm axis require a new internal keep-out and all ten port placements to be rechecked. Optimize for the correct outward antenna direction, standard/RP-SMA identity, at least 6-GHz coverage on native ports and a dual-face or through-board mechanical load path. Accept a replacement only after complete 5+5 placement, opposing-clearance and assembly review.
