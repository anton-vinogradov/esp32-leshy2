...
**H5-R2.1 проведён ревью.** Текущая R2-поверхность содержит **248 закупаемых групп / 1216 изделий**: 205 маршрутов унаследованы из полного H5-R1-аудита, ещё 43 добавлены или заменены текущим H2. Непривязанных групп нет.

```mermaid
flowchart LR
  A["248 текущих групп<br/>1216 изделий"] --> B["205 унаследованных<br/>маршрутов H5-R1"]
...
- Исправленная известная база электроники: **$311.39**; известные внешние антенны: **$138.32**; вместе **$449.70** до платы, сборки, корпуса, доставки и ещё 5 групп компонентов / 2 групп антенн без цены.
