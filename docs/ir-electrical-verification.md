# IR electrical verification · historical R1
...
The corrections add only `-0.0088 USD` per unit at quantity 100. **H3.3.3 is reviewed; the historical R1 progression marker is `H3.6.1`.**
