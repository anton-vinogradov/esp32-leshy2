...
H6.0.1. **Сейчас выполняются трассировка H6.0.2 и сверка native nets.** Результат
...
Текущая фабричная таблица называет 1,6-мм вариант
[`JLC06161H-3313`](https://jlcpcb.com/impedance): внешняя медь 0,035 мм,
внутренняя 0,0152 мм, внешние препреги 3313 по 0,0994 мм, центральный 2116
0,1088 мм и два core по 0,55 мм. H6.0.4/H6.0.5 всё ещё обязаны связать реальные
ширины дорожек и значения калькулятора заказа перед выпуском.
